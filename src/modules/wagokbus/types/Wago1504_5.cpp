...
const CStringDictionary::TStringId FORTE_Wago1504_5::scmDataInputNames[] = {STRID(QI),
...
const TDataIOID FORTE_Wago1504_5::scmEIWith[] = {1,  2,  5,  3,  4,  6,  7,  8, 9,
