...
class FORTE_PLCnextAXLSEDO16 final : public PLCnextSlaveHandler {
  ...
  public:
    FORTE_PLCnextAXLSEDO16(forte::core::InstanceNameId paInstanceNameId, forte::core::CFBContainer &paContainer);
    ...
    void evt_INIT(const CIEC_BOOL &paQI,
                  const CIEC_STRING &paDO_1,
                  const CIEC_STRING &paDO_2,
                  const CIEC_STRING &paDO_3,
                  const CIEC_STRING &paDO_4,
                  const CIEC_STRING &paDO_5,
                  const CIEC_STRING &paDO_6,
                  const CIEC_STRING &paDO_7,
                  const CIEC_STRING &paDO_8,
                  const CIEC_STRING &paDO_9,
                  const CIEC_STRING &paDO_10,
                  const CIEC_STRING &paDO_11,
                  const CIEC_STRING &paDO_12,
                  const CIEC_STRING &paDO_13,
