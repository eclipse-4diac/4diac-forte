...
const TForteInt16 BusAdapter::scm_anEIWithIndexes[] = { -1 };
const TDataIOID BusAdapter::scm_anEOWith[] = { 0, 255 };
const TForteInt16 BusAdapter::scm_anEOWithIndexes[] = { 0, -1 };
const CStringDictionary::TStringId BusAdapter::scm_anEventOutputNames[] = {
    g_nStringIdINIT };

const SFBInterfaceSpec BusAdapter::scm_stFBInterfaceSpecSocket = { 0, 0, 0, 0,
    1, scm_anEventOutputNames, scm_anEOWith, scm_anEOWithIndexes, 0, 0, 0, 1,
    scm_anDataOutputNames, scm_anDataOutputTypeIds, 0, 0 };

const SFBInterfaceSpec BusAdapter::scm_stFBInterfaceSpecPlug = { 1,
    scm_anEventOutputNames, scm_anEOWith, scm_anEOWithIndexes, 0, 0, 0, 0, 1,
    scm_anDataOutputNames, scm_anDataOutputTypeIds, 0, 0, 0, 0, 0 };
