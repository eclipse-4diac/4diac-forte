...
DEFINE_FIRMWARE_FB(FORTE_WORD2WORD, "WORD2WORD"_STRID)
...
FORTE_WORD2WORD::FORTE_WORD2WORD(const forte::core::StringId paInstanceNameId, forte::core::CFBContainer &paContainer) :
