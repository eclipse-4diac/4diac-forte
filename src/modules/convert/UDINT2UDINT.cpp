...
const TDataIOID FORTE_UDINT2UDINT::scm_anEIWith[] = {0, scmWithListDelimiter};
...
const TDataIOID FORTE_UDINT2UDINT::scm_anEOWith[] = {0, scmWithListDelimiter};
...
void FORTE_UDINT2UDINT::executeEvent(TEventID pa_nEIID){
  switch(pa_nEIID) {
...
void FORTE_UDINT2UDINT::readInputData(TEventID pa_nEIID) {
  switch(pa_nEIID) {
    case scm_nEventREQID: {
...
void FORTE_UDINT2UDINT::writeOutputData(TEventID pa_nEIID) {
  switch(pa_nEIID) {
