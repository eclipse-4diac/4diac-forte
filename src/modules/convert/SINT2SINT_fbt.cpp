...
const CStringDictionary::TStringId FORTE_SINT2SINT::scmEventInputTypeIds[] = {g_nStringIdEvent};
...
const CStringDictionary::TStringId FORTE_SINT2SINT::scmEventOutputTypeIds[] = {g_nStringIdEvent};
...
FORTE_SINT2SINT::FORTE_SINT2SINT(CStringDictionary::TStringId paInstanceNameId, forte::core::CFBContainer &paContainer) :
...
void FORTE_SINT2SINT::executeEvent(TEventID paEIID, CEventChainExecutionThread *const paECET) {
  switch(paEIID) {
    case scmEventREQID:
      alg_REQ();
      break;
