...
const TDataIOID FORTE_TIME2TIME::scm_anEIWith[] = {0, 255};
...
const TDataIOID FORTE_TIME2TIME::scm_anEOWith[] = {0, 255};
...
void FORTE_TIME2TIME::executeEvent(int pa_nEIID){
  switch(pa_nEIID) {
...
void FORTE_TIME2TIME::readInputData(size_t pa_nEIID) {
  switch(pa_nEIID) {
    case scm_nEventREQID: {
...
void FORTE_TIME2TIME::writeOutputData(size_t pa_nEIID) {
  switch(pa_nEIID) {
