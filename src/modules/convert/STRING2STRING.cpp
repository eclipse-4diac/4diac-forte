...
const TDataIOID FORTE_STRING2STRING::scm_anEIWith[] = {0, scmWithListDelimiter};
...
const TDataIOID FORTE_STRING2STRING::scm_anEOWith[] = {0, scmWithListDelimiter};
...
void FORTE_STRING2STRING::executeEvent(TEventID pa_nEIID){
  switch(pa_nEIID) {
...
void FORTE_STRING2STRING::readInputData(TEventID pa_nEIID) {
  switch(pa_nEIID) {
    case scm_nEventREQID: {
...
void FORTE_STRING2STRING::writeOutputData(TEventID pa_nEIID) {
  switch(pa_nEIID) {
