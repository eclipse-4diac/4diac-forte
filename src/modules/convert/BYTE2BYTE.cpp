...
const TDataIOID FORTE_BYTE2BYTE::scm_anEIWith[] = {0, 255};
...
const TDataIOID FORTE_BYTE2BYTE::scm_anEOWith[] = {0, 255};
...
void FORTE_BYTE2BYTE::executeEvent(int pa_nEIID){
  switch(pa_nEIID) {
...
void FORTE_BYTE2BYTE::readInputData(size_t pa_nEIID) {
  switch(pa_nEIID) {
    case scm_nEventREQID: {
...
void FORTE_BYTE2BYTE::writeOutputData(size_t pa_nEIID) {
  switch(pa_nEIID) {
