...
const TDataIOID FORTE_BOOL2BOOL::scm_anEIWith[] = {0, 255};
...
const TDataIOID FORTE_BOOL2BOOL::scm_anEOWith[] = {0, 255};
...
void FORTE_BOOL2BOOL::executeEvent(int pa_nEIID){
  switch(pa_nEIID) {
...
void FORTE_BOOL2BOOL::readInputData(size_t pa_nEIID) {
  switch(pa_nEIID) {
    case scm_nEventREQID: {
...
void FORTE_BOOL2BOOL::writeOutputData(size_t pa_nEIID) {
  switch(pa_nEIID) {
