...
namespace {
  const auto cDataInputNames = std::array{STRID(QI), STRID(FILE_NAME), STRID(S1),
...
fileWriter::fileWriter(const forte::core::InstanceNameId paInstanceNameId, forte::core::CFBContainer &paContainer) :
