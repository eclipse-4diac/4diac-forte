...
const TForteInt16 FORTE_ST_DEL_FB::scm_anEOWithIndexes[] = {0};
...
FORTE_ST_DEL_FB::FORTE_ST_DEL_FB(const CStringDictionary::TStringId pa_nInstanceNameId, CResource *pa_poSrcRes) :
...
CIEC_ANY *FORTE_ST_DEL_FB::getDIO(size_t) {
  return nullptr;
}
...
CInOutDataConnection **FORTE_ST_DEL_FB::getDIOInConUnchecked(TPortId) {
  return nullptr;
}

CInOutDataConnection *FORTE_ST_DEL_FB::getDIOOutConUnchecked(TPortId) {
  return nullptr;
}
