...
class FORTE_ST_CREATE_CONN final : public CFunctionBlock {
  ...
  public:
    FORTE_ST_CREATE_CONN(const forte::core::InstanceNameId paInstanceNameId, forte::core::CFBContainer &paContainer);
    ...
    void evt_REQ(const CIEC_BOOL &pa_QI,
                 const CIEC_WSTRING &pa_SRC_FB,
                 const CIEC_WSTRING &pa_SRC_FB_OUT,
                 const CIEC_WSTRING &pa_DST_FB,
                 const CIEC_WSTRING &pa_DST_FB_IN,
