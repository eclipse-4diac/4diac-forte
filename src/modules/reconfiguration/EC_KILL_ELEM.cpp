...
const TDataIOID FORTE_EC_KILL_ELEM::scm_anEIWith[] = {1, 2, 0, scmWithListDelimiter};
...
const TDataIOID FORTE_EC_KILL_ELEM::scm_anEOWith[] = {1, 0, scmWithListDelimiter};
const TForteInt16 FORTE_EC_KILL_ELEM::scm_anEOWithIndexes[] = {0};
...
FORTE_EC_KILL_ELEM::FORTE_EC_KILL_ELEM(const CStringDictionary::TStringId pa_nInstanceNameId, CResource *pa_poSrcRes) :
...
CIEC_ANY *FORTE_EC_KILL_ELEM::getDIO(size_t) {
  return nullptr;
}
...
CInOutDataConnection **FORTE_EC_KILL_ELEM::getDIOInConUnchecked(TPortId) {
  return nullptr;
}

CInOutDataConnection *FORTE_EC_KILL_ELEM::getDIOOutConUnchecked(TPortId) {
  return nullptr;
}
