...
const CStringDictionary::TStringId FORTE_EC_START_ELEM::scmDataInputNames[] = {STRID(QI), STRID(ELEM_NAME), STRID(DST)};
const CStringDictionary::TStringId FORTE_EC_START_ELEM::scmDataInputTypeIds[] = {STRID(BOOL), STRID(WSTRING),
                                                                                 STRID(WSTRING)};
const CStringDictionary::TStringId FORTE_EC_START_ELEM::scmDataOutputNames[] = {STRID(QO), STRID(STATUS)};
const CStringDictionary::TStringId FORTE_EC_START_ELEM::scmDataOutputTypeIds[] = {STRID(BOOL), STRID(WSTRING)};
...
const CStringDictionary::TStringId FORTE_EC_START_ELEM::scmEventInputNames[] = {STRID(REQ)};
const CStringDictionary::TStringId FORTE_EC_START_ELEM::scmEventInputTypeIds[] = {STRID(Event)};
...
const CStringDictionary::TStringId FORTE_EC_START_ELEM::scmEventOutputNames[] = {STRID(CNF)};
const CStringDictionary::TStringId FORTE_EC_START_ELEM::scmEventOutputTypeIds[] = {STRID(Event)};
const SFBInterfaceSpec FORTE_EC_START_ELEM::scmFBInterfaceSpec = {1,
                                                                  scmEventInputNames,
