...
const CStringDictionary::TStringId FORTE_ST_CREATE_CONN::scmEventInputNames[] = {STRID(REQ)};
const CStringDictionary::TStringId FORTE_ST_CREATE_CONN::scmEventInputTypeIds[] = {STRID(Event)};
