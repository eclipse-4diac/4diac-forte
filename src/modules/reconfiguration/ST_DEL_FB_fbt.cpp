...
DEFINE_FIRMWARE_FB(FORTE_ST_DEL_FB, "ST_DEL_FB"_STRID)
...
FORTE_ST_DEL_FB::FORTE_ST_DEL_FB(const forte::core::StringId paInstanceNameId, forte::core::CFBContainer &paContainer) :
