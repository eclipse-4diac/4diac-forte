...
const CStringDictionary::TStringId FORTE_ST_SET_PARM::scm_anDataInputNames[] = { g_nStringIdQI, g_nStringIdELEM_NAME, g_nStringIdELEM_DATA_IN,
  g_nStringIdPARM_VAL, g_nStringIdDST };

const CStringDictionary::TStringId FORTE_ST_SET_PARM::scm_anDataInputTypeIds[] = { g_nStringIdBOOL, g_nStringIdWSTRING, g_nStringIdWSTRING, g_nStringIdWSTRING,
  g_nStringIdWSTRING };
...
const TDataIOID FORTE_ST_SET_PARM::scm_anEIWith[] = { 1, 2, 3, 4, 0, scmWithListDelimiter };
const CStringDictionary::TStringId FORTE_ST_SET_PARM::scm_anEventInputNames[] = { g_nStringIdREQ };

const TDataIOID FORTE_ST_SET_PARM::scm_anEOWith[] = { 1, 0, scmWithListDelimiter };
...
void FORTE_ST_SET_PARM::executeRQST() {
  ...
  theCommand.mAdditionalParams = func_WSTRING_TO_STRING(PARM_VAL());
