...
const TForteInt16 FORTE_ST_SET_PARM::scm_anEOWithIndexes[] = {0};
...
FORTE_ST_SET_PARM::FORTE_ST_SET_PARM(const CStringDictionary::TStringId pa_nInstanceNameId, CResource *pa_poSrcRes) :
...
CIEC_ANY *FORTE_ST_SET_PARM::getDIO(size_t) {
  return nullptr;
}
...
CInOutDataConnection **FORTE_ST_SET_PARM::getDIOInConUnchecked(TPortId) {
  return nullptr;
}

CInOutDataConnection *FORTE_ST_SET_PARM::getDIOOutConUnchecked(TPortId) {
  return nullptr;
}
