...
class FORTE_ST_DEL_FB final : public CFunctionBlock {
...
public:
  FORTE_ST_DEL_FB(const CStringDictionary::TStringId pa_nInstanceNameId, CResource *pa_poSrcRes);
  ...
  void evt_REQ(const CIEC_BOOL &pa_QI, const CIEC_WSTRING &pa_FB_NAME, const CIEC_WSTRING &pa_DST, CIEC_BOOL &pa_QO, CIEC_WSTRING &pa_STATUS) {
    var_QI = pa_QI;
  ...
  void operator()(const CIEC_BOOL &pa_QI, const CIEC_WSTRING &pa_FB_NAME, const CIEC_WSTRING &pa_DST, CIEC_BOOL &pa_QO, CIEC_WSTRING &pa_STATUS) {
    evt_REQ(pa_QI, pa_FB_NAME, pa_DST, pa_QO, pa_STATUS);
  }
};
