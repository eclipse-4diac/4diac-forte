...
const CStringDictionary::TStringId FORTE_ST_CREATE_FB::scmDataInputNames[] = {STRID(QI), STRID(FB_NAME), STRID(FB_TYPE), STRID(DST)};
const CStringDictionary::TStringId FORTE_ST_CREATE_FB::scmDataInputTypeIds[] = {STRID(BOOL), STRID(WSTRING), STRID(WSTRING), STRID(WSTRING)};
