...
public:
  FORTE_F_FIND(const CStringDictionary::TStringId pa_nInstanceNameId, CResource *pa_poSrcRes);

  CIEC_ANY_STRING_VARIANT var_IN1;
  CIEC_ANY_STRING_VARIANT var_IN2;
  CIEC_ANY_INT_VARIANT var_OUT;
  
  CIEC_ANY_INT_VARIANT var_conn_OUT;
  ...
  void evt_REQ(const CIEC_ANY_STRING_VARIANT &pa_IN1, const CIEC_ANY_STRING_VARIANT &pa_IN2, CIEC_ANY_INT_VARIANT &pa_OUT) {
    var_IN1 = pa_IN1;
    var_IN2 = pa_IN2;
  ...
  void operator()(const CIEC_ANY_STRING_VARIANT &pa_IN1, const CIEC_ANY_STRING_VARIANT &pa_IN2, CIEC_ANY_INT_VARIANT &pa_OUT) {
