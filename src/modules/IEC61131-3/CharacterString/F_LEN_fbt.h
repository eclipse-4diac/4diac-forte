...
class FORTE_F_LEN : public CFunctionBlock {
  ...
  public:
    FORTE_F_LEN(const CStringDictionary::TStringId paInstanceNameId, forte::core::CFBContainer &paContainer);
    ...
    void evt_REQ(const CIEC_ANY_STRING &pa_IN, CIEC_ANY_INT &pa_OUT) {
      var_IN = pa_IN;
      receiveInputEvent(scmEventREQID, nullptr);
      pa_OUT.setValue(var_OUT.unwrap());
    }

    void operator()(const CIEC_ANY_STRING &pa_IN, CIEC_ANY_INT &pa_OUT) {
