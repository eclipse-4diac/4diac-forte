...
class FORTE_F_DELETE : public CFunctionBlock {
  ...
  public:
    FORTE_F_DELETE(const CStringDictionary::TStringId paInstanceNameId, forte::core::CFBContainer &paContainer);
    ...
    void
    evt_REQ(const CIEC_ANY_STRING &pa_IN, const CIEC_ANY_INT &pa_L, const CIEC_ANY_INT &pa_P, CIEC_ANY_STRING &pa_OUT) {
      var_IN = pa_IN;
      var_L = pa_L;
      var_P = pa_P;
