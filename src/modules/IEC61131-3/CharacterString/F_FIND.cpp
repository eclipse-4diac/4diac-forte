...
const TDataIOID FORTE_F_FIND::scm_anEIWith[] = {0, 1, scmWithListDelimiter};
...
const TDataIOID FORTE_F_FIND::scm_anEOWith[] = {0, scmWithListDelimiter};
...
void FORTE_F_FIND::executeEvent(TEventID pa_nEIID) {
  switch(pa_nEIID) {
...
void FORTE_F_FIND::readInputData(TEventID pa_nEIID) {
  switch(pa_nEIID) {
    case scm_nEventREQID: {
...
void FORTE_F_FIND::writeOutputData(TEventID pa_nEIID) {
  switch(pa_nEIID) {
