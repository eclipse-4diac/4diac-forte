...
public:
  FORTE_F_MID(const CStringDictionary::TStringId pa_nInstanceNameId, CResource *pa_poSrcRes);
  ...
  void evt_REQ(const CIEC_ANY_STRING_VARIANT &pa_IN, const CIEC_ANY_INT_VARIANT &pa_L, const CIEC_ANY_INT_VARIANT &pa_P, CIEC_ANY_STRING_VARIANT &pa_OUT) {
    var_IN = pa_IN;
    var_L = pa_L;
    var_P = pa_P;
  ...
  void operator()(const CIEC_ANY_STRING_VARIANT &pa_IN, const CIEC_ANY_INT_VARIANT &pa_L, const CIEC_ANY_INT_VARIANT &pa_P, CIEC_ANY_STRING_VARIANT &pa_OUT) {
