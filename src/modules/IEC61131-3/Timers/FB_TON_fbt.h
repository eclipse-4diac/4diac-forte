...
class FORTE_FB_TON final : public CFunctionBlock {
  DECLARE_FIRMWARE_FB(FORTE_FB_TON)
...
public:
  FORTE_FB_TON(const CStringDictionary::TStringId paInstanceNameId, forte::core::CFBContainer &paContainer);
