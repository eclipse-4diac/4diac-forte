...
namespace {
  ...
  const auto cDataOutputNames = std::array{STRID(Q), STRID(ET)};
...
FORTE_FB_TOF::FORTE_FB_TOF(const forte::core::InstanceNameId paInstanceNameId, forte::core::CFBContainer &paContainer) :
