...
const CStringDictionary::TStringId FORTE_F_SIN::scmEventInputTypeIds[] = {g_nStringIdEvent};
...
const CStringDictionary::TStringId FORTE_F_SIN::scmEventOutputTypeIds[] = {g_nStringIdEvent};
