...
const TDataIOID FORTE_F_COS::scm_anEIWith[] = {0, scmWithListDelimiter};
...
const TDataIOID FORTE_F_COS::scm_anEOWith[] = {0, scmWithListDelimiter};
...
void FORTE_F_COS::executeEvent(TEventID pa_nEIID) {
  switch(pa_nEIID) {
...
void FORTE_F_COS::readInputData(TEventID pa_nEIID) {
  switch(pa_nEIID) {
    case scm_nEventREQID: {
...
void FORTE_F_COS::writeOutputData(TEventID pa_nEIID) {
  switch(pa_nEIID) {
