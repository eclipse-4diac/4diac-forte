...
const CStringDictionary::TStringId FORTE_F_EXP::scmEventInputTypeIds[] = {g_nStringIdEvent};
...
const CStringDictionary::TStringId FORTE_F_EXP::scmEventOutputTypeIds[] = {g_nStringIdEvent};
