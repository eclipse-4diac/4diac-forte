...
const TDataIOID FORTE_F_ATAN::scm_anEIWith[] = {0, scmWithListDelimiter};
...
const TDataIOID FORTE_F_ATAN::scm_anEOWith[] = {0, scmWithListDelimiter};
const TForteInt16 FORTE_F_ATAN::scm_anEOWithIndexes[] = {0};
...
FORTE_F_ATAN::FORTE_F_ATAN(const CStringDictionary::TStringId pa_nInstanceNameId, CResource *pa_poSrcRes) :
...
void FORTE_F_ATAN::executeEvent(TEventID pa_nEIID) {
  switch(pa_nEIID) {
...
void FORTE_F_ATAN::readInputData(TEventID pa_nEIID) {
  switch(pa_nEIID) {
    case scm_nEventREQID: {
...
void FORTE_F_ATAN::writeOutputData(TEventID pa_nEIID) {
  switch(pa_nEIID) {
