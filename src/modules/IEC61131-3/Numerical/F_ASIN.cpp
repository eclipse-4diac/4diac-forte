...
const TDataIOID FORTE_F_ASIN::scm_anEIWith[] = {0, scmWithListDelimiter};
...
const TDataIOID FORTE_F_ASIN::scm_anEOWith[] = {0, scmWithListDelimiter};
const TForteInt16 FORTE_F_ASIN::scm_anEOWithIndexes[] = {0};
...
FORTE_F_ASIN::FORTE_F_ASIN(const CStringDictionary::TStringId pa_nInstanceNameId, CResource *pa_poSrcRes) :
...
void FORTE_F_ASIN::executeEvent(TEventID pa_nEIID) {
  switch(pa_nEIID) {
...
void FORTE_F_ASIN::readInputData(TEventID pa_nEIID) {
  switch(pa_nEIID) {
    case scm_nEventREQID: {
...
void FORTE_F_ASIN::writeOutputData(TEventID pa_nEIID) {
  switch(pa_nEIID) {
