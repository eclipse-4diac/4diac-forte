...
const TDataIOID FORTE_F_MUL::scm_anEIWith[] = {0, 1, scmWithListDelimiter};
...
const TDataIOID FORTE_F_MUL::scm_anEOWith[] = {0, scmWithListDelimiter};
...
FORTE_F_MUL::FORTE_F_MUL(const CStringDictionary::TStringId pa_nInstanceNameId, CResource *pa_poSrcRes) :
...
void FORTE_F_MUL::executeEvent(TEventID pa_nEIID) {
  switch(pa_nEIID) {
...
void FORTE_F_MUL::readInputData(TEventID pa_nEIID) {
  switch(pa_nEIID) {
    case scm_nEventREQID: {
...
void FORTE_F_MUL::writeOutputData(TEventID pa_nEIID) {
  switch(pa_nEIID) {
