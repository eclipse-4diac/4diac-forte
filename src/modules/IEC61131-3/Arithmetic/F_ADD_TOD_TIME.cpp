...
const TDataIOID FORTE_F_ADD_TOD_TIME::scm_anEIWith[] = {0, 1, scmWithListDelimiter};
...
const TDataIOID FORTE_F_ADD_TOD_TIME::scm_anEOWith[] = {0, scmWithListDelimiter};
const TForteInt16 FORTE_F_ADD_TOD_TIME::scm_anEOWithIndexes[] = {0};
...
FORTE_F_ADD_TOD_TIME::FORTE_F_ADD_TOD_TIME(const CStringDictionary::TStringId pa_nInstanceNameId, CResource *pa_poSrcRes) :
...
void FORTE_F_ADD_TOD_TIME::executeEvent(TEventID pa_nEIID) {
  switch(pa_nEIID) {
...
void FORTE_F_ADD_TOD_TIME::readInputData(TEventID pa_nEIID) {
  switch(pa_nEIID) {
    case scm_nEventREQID: {
...
void FORTE_F_ADD_TOD_TIME::writeOutputData(TEventID pa_nEIID) {
  switch(pa_nEIID) {
