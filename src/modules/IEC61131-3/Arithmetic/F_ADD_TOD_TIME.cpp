...
FORTE_F_ADD_TOD_TIME::FORTE_F_ADD_TOD_TIME(const CStringDictionary::TStringId paInstanceNameId, CResource *paSrcRes) :
...
void FORTE_F_ADD_TOD_TIME::executeEvent(TEventID paEIID) {
  switch(paEIID) {
    case scmEventREQID:
