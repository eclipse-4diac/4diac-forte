...
#include "F_ADD_TOD_TIME_fbt_gen.cpp"
#endif
...
const CStringDictionary::TStringId FORTE_F_ADD_TOD_TIME::scmDataInputNames[] = {g_nStringIdIN1, g_nStringIdIN2};

const CStringDictionary::TStringId FORTE_F_ADD_TOD_TIME::scmDataInputTypeIds[] = {g_nStringIdTIME_OF_DAY, g_nStringIdTIME};

const CStringDictionary::TStringId FORTE_F_ADD_TOD_TIME::scmDataOutputNames[] = {g_nStringIdOUT};

const CStringDictionary::TStringId FORTE_F_ADD_TOD_TIME::scmDataOutputTypeIds[] = {g_nStringIdTIME_OF_DAY};
...
const CStringDictionary::TStringId FORTE_F_ADD_TOD_TIME::scmEventInputNames[] = {g_nStringIdREQ};
const CStringDictionary::TStringId FORTE_F_ADD_TOD_TIME::scmEventInputTypeIds[] = {g_nStringIdEvent};
...
const CStringDictionary::TStringId FORTE_F_ADD_TOD_TIME::scmEventOutputNames[] = {g_nStringIdCNF};
const CStringDictionary::TStringId FORTE_F_ADD_TOD_TIME::scmEventOutputTypeIds[] = {g_nStringIdEvent};
