...
const TDataIOID FORTE_F_DIVTIME::scm_anEIWith[] = {0, 1, scmWithListDelimiter};
...
const TDataIOID FORTE_F_DIVTIME::scm_anEOWith[] = {0, scmWithListDelimiter};
const TForteInt16 FORTE_F_DIVTIME::scm_anEOWithIndexes[] = {0};
...
FORTE_F_DIVTIME::FORTE_F_DIVTIME(const CStringDictionary::TStringId pa_nInstanceNameId, CResource *pa_poSrcRes) :
...
void FORTE_F_DIVTIME::executeEvent(TEventID pa_nEIID) {
  switch(pa_nEIID) {
...
void FORTE_F_DIVTIME::readInputData(TEventID pa_nEIID) {
  switch(pa_nEIID) {
    case scm_nEventREQID: {
...
void FORTE_F_DIVTIME::writeOutputData(TEventID pa_nEIID) {
  switch(pa_nEIID) {
