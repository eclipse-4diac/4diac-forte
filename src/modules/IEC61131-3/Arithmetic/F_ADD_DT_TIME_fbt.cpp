...
#include "F_ADD_DT_TIME_fbt_gen.cpp"
#endif
...
const CStringDictionary::TStringId FORTE_F_ADD_DT_TIME::scmDataInputNames[] = {g_nStringIdIN1, g_nStringIdIN2};

const CStringDictionary::TStringId FORTE_F_ADD_DT_TIME::scmDataInputTypeIds[] = {g_nStringIdDATE_AND_TIME, g_nStringIdTIME};

const CStringDictionary::TStringId FORTE_F_ADD_DT_TIME::scmDataOutputNames[] = {g_nStringIdOUT};

const CStringDictionary::TStringId FORTE_F_ADD_DT_TIME::scmDataOutputTypeIds[] = {g_nStringIdDATE_AND_TIME};
...
const CStringDictionary::TStringId FORTE_F_ADD_DT_TIME::scmEventInputNames[] = {g_nStringIdREQ};
const CStringDictionary::TStringId FORTE_F_ADD_DT_TIME::scmEventInputTypeIds[] = {g_nStringIdEvent};
...
const CStringDictionary::TStringId FORTE_F_ADD_DT_TIME::scmEventOutputNames[] = {g_nStringIdCNF};
const CStringDictionary::TStringId FORTE_F_ADD_DT_TIME::scmEventOutputTypeIds[] = {g_nStringIdEvent};


const SFBInterfaceSpec FORTE_F_ADD_DT_TIME::scmFBInterfaceSpec = {
