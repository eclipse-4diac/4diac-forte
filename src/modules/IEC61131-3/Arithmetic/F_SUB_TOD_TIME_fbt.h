...
class FORTE_F_SUB_TOD_TIME : public CFunctionBlock {
  ...
  public:
    FORTE_F_SUB_TOD_TIME(const forte::core::InstanceNameId paInstanceNameId, forte::core::CFBContainer &paContainer);
    ...
    void evt_REQ(const CIEC_TIME_OF_DAY &pa_IN1, const CIEC_TIME &pa_IN2, CIEC_TIME_OF_DAY &pa_OUT) {
      var_IN1 = pa_IN1;
      var_IN2 = pa_IN2;
    ...
    void operator()(const CIEC_TIME_OF_DAY &pa_IN1, const CIEC_TIME &pa_IN2, CIEC_TIME_OF_DAY &pa_OUT) {
