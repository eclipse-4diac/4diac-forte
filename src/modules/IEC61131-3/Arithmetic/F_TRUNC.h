...
public:
  FORTE_F_TRUNC(const CStringDictionary::TStringId pa_nInstanceNameId, CResource *pa_poSrcRes);
  ...
  void evt_REQ(const CIEC_ANY_REAL_VARIANT &pa_IN, CIEC_ANY_INT_VARIANT &pa_OUT) {
    var_IN = pa_IN;
    receiveInputEvent(scm_nEventREQID, nullptr);
    pa_OUT = var_OUT;
  }
  
  void operator()(const CIEC_ANY_REAL_VARIANT &pa_IN, CIEC_ANY_INT_VARIANT &pa_OUT) {
