...
const SFBInterfaceSpec FORTE_F_SUB_DT_DT::scm_stFBInterfaceSpec = { 1, scm_anEventInputNames, scm_anEIWith, scm_anEIWithIndexes, 1, scm_anEventOutputNames,
