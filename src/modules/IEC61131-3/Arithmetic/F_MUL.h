...
public:
  FORTE_F_MUL(const CStringDictionary::TStringId pa_nInstanceNameId, CResource *pa_poSrcRes);
  ...
  void evt_REQ(const CIEC_ANY_NUM_VARIANT &pa_IN1, const CIEC_ANY_NUM_VARIANT &pa_IN2, CIEC_ANY_NUM_VARIANT &pa_OUT) {
    var_IN1 = pa_IN1;
    var_IN2 = pa_IN2;
  ...
  void operator()(const CIEC_ANY_NUM_VARIANT &pa_IN1, const CIEC_ANY_NUM_VARIANT &pa_IN2, CIEC_ANY_NUM_VARIANT &pa_OUT) {
