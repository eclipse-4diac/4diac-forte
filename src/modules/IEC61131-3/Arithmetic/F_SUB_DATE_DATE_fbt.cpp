...
const SFBInterfaceSpec FORTE_F_SUB_DATE_DATE::scmFBInterfaceSpec = {1,
                                                                    scmEventInputNames,
...
FORTE_F_SUB_DATE_DATE::FORTE_F_SUB_DATE_DATE(const CStringDictionary::TStringId paInstanceNameId,
...
void FORTE_F_SUB_DATE_DATE::setInitialValues() {
  var_IN1 = CIEC_DATE();
  var_IN2 = CIEC_DATE();
  var_OUT = CIEC_TIME();
}
