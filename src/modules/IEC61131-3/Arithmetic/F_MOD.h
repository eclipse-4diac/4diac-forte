...
public:
  ...
  void evt_REQ(const CIEC_ANY_INT &pa_IN1, const CIEC_ANY_INT &pa_IN2, CIEC_ANY_NUM &pa_OUT) {
    var_IN1 = pa_IN1;
    var_IN2 = pa_IN2;
  ...
  void operator()(const CIEC_ANY_INT &pa_IN1, const CIEC_ANY_INT &pa_IN2, CIEC_ANY_NUM &pa_OUT) {
