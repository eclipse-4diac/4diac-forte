...
const SFBInterfaceSpec FORTE_F_SUB_TOD_TOD::scm_stFBInterfaceSpec = { 1, scm_anEventInputNames, scm_anEIWith, scm_anEIWithIndexes, 1, scm_anEventOutputNames,
...
void FORTE_F_SUB_TOD_TOD::executeEvent(int pa_nEIID) {
  if(scm_nEventREQID == pa_nEIID) {
    st_OUT() = func_SUB_TOD_TOD(IN1(), IN2());
