...
const TDataIOID FORTE_F_SUB_TOD_TOD::scm_anEIWith[] = {0, 1, scmWithListDelimiter};
...
const TDataIOID FORTE_F_SUB_TOD_TOD::scm_anEOWith[] = {0, scmWithListDelimiter};
const TForteInt16 FORTE_F_SUB_TOD_TOD::scm_anEOWithIndexes[] = {0};
...
FORTE_F_SUB_TOD_TOD::FORTE_F_SUB_TOD_TOD(const CStringDictionary::TStringId pa_nInstanceNameId, CResource *pa_poSrcRes) :
...
void FORTE_F_SUB_TOD_TOD::executeEvent(TEventID pa_nEIID) {
  switch(pa_nEIID) {
...
void FORTE_F_SUB_TOD_TOD::readInputData(TEventID pa_nEIID) {
  switch(pa_nEIID) {
    case scm_nEventREQID: {
...
void FORTE_F_SUB_TOD_TOD::writeOutputData(TEventID pa_nEIID) {
  switch(pa_nEIID) {
