...
const TDataIOID FORTE_F_SUB::scm_anEIWith[] = {0, 1, scmWithListDelimiter};
...
const TDataIOID FORTE_F_SUB::scm_anEOWith[] = {0, scmWithListDelimiter};
...
const SFBInterfaceSpec FORTE_F_SUB::scm_stFBInterfaceSpec = {
...
FORTE_F_SUB::FORTE_F_SUB(const CStringDictionary::TStringId pa_nInstanceNameId, CResource *pa_poSrcRes) :
...
void FORTE_F_SUB::executeEvent(TEventID pa_nEIID) {
  switch(pa_nEIID) {
...
void FORTE_F_SUB::readInputData(TEventID pa_nEIID) {
  switch(pa_nEIID) {
    case scm_nEventREQID: {
...
void FORTE_F_SUB::writeOutputData(TEventID pa_nEIID) {
  switch(pa_nEIID) {
