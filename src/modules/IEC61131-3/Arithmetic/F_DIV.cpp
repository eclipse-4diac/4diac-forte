...
const TDataIOID FORTE_F_DIV::scm_anEIWith[] = {0, 1, scmWithListDelimiter};
...
const TDataIOID FORTE_F_DIV::scm_anEOWith[] = {0, scmWithListDelimiter};
...
FORTE_F_DIV::FORTE_F_DIV(const CStringDictionary::TStringId pa_nInstanceNameId, CResource *pa_poSrcRes) :
...
void FORTE_F_DIV::executeEvent(TEventID pa_nEIID) {
  switch(pa_nEIID) {
...
void FORTE_F_DIV::readInputData(TEventID pa_nEIID) {
  switch(pa_nEIID) {
    case scm_nEventREQID: {
...
void FORTE_F_DIV::writeOutputData(TEventID pa_nEIID) {
  switch(pa_nEIID) {
