...
const TDataIOID FORTE_F_ROR::scm_anEIWith[] = {0, 1, scmWithListDelimiter};
...
const TDataIOID FORTE_F_ROR::scm_anEOWith[] = {0, scmWithListDelimiter};
const TForteInt16 FORTE_F_ROR::scm_anEOWithIndexes[] = {0};
...
FORTE_F_ROR::FORTE_F_ROR(const CStringDictionary::TStringId pa_nInstanceNameId, CResource *pa_poSrcRes) :
...
void FORTE_F_ROR::executeEvent(TEventID pa_nEIID) {
  switch(pa_nEIID) {
...
void FORTE_F_ROR::readInputData(TEventID pa_nEIID) {
  switch(pa_nEIID) {
    case scm_nEventREQID: {
...
void FORTE_F_ROR::writeOutputData(TEventID pa_nEIID) {
  switch(pa_nEIID) {
