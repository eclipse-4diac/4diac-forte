...
const TDataIOID FORTE_F_AND::scm_anEIWith[] = {0, 1, scmWithListDelimiter};
...
const TDataIOID FORTE_F_AND::scm_anEOWith[] = {0, scmWithListDelimiter};
const TForteInt16 FORTE_F_AND::scm_anEOWithIndexes[] = {0};
...
FORTE_F_AND::FORTE_F_AND(const CStringDictionary::TStringId pa_nInstanceNameId, CResource *pa_poSrcRes) :
...
void FORTE_F_AND::executeEvent(TEventID pa_nEIID) {
  switch(pa_nEIID) {
...
void FORTE_F_AND::readInputData(TEventID pa_nEIID) {
  switch(pa_nEIID) {
    case scm_nEventREQID: {
...
void FORTE_F_AND::writeOutputData(TEventID pa_nEIID) {
  switch(pa_nEIID) {
