...
public:
  FORTE_F_ROR(const CStringDictionary::TStringId pa_nInstanceNameId, CResource *pa_poSrcRes);
  ...
  void evt_REQ(const CIEC_ANY_BIT_VARIANT &pa_IN, const CIEC_ANY_INT_VARIANT &pa_N, CIEC_ANY_BIT_VARIANT &pa_OUT) {
    var_IN = pa_IN;
    var_N = pa_N;
  ...
  void operator()(const CIEC_ANY_BIT_VARIANT &pa_IN, const CIEC_ANY_INT_VARIANT &pa_N, CIEC_ANY_BIT_VARIANT &pa_OUT) {
