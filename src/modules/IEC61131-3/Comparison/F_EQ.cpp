...
const TDataIOID FORTE_F_EQ::scm_anEIWith[] = {0, 1, scmWithListDelimiter};
...
const TDataIOID FORTE_F_EQ::scm_anEOWith[] = {0, scmWithListDelimiter};
const TForteInt16 FORTE_F_EQ::scm_anEOWithIndexes[] = {0};
...
FORTE_F_EQ::FORTE_F_EQ(const CStringDictionary::TStringId pa_nInstanceNameId, CResource *pa_poSrcRes) :
...
void FORTE_F_EQ::executeEvent(TEventID pa_nEIID) {
  switch(pa_nEIID) {
...
void FORTE_F_EQ::readInputData(TEventID pa_nEIID) {
  switch(pa_nEIID) {
    case scm_nEventREQID: {
...
void FORTE_F_EQ::writeOutputData(TEventID pa_nEIID) {
  switch(pa_nEIID) {
