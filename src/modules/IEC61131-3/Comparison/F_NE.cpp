...
const TDataIOID FORTE_F_NE::scm_anEIWith[] = {0, 1, scmWithListDelimiter};
...
const TDataIOID FORTE_F_NE::scm_anEOWith[] = {0, scmWithListDelimiter};
const TForteInt16 FORTE_F_NE::scm_anEOWithIndexes[] = {0};
...
FORTE_F_NE::FORTE_F_NE(const CStringDictionary::TStringId pa_nInstanceNameId, CResource *pa_poSrcRes) :
...
void FORTE_F_NE::executeEvent(TEventID pa_nEIID) {
  switch(pa_nEIID) {
...
void FORTE_F_NE::readInputData(TEventID pa_nEIID) {
  switch(pa_nEIID) {
    case scm_nEventREQID: {
...
void FORTE_F_NE::writeOutputData(TEventID pa_nEIID) {
  switch(pa_nEIID) {
