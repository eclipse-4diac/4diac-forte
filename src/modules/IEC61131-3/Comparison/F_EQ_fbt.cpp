...
const CStringDictionary::TStringId FORTE_F_EQ::scmEventInputTypeIds[] = {g_nStringIdEvent};
...
const CStringDictionary::TStringId FORTE_F_EQ::scmEventOutputTypeIds[] = {g_nStringIdEvent};
