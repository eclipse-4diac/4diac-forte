...
const TDataIOID FORTE_F_GE::scm_anEIWith[] = {0, 1, scmWithListDelimiter};
...
const TDataIOID FORTE_F_GE::scm_anEOWith[] = {0, scmWithListDelimiter};
const TForteInt16 FORTE_F_GE::scm_anEOWithIndexes[] = {0};
...
FORTE_F_GE::FORTE_F_GE(const CStringDictionary::TStringId pa_nInstanceNameId, CResource *pa_poSrcRes) :
...
void FORTE_F_GE::executeEvent(TEventID pa_nEIID) {
  switch(pa_nEIID) {
...
void FORTE_F_GE::readInputData(TEventID pa_nEIID) {
  switch(pa_nEIID) {
    case scm_nEventREQID: {
...
void FORTE_F_GE::writeOutputData(TEventID pa_nEIID) {
  switch(pa_nEIID) {
