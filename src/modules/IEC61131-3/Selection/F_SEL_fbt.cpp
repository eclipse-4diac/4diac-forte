...
namespace {
  const auto cDataInputNames = std::array{STRID(G), STRID(IN0), STRID(IN1)};
...
FORTE_F_SEL::FORTE_F_SEL(const forte::core::InstanceNameId paInstanceNameId, forte::core::CFBContainer &paContainer) :
