...
const TDataIOID FORTE_FB_RS::scm_anEIWith[] = {0, 1, 255};
...
const TDataIOID FORTE_FB_RS::scm_anEOWith[] = {0, 255};
...
void FORTE_FB_RS::executeEvent(int pa_nEIID){
  switch(pa_nEIID) {
...
void FORTE_FB_RS::readInputData(size_t pa_nEIID) {
  switch(pa_nEIID) {
    case scm_nEventREQID: {
...
void FORTE_FB_RS::writeOutputData(size_t pa_nEIID) {
  switch(pa_nEIID) {
