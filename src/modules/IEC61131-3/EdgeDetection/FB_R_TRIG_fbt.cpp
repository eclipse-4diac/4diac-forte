...
const CStringDictionary::TStringId FORTE_FB_R_TRIG::scmEventInputTypeIds[] = {g_nStringIdEvent};
...
const CStringDictionary::TStringId FORTE_FB_R_TRIG::scmEventOutputTypeIds[] = {g_nStringIdEvent};
