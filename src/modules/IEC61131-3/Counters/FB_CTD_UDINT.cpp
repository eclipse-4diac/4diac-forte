...
void FORTE_FB_CTD_UDINT::executeEvent(int pa_nEIID){
  switch(pa_nEIID) {
...
void FORTE_FB_CTD_UDINT::readInputData(size_t pa_nEIID) {
  switch(pa_nEIID) {
    case scm_nEventREQID: {
...
void FORTE_FB_CTD_UDINT::writeOutputData(size_t pa_nEIID) {
  switch(pa_nEIID) {
