...
const TDataIOID FORTE_FB_CTD_ULINT::scm_anEIWith[] = {0, 2, 1, 255};
...
const TDataIOID FORTE_FB_CTD_ULINT::scm_anEOWith[] = {0, 1, 255};
...
void FORTE_FB_CTD_ULINT::executeEvent(int pa_nEIID){
  switch(pa_nEIID) {
...
void FORTE_FB_CTD_ULINT::readInputData(size_t pa_nEIID) {
  switch(pa_nEIID) {
    case scm_nEventREQID: {
...
void FORTE_FB_CTD_ULINT::writeOutputData(size_t pa_nEIID) {
  switch(pa_nEIID) {
