...
const TDataIOID FORTE_FB_CTU::scm_anEIWith[] = {0, 1, 255};
...
const TDataIOID FORTE_FB_CTU::scm_anEOWith[] = {0, 1, 255};
...
void FORTE_FB_CTU::alg_REQ(void) {
  ...
  else if (func_AND<CIEC_BOOL>(var_CU, func_LT(var_CV, CIEC_INT(32767)))) {
