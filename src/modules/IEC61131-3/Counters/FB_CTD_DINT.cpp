...
const TDataIOID FORTE_FB_CTD_DINT::scm_anEIWith[] = {0, 2, 1, scmWithListDelimiter};
...
const TDataIOID FORTE_FB_CTD_DINT::scm_anEOWith[] = {0, 1, scmWithListDelimiter};
...
void FORTE_FB_CTD_DINT::executeEvent(TEventID pa_nEIID){
  switch(pa_nEIID) {
...
void FORTE_FB_CTD_DINT::readInputData(TEventID pa_nEIID) {
  switch(pa_nEIID) {
    case scm_nEventREQID: {
...
void FORTE_FB_CTD_DINT::writeOutputData(TEventID pa_nEIID) {
  switch(pa_nEIID) {
