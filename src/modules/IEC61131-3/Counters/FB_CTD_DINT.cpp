...
FORTE_FB_CTD_DINT::FORTE_FB_CTD_DINT(CStringDictionary::TStringId paInstanceNameId, CResource *paSrcRes) :
...
void FORTE_FB_CTD_DINT::executeEvent(TEventID paEIID){
  switch(paEIID) {
    case scmEventREQID:
      alg_REQ();
      break;
