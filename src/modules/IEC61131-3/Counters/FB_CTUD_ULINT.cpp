...
void FORTE_FB_CTUD_ULINT::executeEvent(int pa_nEIID){
  switch(pa_nEIID) {
...
void FORTE_FB_CTUD_ULINT::readInputData(size_t pa_nEIID) {
  switch(pa_nEIID) {
    case scm_nEventREQID: {
...
void FORTE_FB_CTUD_ULINT::writeOutputData(size_t pa_nEIID) {
  switch(pa_nEIID) {
