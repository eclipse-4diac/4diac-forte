...
const TDataIOID FORTE_FB_CTU_DINT::scm_anEIWith[] = {0, 1, 255};
...
const TDataIOID FORTE_FB_CTU_DINT::scm_anEOWith[] = {0, 1, 255};
...
void FORTE_FB_CTU_DINT::alg_REQ(void) {
  ...
  else if (func_AND<CIEC_BOOL>(var_CU, func_LT(var_CV, CIEC_DINT(2147483647)))) {
...
void FORTE_FB_CTU_DINT::executeEvent(int pa_nEIID){
  switch(pa_nEIID) {
...
void FORTE_FB_CTU_DINT::readInputData(size_t pa_nEIID) {
  switch(pa_nEIID) {
    case scm_nEventREQID: {
...
void FORTE_FB_CTU_DINT::writeOutputData(size_t pa_nEIID) {
  switch(pa_nEIID) {
