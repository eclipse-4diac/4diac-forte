...
class FORTE_FB_CTUD_ULINT: public CSimpleFB {
...
public:
  FORTE_FB_CTUD_ULINT(CStringDictionary::TStringId pa_nInstanceNameId, CResource *pa_poSrcRes);
  ...
  void evt_REQ(const CIEC_BOOL &pa_CU, const CIEC_BOOL &pa_CD, const CIEC_BOOL &pa_R, const CIEC_BOOL &pa_LD, const CIEC_ULINT &pa_PV, CIEC_BOOL &pa_QU, CIEC_BOOL &pa_QD, CIEC_ULINT &pa_CV) {
    var_CU = pa_CU;
    var_CD = pa_CD;
    var_R = pa_R;
    var_LD = pa_LD;
  ...
  void operator()(const CIEC_BOOL &pa_CU, const CIEC_BOOL &pa_CD, const CIEC_BOOL &pa_R, const CIEC_BOOL &pa_LD, const CIEC_ULINT &pa_PV, CIEC_BOOL &pa_QU, CIEC_BOOL &pa_QD, CIEC_ULINT &pa_CV) {
