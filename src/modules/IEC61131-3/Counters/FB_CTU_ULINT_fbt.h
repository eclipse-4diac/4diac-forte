...
class FORTE_FB_CTU_ULINT final : public CSimpleFB {
  ...
  public:
    ...
    void evt_REQ(const CIEC_BOOL &paCU, const CIEC_BOOL &paR, const CIEC_ULINT &paPV, CIEC_BOOL &paQ, CIEC_ULINT &paCV) {
      var_CU = paCU;
      var_R = paR;
      var_PV = paPV;
    ...
    void operator()(const CIEC_BOOL &paCU, const CIEC_BOOL &paR, const CIEC_ULINT &paPV, CIEC_BOOL &paQ, CIEC_ULINT &paCV) {
