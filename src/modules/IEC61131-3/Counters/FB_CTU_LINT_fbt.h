...
class FORTE_FB_CTU_LINT : public CSimpleFB {
  ...
  public:
    ...
    void
    evt_REQ(const CIEC_BOOL &pa_CU, const CIEC_BOOL &pa_R, const CIEC_LINT &pa_PV, CIEC_BOOL &pa_Q, CIEC_LINT &pa_CV) {
      var_CU = pa_CU;
      var_R = pa_R;
      var_PV = pa_PV;
    ...
    void operator()(
        const CIEC_BOOL &pa_CU, const CIEC_BOOL &pa_R, const CIEC_LINT &pa_PV, CIEC_BOOL &pa_Q, CIEC_LINT &pa_CV) {
