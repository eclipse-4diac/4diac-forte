...
const TDataIOID FORTE_FB_CTUD_DINT::scm_anEIWith[] = {0, 1, 2, 3, 4, 255};
...
const TDataIOID FORTE_FB_CTUD_DINT::scm_anEOWith[] = {0, 1, 2, 255};
...
void FORTE_FB_CTUD_DINT::executeEvent(int pa_nEIID){
  switch(pa_nEIID) {
...
void FORTE_FB_CTUD_DINT::readInputData(size_t pa_nEIID) {
  switch(pa_nEIID) {
    case scm_nEventREQID: {
...
void FORTE_FB_CTUD_DINT::writeOutputData(size_t pa_nEIID) {
  switch(pa_nEIID) {
