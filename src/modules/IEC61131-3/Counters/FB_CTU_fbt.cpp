...
const CStringDictionary::TStringId FORTE_FB_CTU::scmEventInputTypeIds[] = {g_nStringIdEvent};
...
const CStringDictionary::TStringId FORTE_FB_CTU::scmEventOutputTypeIds[] = {g_nStringIdEvent};
