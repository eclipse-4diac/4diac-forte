...
DEFINE_FIRMWARE_FB(FORTE_FB_CTD_ULINT, "FB_CTD_ULINT"_STRID)


FORTE_FB_CTD_ULINT::FORTE_FB_CTD_ULINT(const forte::core::StringId paInstanceNameId, forte::core::CFBContainer &paContainer) :
