...
void FORTE_FB_CTUD_LINT::executeEvent(int pa_nEIID){
  switch(pa_nEIID) {
...
void FORTE_FB_CTUD_LINT::readInputData(size_t pa_nEIID) {
  switch(pa_nEIID) {
    case scm_nEventREQID: {
...
void FORTE_FB_CTUD_LINT::writeOutputData(size_t pa_nEIID) {
  switch(pa_nEIID) {
