...
const CStringDictionary::TStringId FORTE_FB_CTUD_LINT::scm_anDataInputNames[] = {g_nStringIdCU, g_nStringIdCD, g_nStringIdR, g_nStringIdLD, g_nStringIdPV};

const CStringDictionary::TStringId FORTE_FB_CTUD_LINT::scm_anDataInputTypeIds[] = {g_nStringIdBOOL, g_nStringIdBOOL, g_nStringIdBOOL, g_nStringIdBOOL, g_nStringIdLINT};

const CStringDictionary::TStringId FORTE_FB_CTUD_LINT::scm_anDataOutputNames[] = {g_nStringIdQU, g_nStringIdQD, g_nStringIdCV};

const CStringDictionary::TStringId FORTE_FB_CTUD_LINT::scm_anDataOutputTypeIds[] = {g_nStringIdBOOL, g_nStringIdBOOL, g_nStringIdLINT};

const TDataIOID FORTE_FB_CTUD_LINT::scm_anEIWith[] = {0, 1, 2, 3, 4, scmWithListDelimiter};
const TForteInt16 FORTE_FB_CTUD_LINT::scm_anEIWithIndexes[] = {0};
const CStringDictionary::TStringId FORTE_FB_CTUD_LINT::scm_anEventInputNames[] = {g_nStringIdREQ};

const TDataIOID FORTE_FB_CTUD_LINT::scm_anEOWith[] = {0, 1, 2, scmWithListDelimiter};
const TForteInt16 FORTE_FB_CTUD_LINT::scm_anEOWithIndexes[] = {0};
const CStringDictionary::TStringId FORTE_FB_CTUD_LINT::scm_anEventOutputNames[] = {g_nStringIdCNF};


const SFBInterfaceSpec FORTE_FB_CTUD_LINT::scm_stFBInterfaceSpec = {
...
FORTE_FB_CTUD_LINT::FORTE_FB_CTUD_LINT(CStringDictionary::TStringId pa_nInstanceNameId, CResource *pa_poSrcRes) :
  ...
  if (var_R) {
    ...
    if (var_LD) {
      ...
      if (func_NOT<CIEC_BOOL>(func_AND<CIEC_BOOL>(var_CU, var_CD))) {
        if (func_AND<CIEC_BOOL>(var_CU, func_LT(var_CV, CIEC_LINT(9223372036854775807)))) {
...
void FORTE_FB_CTUD_LINT::executeEvent(TEventID pa_nEIID){
  switch(pa_nEIID) {
...
void FORTE_FB_CTUD_LINT::readInputData(TEventID pa_nEIID) {
  switch(pa_nEIID) {
    case scm_nEventREQID: {
...
void FORTE_FB_CTUD_LINT::writeOutputData(TEventID pa_nEIID) {
  switch(pa_nEIID) {
