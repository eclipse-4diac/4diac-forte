...
const TDataIOID FORTE_FB_CTU_UDINT::scm_anEIWith[] = {0, 1, 255};
...
const TDataIOID FORTE_FB_CTU_UDINT::scm_anEOWith[] = {0, 1, 255};
...
void FORTE_FB_CTU_UDINT::executeEvent(int pa_nEIID){
  switch(pa_nEIID) {
...
void FORTE_FB_CTU_UDINT::readInputData(size_t pa_nEIID) {
  switch(pa_nEIID) {
    case scm_nEventREQID: {
...
void FORTE_FB_CTU_UDINT::writeOutputData(size_t pa_nEIID) {
  switch(pa_nEIID) {
