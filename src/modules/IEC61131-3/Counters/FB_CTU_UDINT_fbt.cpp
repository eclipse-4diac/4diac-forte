...
DEFINE_FIRMWARE_FB(FORTE_FB_CTU_UDINT, "FB_CTU_UDINT"_STRID)


FORTE_FB_CTU_UDINT::FORTE_FB_CTU_UDINT(const forte::core::StringId paInstanceNameId, forte::core::CFBContainer &paContainer) :
