...
FORTE_F_STRING_AS_UDINT::FORTE_F_STRING_AS_UDINT(CStringDictionary::TStringId paInstanceNameId, CResource *paSrcRes) :
...
void FORTE_F_STRING_AS_UDINT::executeEvent(TEventID paEIID){
  switch(paEIID) {
    case scmEventREQID:
      alg_REQ();
      break;
