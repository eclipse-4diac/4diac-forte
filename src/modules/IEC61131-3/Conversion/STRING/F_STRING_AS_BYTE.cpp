...
const TDataIOID FORTE_F_STRING_AS_BYTE::scm_anEIWith[] = {0, 255};
...
const TDataIOID FORTE_F_STRING_AS_BYTE::scm_anEOWith[] = {0, 255};
...
void FORTE_F_STRING_AS_BYTE::executeEvent(int pa_nEIID){
  switch(pa_nEIID) {
...
void FORTE_F_STRING_AS_BYTE::readInputData(size_t pa_nEIID) {
  switch(pa_nEIID) {
    case scm_nEventREQID: {
...
void FORTE_F_STRING_AS_BYTE::writeOutputData(size_t pa_nEIID) {
  switch(pa_nEIID) {
