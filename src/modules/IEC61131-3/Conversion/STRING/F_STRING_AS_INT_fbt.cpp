...
#include "F_STRING_AS_INT_fbt_gen.cpp"
#endif
...
const CStringDictionary::TStringId FORTE_F_STRING_AS_INT::scmEventInputTypeIds[] = {g_nStringIdEvent};
...
const CStringDictionary::TStringId FORTE_F_STRING_AS_INT::scmEventOutputTypeIds[] = {g_nStringIdEvent};
