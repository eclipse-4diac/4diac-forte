...
const CStringDictionary::TStringId FORTE_F_STRING_AS_INT::scmEventInputTypeIds[] = {STRID(Event)};
...
const CStringDictionary::TStringId FORTE_F_STRING_AS_INT::scmEventOutputTypeIds[] = {STRID(Event)};

const SFBInterfaceSpec FORTE_F_STRING_AS_INT::scmFBInterfaceSpec = {1,
                                                                    scmEventInputNames,
...
FORTE_F_STRING_AS_INT::FORTE_F_STRING_AS_INT(CStringDictionary::TStringId paInstanceNameId,
