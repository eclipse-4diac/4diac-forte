...
const TDataIOID FORTE_F_STRING_AS_LREAL::scm_anEIWith[] = {0, 255};
...
const TDataIOID FORTE_F_STRING_AS_LREAL::scm_anEOWith[] = {0, 255};
...
void FORTE_F_STRING_AS_LREAL::executeEvent(int pa_nEIID){
  switch(pa_nEIID) {
...
void FORTE_F_STRING_AS_LREAL::readInputData(size_t pa_nEIID) {
  switch(pa_nEIID) {
    case scm_nEventREQID: {
...
void FORTE_F_STRING_AS_LREAL::writeOutputData(size_t pa_nEIID) {
  switch(pa_nEIID) {
