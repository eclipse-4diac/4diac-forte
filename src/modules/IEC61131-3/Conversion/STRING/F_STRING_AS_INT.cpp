...
FORTE_F_STRING_AS_INT::FORTE_F_STRING_AS_INT(CStringDictionary::TStringId paInstanceNameId, CResource *paSrcRes) :
...
void FORTE_F_STRING_AS_INT::executeEvent(TEventID paEIID){
  switch(paEIID) {
    case scmEventREQID:
      alg_REQ();
      break;
