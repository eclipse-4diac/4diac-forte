...
FORTE_F_STRING_AS_BOOL::FORTE_F_STRING_AS_BOOL(CStringDictionary::TStringId paInstanceNameId, CResource *paSrcRes) :
...
void FORTE_F_STRING_AS_BOOL::executeEvent(TEventID paEIID){
  switch(paEIID) {
    case scmEventREQID:
      alg_REQ();
      break;
