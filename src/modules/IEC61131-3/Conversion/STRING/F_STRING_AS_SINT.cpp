...
void FORTE_F_STRING_AS_SINT::executeEvent(int pa_nEIID){
  switch(pa_nEIID) {
...
void FORTE_F_STRING_AS_SINT::readInputData(size_t pa_nEIID) {
  switch(pa_nEIID) {
    case scm_nEventREQID: {
...
void FORTE_F_STRING_AS_SINT::writeOutputData(size_t pa_nEIID) {
  switch(pa_nEIID) {
