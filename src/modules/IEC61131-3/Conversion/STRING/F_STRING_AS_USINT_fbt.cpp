...
#include "F_STRING_AS_USINT_fbt_gen.cpp"
#endif
...
const CStringDictionary::TStringId FORTE_F_STRING_AS_USINT::scmDataInputNames[] = {g_nStringIdIN};

const CStringDictionary::TStringId FORTE_F_STRING_AS_USINT::scmDataInputTypeIds[] = {g_nStringIdSTRING};

const CStringDictionary::TStringId FORTE_F_STRING_AS_USINT::scmDataOutputNames[] = {g_nStringIdOUT};

const CStringDictionary::TStringId FORTE_F_STRING_AS_USINT::scmDataOutputTypeIds[] = {g_nStringIdUSINT};
...
const CStringDictionary::TStringId FORTE_F_STRING_AS_USINT::scmEventInputNames[] = {g_nStringIdREQ};
const CStringDictionary::TStringId FORTE_F_STRING_AS_USINT::scmEventInputTypeIds[] = {g_nStringIdEvent};
...
const CStringDictionary::TStringId FORTE_F_STRING_AS_USINT::scmEventOutputNames[] = {g_nStringIdCNF};
const CStringDictionary::TStringId FORTE_F_STRING_AS_USINT::scmEventOutputTypeIds[] = {g_nStringIdEvent};
...
FORTE_F_STRING_AS_USINT::FORTE_F_STRING_AS_USINT(CStringDictionary::TStringId paInstanceNameId, forte::core::CFBContainer &paContainer) :
