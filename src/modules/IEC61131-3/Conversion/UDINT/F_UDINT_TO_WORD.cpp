...
const TDataIOID FORTE_F_UDINT_TO_WORD::scm_anEIWith[] = {0, scmWithListDelimiter};
...
const TDataIOID FORTE_F_UDINT_TO_WORD::scm_anEOWith[] = {0, scmWithListDelimiter};
const TForteInt16 FORTE_F_UDINT_TO_WORD::scm_anEOWithIndexes[] = {0};
...
FORTE_F_UDINT_TO_WORD::FORTE_F_UDINT_TO_WORD(CStringDictionary::TStringId pa_nInstanceNameId, CResource *pa_poSrcRes) :
...
void FORTE_F_UDINT_TO_WORD::executeEvent(TEventID pa_nEIID){
  switch(pa_nEIID) {
...
void FORTE_F_UDINT_TO_WORD::readInputData(TEventID pa_nEIID) {
  switch(pa_nEIID) {
    case scm_nEventREQID: {
...
void FORTE_F_UDINT_TO_WORD::writeOutputData(TEventID pa_nEIID) {
  switch(pa_nEIID) {
