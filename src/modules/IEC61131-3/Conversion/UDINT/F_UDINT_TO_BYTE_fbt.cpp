...
DEFINE_FIRMWARE_FB(FORTE_F_UDINT_TO_BYTE, "F_UDINT_TO_BYTE"_STRID)
...
FORTE_F_UDINT_TO_BYTE::FORTE_F_UDINT_TO_BYTE(const forte::core::StringId paInstanceNameId, forte::core::CFBContainer &paContainer) :
