...
#include "F_UDINT_AS_WSTRING_fbt_gen.cpp"
#endif
...
const CStringDictionary::TStringId FORTE_F_UDINT_AS_WSTRING::scmEventInputTypeIds[] = {g_nStringIdEvent};
...
const CStringDictionary::TStringId FORTE_F_UDINT_AS_WSTRING::scmEventOutputTypeIds[] = {g_nStringIdEvent};
