...
#include "F_UDINT_TO_REAL_fbt_gen.cpp"
#endif
...
const CStringDictionary::TStringId FORTE_F_UDINT_TO_REAL::scmEventInputTypeIds[] = {g_nStringIdEvent};
...
const CStringDictionary::TStringId FORTE_F_UDINT_TO_REAL::scmEventOutputTypeIds[] = {g_nStringIdEvent};
