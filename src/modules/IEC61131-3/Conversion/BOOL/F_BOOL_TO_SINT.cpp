...
const TDataIOID FORTE_F_BOOL_TO_SINT::scm_anEIWith[] = {0, scmWithListDelimiter};
...
const TDataIOID FORTE_F_BOOL_TO_SINT::scm_anEOWith[] = {0, scmWithListDelimiter};
const TForteInt16 FORTE_F_BOOL_TO_SINT::scm_anEOWithIndexes[] = {0};
...
FORTE_F_BOOL_TO_SINT::FORTE_F_BOOL_TO_SINT(CStringDictionary::TStringId pa_nInstanceNameId, CResource *pa_poSrcRes) :
...
void FORTE_F_BOOL_TO_SINT::executeEvent(TEventID pa_nEIID){
  switch(pa_nEIID) {
...
void FORTE_F_BOOL_TO_SINT::readInputData(TEventID pa_nEIID) {
  switch(pa_nEIID) {
    case scm_nEventREQID: {
...
void FORTE_F_BOOL_TO_SINT::writeOutputData(TEventID pa_nEIID) {
  switch(pa_nEIID) {
