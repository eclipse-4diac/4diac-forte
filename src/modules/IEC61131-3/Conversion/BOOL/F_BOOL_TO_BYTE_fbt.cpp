...
#include "F_BOOL_TO_BYTE_fbt_gen.cpp"
#endif
...
const CStringDictionary::TStringId FORTE_F_BOOL_TO_BYTE::scmDataInputNames[] = {g_nStringIdIN};

const CStringDictionary::TStringId FORTE_F_BOOL_TO_BYTE::scmDataInputTypeIds[] = {g_nStringIdBOOL};

const CStringDictionary::TStringId FORTE_F_BOOL_TO_BYTE::scmDataOutputNames[] = {g_nStringIdOUT};

const CStringDictionary::TStringId FORTE_F_BOOL_TO_BYTE::scmDataOutputTypeIds[] = {g_nStringIdBYTE};
...
const CStringDictionary::TStringId FORTE_F_BOOL_TO_BYTE::scmEventInputNames[] = {g_nStringIdREQ};
const CStringDictionary::TStringId FORTE_F_BOOL_TO_BYTE::scmEventInputTypeIds[] = {g_nStringIdEvent};
...
const CStringDictionary::TStringId FORTE_F_BOOL_TO_BYTE::scmEventOutputNames[] = {g_nStringIdCNF};
const CStringDictionary::TStringId FORTE_F_BOOL_TO_BYTE::scmEventOutputTypeIds[] = {g_nStringIdEvent};


const SFBInterfaceSpec FORTE_F_BOOL_TO_BYTE::scmFBInterfaceSpec = {
...
FORTE_F_BOOL_TO_BYTE::FORTE_F_BOOL_TO_BYTE(CStringDictionary::TStringId paInstanceNameId, forte::core::CFBContainer &paContainer) :
