...
FORTE_F_BOOL_TO_BYTE::FORTE_F_BOOL_TO_BYTE(CStringDictionary::TStringId paInstanceNameId, CResource *paSrcRes) :
...
void FORTE_F_BOOL_TO_BYTE::executeEvent(TEventID paEIID){
  switch(paEIID) {
    case scmEventREQID:
      alg_REQ();
      break;
