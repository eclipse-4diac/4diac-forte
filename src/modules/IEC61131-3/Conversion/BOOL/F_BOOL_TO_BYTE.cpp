...
const TDataIOID FORTE_F_BOOL_TO_BYTE::scm_anEIWith[] = {0, scmWithListDelimiter};
...
const TDataIOID FORTE_F_BOOL_TO_BYTE::scm_anEOWith[] = {0, scmWithListDelimiter};
const TForteInt16 FORTE_F_BOOL_TO_BYTE::scm_anEOWithIndexes[] = {0};
...
FORTE_F_BOOL_TO_BYTE::FORTE_F_BOOL_TO_BYTE(CStringDictionary::TStringId pa_nInstanceNameId, CResource *pa_poSrcRes) :
...
void FORTE_F_BOOL_TO_BYTE::executeEvent(TEventID pa_nEIID){
  switch(pa_nEIID) {
...
void FORTE_F_BOOL_TO_BYTE::readInputData(TEventID pa_nEIID) {
  switch(pa_nEIID) {
    case scm_nEventREQID: {
...
void FORTE_F_BOOL_TO_BYTE::writeOutputData(TEventID pa_nEIID) {
  switch(pa_nEIID) {
