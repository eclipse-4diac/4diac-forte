...
FORTE_F_LREAL_TO_REAL::FORTE_F_LREAL_TO_REAL(CStringDictionary::TStringId paInstanceNameId, CResource *paSrcRes) :
...
void FORTE_F_LREAL_TO_REAL::executeEvent(TEventID paEIID){
  switch(paEIID) {
    case scmEventREQID:
      alg_REQ();
      break;
