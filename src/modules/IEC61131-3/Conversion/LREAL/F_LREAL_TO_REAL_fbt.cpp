...
#include "F_LREAL_TO_REAL_fbt_gen.cpp"
#endif
...
const CStringDictionary::TStringId FORTE_F_LREAL_TO_REAL::scmDataInputNames[] = {g_nStringIdIN};

const CStringDictionary::TStringId FORTE_F_LREAL_TO_REAL::scmDataInputTypeIds[] = {g_nStringIdLREAL};

const CStringDictionary::TStringId FORTE_F_LREAL_TO_REAL::scmDataOutputNames[] = {g_nStringIdOUT};

const CStringDictionary::TStringId FORTE_F_LREAL_TO_REAL::scmDataOutputTypeIds[] = {g_nStringIdREAL};
...
const CStringDictionary::TStringId FORTE_F_LREAL_TO_REAL::scmEventInputNames[] = {g_nStringIdREQ};
const CStringDictionary::TStringId FORTE_F_LREAL_TO_REAL::scmEventInputTypeIds[] = {g_nStringIdEvent};
...
const CStringDictionary::TStringId FORTE_F_LREAL_TO_REAL::scmEventOutputNames[] = {g_nStringIdCNF};
const CStringDictionary::TStringId FORTE_F_LREAL_TO_REAL::scmEventOutputTypeIds[] = {g_nStringIdEvent};
...
FORTE_F_LREAL_TO_REAL::FORTE_F_LREAL_TO_REAL(CStringDictionary::TStringId paInstanceNameId, forte::core::CFBContainer &paContainer) :
