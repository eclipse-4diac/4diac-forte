...
const SFBInterfaceSpec FORTE_F_LREAL_TO_SINT::scm_stFBInterfaceSpec = { 1, scm_anEventInputNames, scm_anEIWith, scm_anEIWithIndexes, 1, scm_anEventOutputNames,
...
void FORTE_F_LREAL_TO_SINT::executeEvent(int pa_nEIID) {
  if(scm_nEventREQID == pa_nEIID) {
    st_OUT() = func_LREAL_TO_SINT(st_IN());
