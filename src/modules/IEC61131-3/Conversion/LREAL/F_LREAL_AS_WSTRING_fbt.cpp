...
const CStringDictionary::TStringId FORTE_F_LREAL_AS_WSTRING::scmEventInputTypeIds[] = {STRID(Event)};
...
const CStringDictionary::TStringId FORTE_F_LREAL_AS_WSTRING::scmEventOutputTypeIds[] = {STRID(Event)};

const SFBInterfaceSpec FORTE_F_LREAL_AS_WSTRING::scmFBInterfaceSpec = {1,
                                                                       scmEventInputNames,
...
FORTE_F_LREAL_AS_WSTRING::FORTE_F_LREAL_AS_WSTRING(CStringDictionary::TStringId paInstanceNameId,
