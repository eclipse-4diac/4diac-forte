...
const CStringDictionary::TStringId FORTE_F_LREAL_AS_STRING::scmEventInputTypeIds[] = {STRID(Event)};
...
const CStringDictionary::TStringId FORTE_F_LREAL_AS_STRING::scmEventOutputTypeIds[] = {STRID(Event)};

const SFBInterfaceSpec FORTE_F_LREAL_AS_STRING::scmFBInterfaceSpec = {1,
                                                                      scmEventInputNames,
...
FORTE_F_LREAL_AS_STRING::FORTE_F_LREAL_AS_STRING(CStringDictionary::TStringId paInstanceNameId,
