...
const SFBInterfaceSpec FORTE_F_LREAL_TO_USINT::scm_stFBInterfaceSpec = { 1, scm_anEventInputNames, scm_anEIWith, scm_anEIWithIndexes, 1, scm_anEventOutputNames,
...
void FORTE_F_LREAL_TO_USINT::executeEvent(int pa_nEIID) {
  if(scm_nEventREQID == pa_nEIID) {
    st_OUT() = func_LREAL_TO_USINT(st_IN());
