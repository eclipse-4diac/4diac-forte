...
const CStringDictionary::TStringId FORTE_F_LREAL_TO_UDINT::scmEventInputTypeIds[] = {g_nStringIdEvent};
...
const CStringDictionary::TStringId FORTE_F_LREAL_TO_UDINT::scmEventOutputTypeIds[] = {g_nStringIdEvent};
