...
const TDataIOID FORTE_F_LWORD_AS_STRING::scm_anEIWith[] = {0, 255};
...
const TDataIOID FORTE_F_LWORD_AS_STRING::scm_anEOWith[] = {0, 255};
...
void FORTE_F_LWORD_AS_STRING::executeEvent(int pa_nEIID){
  switch(pa_nEIID) {
...
void FORTE_F_LWORD_AS_STRING::readInputData(size_t pa_nEIID) {
  switch(pa_nEIID) {
    case scm_nEventREQID: {
...
void FORTE_F_LWORD_AS_STRING::writeOutputData(size_t pa_nEIID) {
  switch(pa_nEIID) {
