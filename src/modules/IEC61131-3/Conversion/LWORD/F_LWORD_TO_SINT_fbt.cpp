...
const SFBInterfaceSpec FORTE_F_LWORD_TO_SINT::scmFBInterfaceSpec = {1,
                                                                    scmEventInputNames,
...
FORTE_F_LWORD_TO_SINT::FORTE_F_LWORD_TO_SINT(CStringDictionary::TStringId paInstanceNameId,
