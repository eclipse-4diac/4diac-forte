...
#include "F_LWORD_TO_SINT_fbt_gen.cpp"
#endif
...
const CStringDictionary::TStringId FORTE_F_LWORD_TO_SINT::scmDataInputNames[] = {g_nStringIdIN};

const CStringDictionary::TStringId FORTE_F_LWORD_TO_SINT::scmDataInputTypeIds[] = {g_nStringIdLWORD};

const CStringDictionary::TStringId FORTE_F_LWORD_TO_SINT::scmDataOutputNames[] = {g_nStringIdOUT};

const CStringDictionary::TStringId FORTE_F_LWORD_TO_SINT::scmDataOutputTypeIds[] = {g_nStringIdSINT};
...
const CStringDictionary::TStringId FORTE_F_LWORD_TO_SINT::scmEventInputNames[] = {g_nStringIdREQ};
const CStringDictionary::TStringId FORTE_F_LWORD_TO_SINT::scmEventInputTypeIds[] = {g_nStringIdEvent};
...
const CStringDictionary::TStringId FORTE_F_LWORD_TO_SINT::scmEventOutputNames[] = {g_nStringIdCNF};
const CStringDictionary::TStringId FORTE_F_LWORD_TO_SINT::scmEventOutputTypeIds[] = {g_nStringIdEvent};
