...
#include "F_LWORD_AS_STRING_fbt_gen.cpp"
#endif
...
const CStringDictionary::TStringId FORTE_F_LWORD_AS_STRING::scmDataInputNames[] = {g_nStringIdIN};

const CStringDictionary::TStringId FORTE_F_LWORD_AS_STRING::scmDataInputTypeIds[] = {g_nStringIdLWORD};

const CStringDictionary::TStringId FORTE_F_LWORD_AS_STRING::scmDataOutputNames[] = {g_nStringIdOUT};

const CStringDictionary::TStringId FORTE_F_LWORD_AS_STRING::scmDataOutputTypeIds[] = {g_nStringIdSTRING};
...
const CStringDictionary::TStringId FORTE_F_LWORD_AS_STRING::scmEventInputNames[] = {g_nStringIdREQ};
const CStringDictionary::TStringId FORTE_F_LWORD_AS_STRING::scmEventInputTypeIds[] = {g_nStringIdEvent};
...
const CStringDictionary::TStringId FORTE_F_LWORD_AS_STRING::scmEventOutputNames[] = {g_nStringIdCNF};
const CStringDictionary::TStringId FORTE_F_LWORD_AS_STRING::scmEventOutputTypeIds[] = {g_nStringIdEvent};


const SFBInterfaceSpec FORTE_F_LWORD_AS_STRING::scmFBInterfaceSpec = {
...
FORTE_F_LWORD_AS_STRING::FORTE_F_LWORD_AS_STRING(CStringDictionary::TStringId paInstanceNameId, forte::core::CFBContainer &paContainer) :
