...
const SFBInterfaceSpec FORTE_F_LWORD_TO_STRING::scm_stFBInterfaceSpec = { 1, scm_anEventInputNames, scm_anEIWith, scm_anEIWithIndexes, 1,
...
void FORTE_F_LWORD_TO_STRING::executeEvent(int pa_nEIID) {
  if(scm_nEventREQID == pa_nEIID) {
    st_OUT() = func_LWORD_TO_STRING(st_IN());
