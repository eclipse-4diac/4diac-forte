...
const SFBInterfaceSpec FORTE_F_DWORD_TO_DINT::scmFBInterfaceSpec = {1,
                                                                    scmEventInputNames,
...
FORTE_F_DWORD_TO_DINT::FORTE_F_DWORD_TO_DINT(CStringDictionary::TStringId paInstanceNameId,
