...
#include "F_DWORD_TO_DINT_fbt_gen.cpp"
#endif
...
const CStringDictionary::TStringId FORTE_F_DWORD_TO_DINT::scmDataInputNames[] = {g_nStringIdIN};

const CStringDictionary::TStringId FORTE_F_DWORD_TO_DINT::scmDataInputTypeIds[] = {g_nStringIdDWORD};

const CStringDictionary::TStringId FORTE_F_DWORD_TO_DINT::scmDataOutputNames[] = {g_nStringIdOUT};

const CStringDictionary::TStringId FORTE_F_DWORD_TO_DINT::scmDataOutputTypeIds[] = {g_nStringIdDINT};
...
const CStringDictionary::TStringId FORTE_F_DWORD_TO_DINT::scmEventInputNames[] = {g_nStringIdREQ};
const CStringDictionary::TStringId FORTE_F_DWORD_TO_DINT::scmEventInputTypeIds[] = {g_nStringIdEvent};
...
const CStringDictionary::TStringId FORTE_F_DWORD_TO_DINT::scmEventOutputNames[] = {g_nStringIdCNF};
const CStringDictionary::TStringId FORTE_F_DWORD_TO_DINT::scmEventOutputTypeIds[] = {g_nStringIdEvent};
