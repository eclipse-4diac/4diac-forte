...
const SFBInterfaceSpec FORTE_F_DWORD_TO_USINT::scmFBInterfaceSpec = {1,
                                                                     scmEventInputNames,
...
FORTE_F_DWORD_TO_USINT::FORTE_F_DWORD_TO_USINT(CStringDictionary::TStringId paInstanceNameId,
