...
#include "F_DWORD_TO_USINT_fbt_gen.cpp"
#endif
...
const CStringDictionary::TStringId FORTE_F_DWORD_TO_USINT::scmEventInputTypeIds[] = {g_nStringIdEvent};
...
const CStringDictionary::TStringId FORTE_F_DWORD_TO_USINT::scmEventOutputTypeIds[] = {g_nStringIdEvent};
