...
const CStringDictionary::TStringId FORTE_F_DWORD_TO_ULINT::scmEventInputTypeIds[] = {STRID(Event)};
...
const CStringDictionary::TStringId FORTE_F_DWORD_TO_ULINT::scmEventOutputTypeIds[] = {STRID(Event)};

const SFBInterfaceSpec FORTE_F_DWORD_TO_ULINT::scmFBInterfaceSpec = {1,
                                                                     scmEventInputNames,
...
FORTE_F_DWORD_TO_ULINT::FORTE_F_DWORD_TO_ULINT(CStringDictionary::TStringId paInstanceNameId,
