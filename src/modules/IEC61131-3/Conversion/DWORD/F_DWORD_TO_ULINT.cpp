...
const TDataIOID FORTE_F_DWORD_TO_ULINT::scm_anEIWith[] = {0, scmWithListDelimiter};
...
const TDataIOID FORTE_F_DWORD_TO_ULINT::scm_anEOWith[] = {0, scmWithListDelimiter};
const TForteInt16 FORTE_F_DWORD_TO_ULINT::scm_anEOWithIndexes[] = {0};
...
FORTE_F_DWORD_TO_ULINT::FORTE_F_DWORD_TO_ULINT(CStringDictionary::TStringId pa_nInstanceNameId, CResource *pa_poSrcRes) :
...
void FORTE_F_DWORD_TO_ULINT::executeEvent(TEventID pa_nEIID){
  switch(pa_nEIID) {
...
void FORTE_F_DWORD_TO_ULINT::readInputData(TEventID pa_nEIID) {
  switch(pa_nEIID) {
    case scm_nEventREQID: {
...
void FORTE_F_DWORD_TO_ULINT::writeOutputData(TEventID pa_nEIID) {
  switch(pa_nEIID) {
