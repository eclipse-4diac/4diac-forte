...
FORTE_F_DWORD_TO_ULINT::FORTE_F_DWORD_TO_ULINT(CStringDictionary::TStringId paInstanceNameId, CResource *paSrcRes) :
...
void FORTE_F_DWORD_TO_ULINT::executeEvent(TEventID paEIID){
  switch(paEIID) {
    case scmEventREQID:
      alg_REQ();
      break;
