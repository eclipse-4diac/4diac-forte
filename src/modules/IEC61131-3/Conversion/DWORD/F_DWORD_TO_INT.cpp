...
const TDataIOID FORTE_F_DWORD_TO_INT::scm_anEIWith[] = {0, scmWithListDelimiter};
...
const TDataIOID FORTE_F_DWORD_TO_INT::scm_anEOWith[] = {0, scmWithListDelimiter};
...
void FORTE_F_DWORD_TO_INT::executeEvent(TEventID pa_nEIID){
  switch(pa_nEIID) {
...
void FORTE_F_DWORD_TO_INT::readInputData(TEventID pa_nEIID) {
  switch(pa_nEIID) {
    case scm_nEventREQID: {
...
void FORTE_F_DWORD_TO_INT::writeOutputData(TEventID pa_nEIID) {
  switch(pa_nEIID) {
