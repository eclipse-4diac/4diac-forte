...
const SFBInterfaceSpec FORTE_F_DT_TO_TOD::scm_stFBInterfaceSpec = { 1, scm_anEventInputNames, scm_anEIWith, scm_anEIWithIndexes, 1, scm_anEventOutputNames,
