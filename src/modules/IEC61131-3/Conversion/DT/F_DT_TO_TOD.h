...
class FORTE_F_DT_TO_TOD: public CSimpleFB {
...
public:
  FORTE_F_DT_TO_TOD(CStringDictionary::TStringId pa_nInstanceNameId, CResource *pa_poSrcRes);
  ...
  void evt_REQ(const CIEC_DATE_AND_TIME &pa_IN, CIEC_TIME_OF_DAY &pa_OUT) {
    var_IN = pa_IN;
    receiveInputEvent(scm_nEventREQID, nullptr);
    pa_OUT = var_OUT;
  }
  
  void operator()(const CIEC_DATE_AND_TIME &pa_IN, CIEC_TIME_OF_DAY &pa_OUT) {
