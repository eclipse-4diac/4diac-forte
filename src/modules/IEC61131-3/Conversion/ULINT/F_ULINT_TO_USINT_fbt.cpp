...
DEFINE_FIRMWARE_FB(FORTE_F_ULINT_TO_USINT, "F_ULINT_TO_USINT"_STRID)
...
FORTE_F_ULINT_TO_USINT::FORTE_F_ULINT_TO_USINT(const forte::core::StringId paInstanceNameId, forte::core::CFBContainer &paContainer) :
