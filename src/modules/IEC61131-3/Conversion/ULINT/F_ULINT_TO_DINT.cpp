...
const SFBInterfaceSpec FORTE_F_ULINT_TO_DINT::scm_stFBInterfaceSpec = { 1, scm_anEventInputNames, scm_anEIWith, scm_anEIWithIndexes, 1, scm_anEventOutputNames,
...
void FORTE_F_ULINT_TO_DINT::executeEvent(int pa_nEIID) {
  if(scm_nEventREQID == pa_nEIID) {
    st_OUT() = func_ULINT_TO_DINT(st_IN());
