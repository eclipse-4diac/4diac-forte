...
FORTE_F_ULINT_TO_DINT::FORTE_F_ULINT_TO_DINT(CStringDictionary::TStringId paInstanceNameId, CResource *paSrcRes) :
...
void FORTE_F_ULINT_TO_DINT::executeEvent(TEventID paEIID){
  switch(paEIID) {
    case scmEventREQID:
      alg_REQ();
      break;
