...
const SFBInterfaceSpec FORTE_F_ULINT_TO_UDINT::scmFBInterfaceSpec = {1,
                                                                     scmEventInputNames,
...
FORTE_F_ULINT_TO_UDINT::FORTE_F_ULINT_TO_UDINT(CStringDictionary::TStringId paInstanceNameId,
