...
const CStringDictionary::TStringId FORTE_F_ULINT_TO_DWORD::scmEventInputTypeIds[] = {STRID(Event)};
...
const CStringDictionary::TStringId FORTE_F_ULINT_TO_DWORD::scmEventOutputTypeIds[] = {STRID(Event)};

const SFBInterfaceSpec FORTE_F_ULINT_TO_DWORD::scmFBInterfaceSpec = {1,
                                                                     scmEventInputNames,
...
FORTE_F_ULINT_TO_DWORD::FORTE_F_ULINT_TO_DWORD(CStringDictionary::TStringId paInstanceNameId,
