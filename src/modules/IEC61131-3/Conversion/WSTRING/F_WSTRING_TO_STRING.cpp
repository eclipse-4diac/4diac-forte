...
FORTE_F_WSTRING_TO_STRING::FORTE_F_WSTRING_TO_STRING(CStringDictionary::TStringId paInstanceNameId, CResource *paSrcRes) :
...
void FORTE_F_WSTRING_TO_STRING::executeEvent(TEventID paEIID){
  switch(paEIID) {
    case scmEventREQID:
      alg_REQ();
      break;
