...
#include "F_WSTRING_AS_UDINT_fbt_gen.cpp"
#endif
...
const CStringDictionary::TStringId FORTE_F_WSTRING_AS_UDINT::scmEventInputTypeIds[] = {g_nStringIdEvent};
...
const CStringDictionary::TStringId FORTE_F_WSTRING_AS_UDINT::scmEventOutputTypeIds[] = {g_nStringIdEvent};
