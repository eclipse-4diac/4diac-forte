...
#include "F_WSTRING_AS_DINT_fbt_gen.cpp"
#endif
...
const CStringDictionary::TStringId FORTE_F_WSTRING_AS_DINT::scmDataInputNames[] = {g_nStringIdIN};

const CStringDictionary::TStringId FORTE_F_WSTRING_AS_DINT::scmDataInputTypeIds[] = {g_nStringIdWSTRING};

const CStringDictionary::TStringId FORTE_F_WSTRING_AS_DINT::scmDataOutputNames[] = {g_nStringIdOUT};

const CStringDictionary::TStringId FORTE_F_WSTRING_AS_DINT::scmDataOutputTypeIds[] = {g_nStringIdDINT};
...
const CStringDictionary::TStringId FORTE_F_WSTRING_AS_DINT::scmEventInputNames[] = {g_nStringIdREQ};
const CStringDictionary::TStringId FORTE_F_WSTRING_AS_DINT::scmEventInputTypeIds[] = {g_nStringIdEvent};
...
const CStringDictionary::TStringId FORTE_F_WSTRING_AS_DINT::scmEventOutputNames[] = {g_nStringIdCNF};
const CStringDictionary::TStringId FORTE_F_WSTRING_AS_DINT::scmEventOutputTypeIds[] = {g_nStringIdEvent};
...
FORTE_F_WSTRING_AS_DINT::FORTE_F_WSTRING_AS_DINT(CStringDictionary::TStringId paInstanceNameId, forte::core::CFBContainer &paContainer) :
