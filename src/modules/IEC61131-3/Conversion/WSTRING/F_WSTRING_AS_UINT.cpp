...
const TDataIOID FORTE_F_WSTRING_AS_UINT::scm_anEIWith[] = {0, scmWithListDelimiter};
...
const TDataIOID FORTE_F_WSTRING_AS_UINT::scm_anEOWith[] = {0, scmWithListDelimiter};
