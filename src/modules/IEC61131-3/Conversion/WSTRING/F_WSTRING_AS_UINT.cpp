...
void FORTE_F_WSTRING_AS_UINT::executeEvent(int pa_nEIID){
  switch(pa_nEIID) {
...
void FORTE_F_WSTRING_AS_UINT::readInputData(size_t pa_nEIID) {
  switch(pa_nEIID) {
    case scm_nEventREQID: {
...
void FORTE_F_WSTRING_AS_UINT::writeOutputData(size_t pa_nEIID) {
  switch(pa_nEIID) {
