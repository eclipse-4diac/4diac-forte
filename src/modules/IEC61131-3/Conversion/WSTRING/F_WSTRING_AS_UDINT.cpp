...
void FORTE_F_WSTRING_AS_UDINT::executeEvent(int pa_nEIID){
  switch(pa_nEIID) {
...
void FORTE_F_WSTRING_AS_UDINT::readInputData(size_t pa_nEIID) {
  switch(pa_nEIID) {
    case scm_nEventREQID: {
...
void FORTE_F_WSTRING_AS_UDINT::writeOutputData(size_t pa_nEIID) {
  switch(pa_nEIID) {
