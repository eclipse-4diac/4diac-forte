...
const TDataIOID FORTE_F_WSTRING_AS_UDINT::scm_anEIWith[] = {0, scmWithListDelimiter};
...
const TDataIOID FORTE_F_WSTRING_AS_UDINT::scm_anEOWith[] = {0, scmWithListDelimiter};
