...
const TDataIOID FORTE_F_WSTRING_AS_DINT::scm_anEIWith[] = {0, 255};
...
const TDataIOID FORTE_F_WSTRING_AS_DINT::scm_anEOWith[] = {0, 255};
...
void FORTE_F_WSTRING_AS_DINT::executeEvent(int pa_nEIID){
  switch(pa_nEIID) {
...
void FORTE_F_WSTRING_AS_DINT::readInputData(size_t pa_nEIID) {
  switch(pa_nEIID) {
    case scm_nEventREQID: {
...
void FORTE_F_WSTRING_AS_DINT::writeOutputData(size_t pa_nEIID) {
  switch(pa_nEIID) {
