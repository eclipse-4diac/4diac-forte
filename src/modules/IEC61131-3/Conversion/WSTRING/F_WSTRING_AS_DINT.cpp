...
FORTE_F_WSTRING_AS_DINT::FORTE_F_WSTRING_AS_DINT(CStringDictionary::TStringId paInstanceNameId, CResource *paSrcRes) :
...
void FORTE_F_WSTRING_AS_DINT::executeEvent(TEventID paEIID){
  switch(paEIID) {
    case scmEventREQID:
      alg_REQ();
      break;
