...
#include "F_WSTRING_AS_TIME_fbt_gen.cpp"
#endif
...
const CStringDictionary::TStringId FORTE_F_WSTRING_AS_TIME::scmDataInputNames[] = {g_nStringIdIN};

const CStringDictionary::TStringId FORTE_F_WSTRING_AS_TIME::scmDataInputTypeIds[] = {g_nStringIdWSTRING};

const CStringDictionary::TStringId FORTE_F_WSTRING_AS_TIME::scmDataOutputNames[] = {g_nStringIdOUT};

const CStringDictionary::TStringId FORTE_F_WSTRING_AS_TIME::scmDataOutputTypeIds[] = {g_nStringIdTIME};
...
const CStringDictionary::TStringId FORTE_F_WSTRING_AS_TIME::scmEventInputNames[] = {g_nStringIdREQ};
const CStringDictionary::TStringId FORTE_F_WSTRING_AS_TIME::scmEventInputTypeIds[] = {g_nStringIdEvent};
...
const CStringDictionary::TStringId FORTE_F_WSTRING_AS_TIME::scmEventOutputNames[] = {g_nStringIdCNF};
const CStringDictionary::TStringId FORTE_F_WSTRING_AS_TIME::scmEventOutputTypeIds[] = {g_nStringIdEvent};
