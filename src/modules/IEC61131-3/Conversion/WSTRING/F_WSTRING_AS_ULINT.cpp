...
FORTE_F_WSTRING_AS_ULINT::FORTE_F_WSTRING_AS_ULINT(CStringDictionary::TStringId paInstanceNameId, CResource *paSrcRes) :
...
void FORTE_F_WSTRING_AS_ULINT::executeEvent(TEventID paEIID){
  switch(paEIID) {
    case scmEventREQID:
      alg_REQ();
      break;
