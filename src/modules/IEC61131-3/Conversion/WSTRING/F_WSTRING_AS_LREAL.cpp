...
FORTE_F_WSTRING_AS_LREAL::FORTE_F_WSTRING_AS_LREAL(CStringDictionary::TStringId paInstanceNameId, CResource *paSrcRes) :
...
void FORTE_F_WSTRING_AS_LREAL::executeEvent(TEventID paEIID){
  switch(paEIID) {
    case scmEventREQID:
      alg_REQ();
      break;
