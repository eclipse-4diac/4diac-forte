...
FORTE_F_WSTRING_AS_LINT::FORTE_F_WSTRING_AS_LINT(CStringDictionary::TStringId paInstanceNameId, CResource *paSrcRes) :
...
void FORTE_F_WSTRING_AS_LINT::executeEvent(TEventID paEIID){
  switch(paEIID) {
    case scmEventREQID:
      alg_REQ();
      break;
