...
const TDataIOID FORTE_F_WSTRING_AS_LINT::scm_anEIWith[] = {0, scmWithListDelimiter};
...
const TDataIOID FORTE_F_WSTRING_AS_LINT::scm_anEOWith[] = {0, scmWithListDelimiter};
...
void FORTE_F_WSTRING_AS_LINT::executeEvent(TEventID pa_nEIID){
  switch(pa_nEIID) {
...
void FORTE_F_WSTRING_AS_LINT::readInputData(TEventID pa_nEIID) {
  switch(pa_nEIID) {
    case scm_nEventREQID: {
...
void FORTE_F_WSTRING_AS_LINT::writeOutputData(TEventID pa_nEIID) {
  switch(pa_nEIID) {
