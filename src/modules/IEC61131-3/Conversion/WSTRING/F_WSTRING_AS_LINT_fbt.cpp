...
const SFBInterfaceSpec FORTE_F_WSTRING_AS_LINT::scmFBInterfaceSpec = {1,
                                                                      scmEventInputNames,
...
FORTE_F_WSTRING_AS_LINT::FORTE_F_WSTRING_AS_LINT(CStringDictionary::TStringId paInstanceNameId,
