...
DEFINE_FIRMWARE_FB(FORTE_F_WSTRING_AS_LINT, "F_WSTRING_AS_LINT"_STRID)
...
FORTE_F_WSTRING_AS_LINT::FORTE_F_WSTRING_AS_LINT(const forte::core::StringId paInstanceNameId, forte::core::CFBContainer &paContainer) :
