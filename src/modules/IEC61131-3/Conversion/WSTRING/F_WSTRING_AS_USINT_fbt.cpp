...
const SFBInterfaceSpec FORTE_F_WSTRING_AS_USINT::scmFBInterfaceSpec = {1,
                                                                       scmEventInputNames,
...
FORTE_F_WSTRING_AS_USINT::FORTE_F_WSTRING_AS_USINT(CStringDictionary::TStringId paInstanceNameId,
...
void FORTE_F_WSTRING_AS_USINT::executeEvent(TEventID paEIID, CEventChainExecutionThread *const paECET) {
  switch (paEIID) {
