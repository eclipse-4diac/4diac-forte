...
const CStringDictionary::TStringId FORTE_F_WSTRING_AS_BYTE::scmEventInputTypeIds[] = {STRID(Event)};
...
const CStringDictionary::TStringId FORTE_F_WSTRING_AS_BYTE::scmEventOutputTypeIds[] = {STRID(Event)};

const SFBInterfaceSpec FORTE_F_WSTRING_AS_BYTE::scmFBInterfaceSpec = {1,
                                                                      scmEventInputNames,
...
FORTE_F_WSTRING_AS_BYTE::FORTE_F_WSTRING_AS_BYTE(CStringDictionary::TStringId paInstanceNameId,
