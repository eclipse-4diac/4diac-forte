...
const SFBInterfaceSpec FORTE_F_WSTRING_AS_DWORD::scmFBInterfaceSpec = {1,
                                                                       scmEventInputNames,
...
FORTE_F_WSTRING_AS_DWORD::FORTE_F_WSTRING_AS_DWORD(CStringDictionary::TStringId paInstanceNameId,
