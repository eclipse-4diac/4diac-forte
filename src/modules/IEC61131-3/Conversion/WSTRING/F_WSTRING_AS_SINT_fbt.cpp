...
const CStringDictionary::TStringId FORTE_F_WSTRING_AS_SINT::scmEventInputTypeIds[] = {STRID(Event)};
...
const CStringDictionary::TStringId FORTE_F_WSTRING_AS_SINT::scmEventOutputTypeIds[] = {STRID(Event)};

const SFBInterfaceSpec FORTE_F_WSTRING_AS_SINT::scmFBInterfaceSpec = {1,
                                                                      scmEventInputNames,
...
FORTE_F_WSTRING_AS_SINT::FORTE_F_WSTRING_AS_SINT(CStringDictionary::TStringId paInstanceNameId,
