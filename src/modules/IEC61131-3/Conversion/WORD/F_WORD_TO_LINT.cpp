...
FORTE_F_WORD_TO_LINT::FORTE_F_WORD_TO_LINT(CStringDictionary::TStringId paInstanceNameId, CResource *paSrcRes) :
...
void FORTE_F_WORD_TO_LINT::executeEvent(TEventID paEIID){
  switch(paEIID) {
    case scmEventREQID:
      alg_REQ();
      break;
