...
#include "F_WORD_AS_STRING_fbt_gen.cpp"
#endif
...
const CStringDictionary::TStringId FORTE_F_WORD_AS_STRING::scmEventInputTypeIds[] = {g_nStringIdEvent};
...
const CStringDictionary::TStringId FORTE_F_WORD_AS_STRING::scmEventOutputTypeIds[] = {g_nStringIdEvent};
