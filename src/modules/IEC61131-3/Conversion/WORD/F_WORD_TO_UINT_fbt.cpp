...
DEFINE_FIRMWARE_FB(FORTE_F_WORD_TO_UINT, "F_WORD_TO_UINT"_STRID)
...
FORTE_F_WORD_TO_UINT::FORTE_F_WORD_TO_UINT(const forte::core::StringId paInstanceNameId, forte::core::CFBContainer &paContainer) :
