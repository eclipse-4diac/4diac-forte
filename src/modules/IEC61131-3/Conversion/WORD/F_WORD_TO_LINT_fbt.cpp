...
#include "F_WORD_TO_LINT_fbt_gen.cpp"
#endif
...
const CStringDictionary::TStringId FORTE_F_WORD_TO_LINT::scmDataInputNames[] = {g_nStringIdIN};

const CStringDictionary::TStringId FORTE_F_WORD_TO_LINT::scmDataInputTypeIds[] = {g_nStringIdWORD};

const CStringDictionary::TStringId FORTE_F_WORD_TO_LINT::scmDataOutputNames[] = {g_nStringIdOUT};

const CStringDictionary::TStringId FORTE_F_WORD_TO_LINT::scmDataOutputTypeIds[] = {g_nStringIdLINT};
...
const CStringDictionary::TStringId FORTE_F_WORD_TO_LINT::scmEventInputNames[] = {g_nStringIdREQ};
const CStringDictionary::TStringId FORTE_F_WORD_TO_LINT::scmEventInputTypeIds[] = {g_nStringIdEvent};
...
const CStringDictionary::TStringId FORTE_F_WORD_TO_LINT::scmEventOutputNames[] = {g_nStringIdCNF};
const CStringDictionary::TStringId FORTE_F_WORD_TO_LINT::scmEventOutputTypeIds[] = {g_nStringIdEvent};
