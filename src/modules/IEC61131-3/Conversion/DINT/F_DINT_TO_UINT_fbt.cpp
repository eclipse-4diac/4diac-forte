...
const CStringDictionary::TStringId FORTE_F_DINT_TO_UINT::scmEventInputTypeIds[] = {g_nStringIdEvent};
...
const CStringDictionary::TStringId FORTE_F_DINT_TO_UINT::scmEventOutputTypeIds[] = {g_nStringIdEvent};
