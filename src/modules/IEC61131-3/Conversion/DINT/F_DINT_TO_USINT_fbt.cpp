...
const CStringDictionary::TStringId FORTE_F_DINT_TO_USINT::scmEventInputTypeIds[] = {g_nStringIdEvent};
...
const CStringDictionary::TStringId FORTE_F_DINT_TO_USINT::scmEventOutputTypeIds[] = {g_nStringIdEvent};
