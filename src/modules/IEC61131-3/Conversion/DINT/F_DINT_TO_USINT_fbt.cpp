...
const CStringDictionary::TStringId FORTE_F_DINT_TO_USINT::scmEventInputTypeIds[] = {STRID(Event)};
...
const CStringDictionary::TStringId FORTE_F_DINT_TO_USINT::scmEventOutputTypeIds[] = {STRID(Event)};

const SFBInterfaceSpec FORTE_F_DINT_TO_USINT::scmFBInterfaceSpec = {1,
                                                                    scmEventInputNames,
...
FORTE_F_DINT_TO_USINT::FORTE_F_DINT_TO_USINT(CStringDictionary::TStringId paInstanceNameId,
