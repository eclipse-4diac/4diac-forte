...
FORTE_F_DINT_TO_UINT::FORTE_F_DINT_TO_UINT(CStringDictionary::TStringId paInstanceNameId, CResource *paSrcRes) :
...
void FORTE_F_DINT_TO_UINT::executeEvent(TEventID paEIID){
  switch(paEIID) {
    case scmEventREQID:
      alg_REQ();
      break;
