...
DEFINE_FIRMWARE_FB(FORTE_F_DINT_AS_WSTRING, "F_DINT_AS_WSTRING"_STRID)
...
FORTE_F_DINT_AS_WSTRING::FORTE_F_DINT_AS_WSTRING(const forte::core::StringId paInstanceNameId,
