...
const SFBInterfaceSpec FORTE_F_LINT_TO_LWORD::scm_stFBInterfaceSpec = { 1, scm_anEventInputNames, scm_anEIWith, scm_anEIWithIndexes, 1, scm_anEventOutputNames,
...
void FORTE_F_LINT_TO_LWORD::executeEvent(int pa_nEIID) {
  if(scm_nEventREQID == pa_nEIID) {
    st_OUT() = func_LINT_TO_LWORD(st_IN());
