...
const CStringDictionary::TStringId FORTE_F_LINT_TO_INT::scmEventInputTypeIds[] = {STRID(Event)};
...
const CStringDictionary::TStringId FORTE_F_LINT_TO_INT::scmEventOutputTypeIds[] = {STRID(Event)};

const SFBInterfaceSpec FORTE_F_LINT_TO_INT::scmFBInterfaceSpec = {1,
                                                                  scmEventInputNames,
...
FORTE_F_LINT_TO_INT::FORTE_F_LINT_TO_INT(CStringDictionary::TStringId paInstanceNameId,
