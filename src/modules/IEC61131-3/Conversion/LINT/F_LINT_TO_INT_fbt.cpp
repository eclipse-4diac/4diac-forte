...
DEFINE_FIRMWARE_FB(FORTE_F_LINT_TO_INT, "F_LINT_TO_INT"_STRID)
...
FORTE_F_LINT_TO_INT::FORTE_F_LINT_TO_INT(const forte::core::StringId paInstanceNameId, forte::core::CFBContainer &paContainer) :
