...
#include "F_LINT_TO_DWORD_fbt_gen.cpp"
#endif
...
const CStringDictionary::TStringId FORTE_F_LINT_TO_DWORD::scmEventInputTypeIds[] = {g_nStringIdEvent};
...
const CStringDictionary::TStringId FORTE_F_LINT_TO_DWORD::scmEventOutputTypeIds[] = {g_nStringIdEvent};
