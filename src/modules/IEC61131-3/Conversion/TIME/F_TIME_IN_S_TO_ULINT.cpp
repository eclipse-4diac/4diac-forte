...
const SFBInterfaceSpec FORTE_F_TIME_IN_S_TO_ULINT::scm_stFBInterfaceSpec = { 1, scm_anEventInputNames, scm_anEIWith, scm_anEIWithIndexes, 1,
...
void FORTE_F_TIME_IN_S_TO_ULINT::alg_REQ() {
  st_OUT() = func_TIME_IN_S_TO_ULINT((st_IN()));
}

void FORTE_F_TIME_IN_S_TO_ULINT::executeEvent(int paEIID) {
