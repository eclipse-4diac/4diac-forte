...
const SFBInterfaceSpec FORTE_F_TIME_IN_MS_TO_LINT::scm_stFBInterfaceSpec = { 1, scm_anEventInputNames, scm_anEIWith, scm_anEIWithIndexes, 1,
...
void FORTE_F_TIME_IN_MS_TO_LINT::alg_REQ() {
  st_OUT() = func_TIME_IN_MS_TO_LINT((st_IN()));
}

void FORTE_F_TIME_IN_MS_TO_LINT::executeEvent(int paEIID) {
