...
const CStringDictionary::TStringId FORTE_F_TIME_IN_S_TO_UDINT::scmDataInputNames[] = {STRID(IN)};
const CStringDictionary::TStringId FORTE_F_TIME_IN_S_TO_UDINT::scmDataInputTypeIds[] = {STRID(TIME)};
const CStringDictionary::TStringId FORTE_F_TIME_IN_S_TO_UDINT::scmDataOutputNames[] = {STRID(OUT)};
const CStringDictionary::TStringId FORTE_F_TIME_IN_S_TO_UDINT::scmDataOutputTypeIds[] = {STRID(UDINT)};
...
const CStringDictionary::TStringId FORTE_F_TIME_IN_S_TO_UDINT::scmEventInputNames[] = {STRID(REQ)};
const CStringDictionary::TStringId FORTE_F_TIME_IN_S_TO_UDINT::scmEventInputTypeIds[] = {STRID(Event)};
...
const CStringDictionary::TStringId FORTE_F_TIME_IN_S_TO_UDINT::scmEventOutputNames[] = {STRID(CNF)};
const CStringDictionary::TStringId FORTE_F_TIME_IN_S_TO_UDINT::scmEventOutputTypeIds[] = {STRID(Event)};
const SFBInterfaceSpec FORTE_F_TIME_IN_S_TO_UDINT::scmFBInterfaceSpec = {1,
                                                                         scmEventInputNames,
