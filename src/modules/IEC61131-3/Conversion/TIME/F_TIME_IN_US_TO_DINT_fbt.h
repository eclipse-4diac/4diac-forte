...
class FORTE_F_TIME_IN_US_TO_DINT final : public CSimpleFB {
    DECLARE_FIRMWARE_FB(FORTE_F_TIME_IN_US_TO_DINT)
  ...
  public:
    FORTE_F_TIME_IN_US_TO_DINT(forte::core::InstanceNameId paInstanceNameId, forte::core::CFBContainer &paContainer);
