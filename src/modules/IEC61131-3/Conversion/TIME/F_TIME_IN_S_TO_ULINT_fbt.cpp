...
const SFBInterfaceSpec FORTE_F_TIME_IN_S_TO_ULINT::scmFBInterfaceSpec = {1,
                                                                         scmEventInputNames,
...
FORTE_F_TIME_IN_S_TO_ULINT::FORTE_F_TIME_IN_S_TO_ULINT(CStringDictionary::TStringId paInstanceNameId,
...
void FORTE_F_TIME_IN_S_TO_ULINT::executeEvent(TEventID paEIID, CEventChainExecutionThread *const paECET) {
  switch (paEIID) {
