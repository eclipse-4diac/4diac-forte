...
#include "F_TIME_IN_MS_TO_UDINT_fbt_gen.cpp"
#endif
...
const CStringDictionary::TStringId FORTE_F_TIME_IN_MS_TO_UDINT::scmEventInputTypeIds[] = {g_nStringIdEvent};
...
const CStringDictionary::TStringId FORTE_F_TIME_IN_MS_TO_UDINT::scmEventOutputTypeIds[] = {g_nStringIdEvent};
...
FORTE_F_TIME_IN_MS_TO_UDINT::FORTE_F_TIME_IN_MS_TO_UDINT(const CStringDictionary::TStringId paInstanceNameId, forte::core::CFBContainer &paContainer) :
