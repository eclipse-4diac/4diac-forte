...
#include "F_TIME_IN_US_TO_LINT_fbt_gen.cpp"
#endif
...
const CStringDictionary::TStringId FORTE_F_TIME_IN_US_TO_LINT::scmDataInputNames[] = {g_nStringIdIN};

const CStringDictionary::TStringId FORTE_F_TIME_IN_US_TO_LINT::scmDataInputTypeIds[] = {g_nStringIdTIME};

const CStringDictionary::TStringId FORTE_F_TIME_IN_US_TO_LINT::scmDataOutputNames[] = {g_nStringIdOUT};

const CStringDictionary::TStringId FORTE_F_TIME_IN_US_TO_LINT::scmDataOutputTypeIds[] = {g_nStringIdLINT};
...
const CStringDictionary::TStringId FORTE_F_TIME_IN_US_TO_LINT::scmEventInputNames[] = {g_nStringIdREQ};
const CStringDictionary::TStringId FORTE_F_TIME_IN_US_TO_LINT::scmEventInputTypeIds[] = {g_nStringIdEvent};
...
const CStringDictionary::TStringId FORTE_F_TIME_IN_US_TO_LINT::scmEventOutputNames[] = {g_nStringIdCNF};
const CStringDictionary::TStringId FORTE_F_TIME_IN_US_TO_LINT::scmEventOutputTypeIds[] = {g_nStringIdEvent};


const SFBInterfaceSpec FORTE_F_TIME_IN_US_TO_LINT::scmFBInterfaceSpec = {
...
FORTE_F_TIME_IN_US_TO_LINT::FORTE_F_TIME_IN_US_TO_LINT(CStringDictionary::TStringId paInstanceNameId, forte::core::CFBContainer &paContainer) :
