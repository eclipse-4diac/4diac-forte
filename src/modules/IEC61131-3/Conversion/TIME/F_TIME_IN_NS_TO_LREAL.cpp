...
const SFBInterfaceSpec FORTE_F_TIME_IN_NS_TO_LREAL::scm_stFBInterfaceSpec = { 1, scm_anEventInputNames, scm_anEIWith, scm_anEIWithIndexes, 1,
...
void FORTE_F_TIME_IN_NS_TO_LREAL::alg_REQ() {
  st_OUT() = func_TIME_IN_NS_TO_LREAL((st_IN()));
}

void FORTE_F_TIME_IN_NS_TO_LREAL::executeEvent(int paEIID) {
