...
void FORTE_F_TIME_IN_S_TO_LINT::executeEvent(int pa_nEIID){
  switch(pa_nEIID) {
...
void FORTE_F_TIME_IN_S_TO_LINT::readInputData(size_t pa_nEIID) {
  switch(pa_nEIID) {
    case scm_nEventREQID: {
...
void FORTE_F_TIME_IN_S_TO_LINT::writeOutputData(size_t pa_nEIID) {
  switch(pa_nEIID) {
