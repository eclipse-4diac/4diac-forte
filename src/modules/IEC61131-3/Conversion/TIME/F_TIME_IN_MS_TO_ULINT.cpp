...
void FORTE_F_TIME_IN_MS_TO_ULINT::executeEvent(int pa_nEIID){
  switch(pa_nEIID) {
...
void FORTE_F_TIME_IN_MS_TO_ULINT::readInputData(size_t pa_nEIID) {
  switch(pa_nEIID) {
    case scm_nEventREQID: {
...
void FORTE_F_TIME_IN_MS_TO_ULINT::writeOutputData(size_t pa_nEIID) {
  switch(pa_nEIID) {
