...
const CStringDictionary::TStringId FORTE_F_TIME_IN_S_TO_LINT::scmEventInputTypeIds[] = {STRID(Event)};
...
const CStringDictionary::TStringId FORTE_F_TIME_IN_S_TO_LINT::scmEventOutputTypeIds[] = {STRID(Event)};

const SFBInterfaceSpec FORTE_F_TIME_IN_S_TO_LINT::scmFBInterfaceSpec = {1,
                                                                        scmEventInputNames,
...
FORTE_F_TIME_IN_S_TO_LINT::FORTE_F_TIME_IN_S_TO_LINT(CStringDictionary::TStringId paInstanceNameId,
