...
const TDataIOID FORTE_F_ULINT_TO_BCD_LWORD::scm_anEIWith[] = {0, scmWithListDelimiter};
...
const TDataIOID FORTE_F_ULINT_TO_BCD_LWORD::scm_anEOWith[] = {0, scmWithListDelimiter};
const TForteInt16 FORTE_F_ULINT_TO_BCD_LWORD::scm_anEOWithIndexes[] = {0};
...
FORTE_F_ULINT_TO_BCD_LWORD::FORTE_F_ULINT_TO_BCD_LWORD(CStringDictionary::TStringId pa_nInstanceNameId, CResource *pa_poSrcRes) :
...
void FORTE_F_ULINT_TO_BCD_LWORD::executeEvent(TEventID pa_nEIID){
  switch(pa_nEIID) {
...
void FORTE_F_ULINT_TO_BCD_LWORD::readInputData(TEventID pa_nEIID) {
  switch(pa_nEIID) {
    case scm_nEventREQID: {
...
void FORTE_F_ULINT_TO_BCD_LWORD::writeOutputData(TEventID pa_nEIID) {
  switch(pa_nEIID) {
