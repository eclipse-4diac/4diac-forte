...
FORTE_F_ULINT_TO_BCD_LWORD::FORTE_F_ULINT_TO_BCD_LWORD(CStringDictionary::TStringId paInstanceNameId, CResource *paSrcRes) :
...
void FORTE_F_ULINT_TO_BCD_LWORD::executeEvent(TEventID paEIID){
  switch(paEIID) {
    case scmEventREQID:
      alg_REQ();
      break;
