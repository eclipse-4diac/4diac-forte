...
const SFBInterfaceSpec FORTE_F_UDINT_TO_BCD_DWORD::scm_stFBInterfaceSpec = { 1, scm_anEventInputNames, scm_anEIWith, scm_anEIWithIndexes, 1,
...
void FORTE_F_UDINT_TO_BCD_DWORD::executeEvent(int pa_nEIID) {
  if(scm_nEventREQID == pa_nEIID) {
    st_OUT() = func_UDINT_TO_BCD_DWORD(st_IN());
