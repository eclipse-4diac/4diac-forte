...
const TDataIOID FORTE_F_UDINT_TO_BCD_DWORD::scm_anEIWith[] = {0, scmWithListDelimiter};
...
const TDataIOID FORTE_F_UDINT_TO_BCD_DWORD::scm_anEOWith[] = {0, scmWithListDelimiter};
