...
const CStringDictionary::TStringId FORTE_F_USINT_TO_BCD_BYTE::scmEventInputTypeIds[] = {STRID(Event)};
...
const CStringDictionary::TStringId FORTE_F_USINT_TO_BCD_BYTE::scmEventOutputTypeIds[] = {STRID(Event)};

const SFBInterfaceSpec FORTE_F_USINT_TO_BCD_BYTE::scmFBInterfaceSpec = {1,
                                                                        scmEventInputNames,
...
FORTE_F_USINT_TO_BCD_BYTE::FORTE_F_USINT_TO_BCD_BYTE(CStringDictionary::TStringId paInstanceNameId,
