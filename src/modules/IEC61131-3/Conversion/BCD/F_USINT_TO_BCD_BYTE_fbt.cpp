...
#include "F_USINT_TO_BCD_BYTE_fbt_gen.cpp"
#endif
...
const CStringDictionary::TStringId FORTE_F_USINT_TO_BCD_BYTE::scmEventInputTypeIds[] = {g_nStringIdEvent};
...
const CStringDictionary::TStringId FORTE_F_USINT_TO_BCD_BYTE::scmEventOutputTypeIds[] = {g_nStringIdEvent};
...
FORTE_F_USINT_TO_BCD_BYTE::FORTE_F_USINT_TO_BCD_BYTE(CStringDictionary::TStringId paInstanceNameId, forte::core::CFBContainer &paContainer) :
...
void FORTE_F_USINT_TO_BCD_BYTE::executeEvent(TEventID paEIID, CEventChainExecutionThread *const paECET) {
  switch(paEIID) {
    case scmEventREQID:
      alg_REQ();
      break;
