...
#include "F_ULINT_TO_BCD_LWORD_fbt_gen.cpp"
#endif
...
const CStringDictionary::TStringId FORTE_F_ULINT_TO_BCD_LWORD::scmDataInputNames[] = {g_nStringIdIN};

const CStringDictionary::TStringId FORTE_F_ULINT_TO_BCD_LWORD::scmDataInputTypeIds[] = {g_nStringIdULINT};

const CStringDictionary::TStringId FORTE_F_ULINT_TO_BCD_LWORD::scmDataOutputNames[] = {g_nStringIdOUT};

const CStringDictionary::TStringId FORTE_F_ULINT_TO_BCD_LWORD::scmDataOutputTypeIds[] = {g_nStringIdLWORD};
...
const CStringDictionary::TStringId FORTE_F_ULINT_TO_BCD_LWORD::scmEventInputNames[] = {g_nStringIdREQ};
const CStringDictionary::TStringId FORTE_F_ULINT_TO_BCD_LWORD::scmEventInputTypeIds[] = {g_nStringIdEvent};
...
const CStringDictionary::TStringId FORTE_F_ULINT_TO_BCD_LWORD::scmEventOutputNames[] = {g_nStringIdCNF};
const CStringDictionary::TStringId FORTE_F_ULINT_TO_BCD_LWORD::scmEventOutputTypeIds[] = {g_nStringIdEvent};


const SFBInterfaceSpec FORTE_F_ULINT_TO_BCD_LWORD::scmFBInterfaceSpec = {
...
FORTE_F_ULINT_TO_BCD_LWORD::FORTE_F_ULINT_TO_BCD_LWORD(CStringDictionary::TStringId paInstanceNameId, forte::core::CFBContainer &paContainer) :
