...
const CStringDictionary::TStringId FORTE_F_BYTE_TO_UDINT::scmEventInputTypeIds[] = {STRID(Event)};
...
const CStringDictionary::TStringId FORTE_F_BYTE_TO_UDINT::scmEventOutputTypeIds[] = {STRID(Event)};

const SFBInterfaceSpec FORTE_F_BYTE_TO_UDINT::scmFBInterfaceSpec = {1,
                                                                    scmEventInputNames,
...
FORTE_F_BYTE_TO_UDINT::FORTE_F_BYTE_TO_UDINT(CStringDictionary::TStringId paInstanceNameId,
