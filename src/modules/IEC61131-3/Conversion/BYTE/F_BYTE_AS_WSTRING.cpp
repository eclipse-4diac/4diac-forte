...
#include "F_BYTE_AS_WSTRING.h"
#ifdef FORTE_ENABLE_GENERATED_SOURCE_CPP
#include "F_BYTE_AS_WSTRING_gen.cpp"
#endif
...
const TDataIOID FORTE_F_BYTE_AS_WSTRING::scm_anEIWith[] = {0, 255};
...
const TDataIOID FORTE_F_BYTE_AS_WSTRING::scm_anEOWith[] = {0, 255};
...
void FORTE_F_BYTE_AS_WSTRING::executeEvent(int pa_nEIID){
  switch(pa_nEIID) {
...
void FORTE_F_BYTE_AS_WSTRING::readInputData(size_t pa_nEIID) {
  switch(pa_nEIID) {
    case scm_nEventREQID: {
...
void FORTE_F_BYTE_AS_WSTRING::writeOutputData(size_t pa_nEIID) {
  switch(pa_nEIID) {
