...
class FORTE_F_ANY_AS_STRING final : public CSimpleFB {
  ...
  public:
    FORTE_F_ANY_AS_STRING(forte::core::InstanceNameId paInstanceNameId, forte::core::CFBContainer &paContainer);
    ...
    void evt_REQ(const CIEC_ANY &paIN, CIEC_STRING &paOUT) {
      var_IN = paIN;
      executeEvent(scmEventREQID, nullptr);
      paOUT = var_OUT;
    }

    void operator()(const CIEC_ANY &paIN, CIEC_STRING &paOUT) {
      evt_REQ(paIN, paOUT);
    }
};
