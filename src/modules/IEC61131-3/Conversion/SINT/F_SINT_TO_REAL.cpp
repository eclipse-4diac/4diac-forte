...
const SFBInterfaceSpec FORTE_F_SINT_TO_REAL::scm_stFBInterfaceSpec = { 1, scm_anEventInputNames, scm_anEIWith, scm_anEIWithIndexes, 1, scm_anEventOutputNames,
...
void FORTE_F_SINT_TO_REAL::executeEvent(int pa_nEIID) {
  if(scm_nEventREQID == pa_nEIID) {
    st_OUT() = func_SINT_TO_REAL(st_IN());
