...
#include "F_SINT_TO_DINT_fbt_gen.cpp"
#endif
...
const CStringDictionary::TStringId FORTE_F_SINT_TO_DINT::scmEventInputTypeIds[] = {g_nStringIdEvent};
...
const CStringDictionary::TStringId FORTE_F_SINT_TO_DINT::scmEventOutputTypeIds[] = {g_nStringIdEvent};
