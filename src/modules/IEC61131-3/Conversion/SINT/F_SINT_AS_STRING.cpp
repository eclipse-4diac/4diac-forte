...
FORTE_F_SINT_AS_STRING::FORTE_F_SINT_AS_STRING(CStringDictionary::TStringId paInstanceNameId, CResource *paSrcRes) :
...
void FORTE_F_SINT_AS_STRING::executeEvent(TEventID paEIID){
  switch(paEIID) {
    case scmEventREQID:
      alg_REQ();
      break;
