...
const CStringDictionary::TStringId FORTE_F_UINT_TO_DWORD::scmEventInputTypeIds[] = {g_nStringIdEvent};
...
const CStringDictionary::TStringId FORTE_F_UINT_TO_DWORD::scmEventOutputTypeIds[] = {g_nStringIdEvent};
