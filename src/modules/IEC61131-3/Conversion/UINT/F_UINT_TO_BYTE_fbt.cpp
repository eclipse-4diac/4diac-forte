...
#include "F_UINT_TO_BYTE_fbt_gen.cpp"
#endif
...
const CStringDictionary::TStringId FORTE_F_UINT_TO_BYTE::scmEventInputTypeIds[] = {g_nStringIdEvent};
...
const CStringDictionary::TStringId FORTE_F_UINT_TO_BYTE::scmEventOutputTypeIds[] = {g_nStringIdEvent};
