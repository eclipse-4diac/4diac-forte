...
const CStringDictionary::TStringId FORTE_F_UINT_TO_WORD::scmEventInputTypeIds[] = {STRID(Event)};
...
const CStringDictionary::TStringId FORTE_F_UINT_TO_WORD::scmEventOutputTypeIds[] = {STRID(Event)};

const SFBInterfaceSpec FORTE_F_UINT_TO_WORD::scmFBInterfaceSpec = {1,
                                                                   scmEventInputNames,
...
FORTE_F_UINT_TO_WORD::FORTE_F_UINT_TO_WORD(CStringDictionary::TStringId paInstanceNameId,
