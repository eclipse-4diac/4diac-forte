...
DEFINE_FIRMWARE_FB(FORTE_F_UINT_TO_WORD, "F_UINT_TO_WORD"_STRID)
...
FORTE_F_UINT_TO_WORD::FORTE_F_UINT_TO_WORD(const forte::core::StringId paInstanceNameId, forte::core::CFBContainer &paContainer) :
