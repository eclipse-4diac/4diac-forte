...
const SFBInterfaceSpec FORTE_F_UINT_TO_DWORD::scm_stFBInterfaceSpec = { 1, scm_anEventInputNames, scm_anEIWith, scm_anEIWithIndexes, 1, scm_anEventOutputNames,
...
void FORTE_F_UINT_TO_DWORD::executeEvent(int pa_nEIID) {
  if(scm_nEventREQID == pa_nEIID) {
    st_OUT() = func_UINT_TO_DWORD(st_IN());
