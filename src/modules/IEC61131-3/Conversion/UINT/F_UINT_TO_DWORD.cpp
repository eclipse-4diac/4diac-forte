...
const TDataIOID FORTE_F_UINT_TO_DWORD::scm_anEIWith[] = {0, scmWithListDelimiter};
...
const TDataIOID FORTE_F_UINT_TO_DWORD::scm_anEOWith[] = {0, scmWithListDelimiter};
const TForteInt16 FORTE_F_UINT_TO_DWORD::scm_anEOWithIndexes[] = {0};
...
FORTE_F_UINT_TO_DWORD::FORTE_F_UINT_TO_DWORD(CStringDictionary::TStringId pa_nInstanceNameId, CResource *pa_poSrcRes) :
...
void FORTE_F_UINT_TO_DWORD::executeEvent(TEventID pa_nEIID){
  switch(pa_nEIID) {
...
void FORTE_F_UINT_TO_DWORD::readInputData(TEventID pa_nEIID) {
  switch(pa_nEIID) {
    case scm_nEventREQID: {
...
void FORTE_F_UINT_TO_DWORD::writeOutputData(TEventID pa_nEIID) {
  switch(pa_nEIID) {
