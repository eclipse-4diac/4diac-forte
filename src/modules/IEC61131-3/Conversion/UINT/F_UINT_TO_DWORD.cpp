...
FORTE_F_UINT_TO_DWORD::FORTE_F_UINT_TO_DWORD(CStringDictionary::TStringId paInstanceNameId, CResource *paSrcRes) :
...
void FORTE_F_UINT_TO_DWORD::executeEvent(TEventID paEIID){
  switch(paEIID) {
    case scmEventREQID:
      alg_REQ();
      break;
