...
#include "F_UINT_TO_LREAL_fbt_gen.cpp"
#endif
...
const CStringDictionary::TStringId FORTE_F_UINT_TO_LREAL::scmEventInputTypeIds[] = {g_nStringIdEvent};
...
const CStringDictionary::TStringId FORTE_F_UINT_TO_LREAL::scmEventOutputTypeIds[] = {g_nStringIdEvent};
