...
const CStringDictionary::TStringId FORTE_F_USINT_AS_WSTRING::scmDataInputNames[] = {g_nStringIdIN};

const CStringDictionary::TStringId FORTE_F_USINT_AS_WSTRING::scmDataInputTypeIds[] = {g_nStringIdUSINT};

const CStringDictionary::TStringId FORTE_F_USINT_AS_WSTRING::scmDataOutputNames[] = {g_nStringIdOUT};

const CStringDictionary::TStringId FORTE_F_USINT_AS_WSTRING::scmDataOutputTypeIds[] = {g_nStringIdWSTRING};
...
const CStringDictionary::TStringId FORTE_F_USINT_AS_WSTRING::scmEventInputNames[] = {g_nStringIdREQ};
...
const CStringDictionary::TStringId FORTE_F_USINT_AS_WSTRING::scmEventOutputNames[] = {g_nStringIdCNF};
...
FORTE_F_USINT_AS_WSTRING::FORTE_F_USINT_AS_WSTRING(CStringDictionary::TStringId paInstanceNameId, CResource *paSrcRes) :
...
void FORTE_F_USINT_AS_WSTRING::executeEvent(TEventID paEIID){
  switch(paEIID) {
    case scmEventREQID:
      alg_REQ();
      break;
