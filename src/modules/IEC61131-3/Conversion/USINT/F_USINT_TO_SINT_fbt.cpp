...
DEFINE_FIRMWARE_FB(FORTE_F_USINT_TO_SINT, "F_USINT_TO_SINT"_STRID)
...
FORTE_F_USINT_TO_SINT::FORTE_F_USINT_TO_SINT(const forte::core::StringId paInstanceNameId, forte::core::CFBContainer &paContainer) :
