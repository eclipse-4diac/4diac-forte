...
#include "F_USINT_TO_INT_fbt_gen.cpp"
#endif
...
const CStringDictionary::TStringId FORTE_F_USINT_TO_INT::scmEventInputTypeIds[] = {g_nStringIdEvent};
...
const CStringDictionary::TStringId FORTE_F_USINT_TO_INT::scmEventOutputTypeIds[] = {g_nStringIdEvent};
