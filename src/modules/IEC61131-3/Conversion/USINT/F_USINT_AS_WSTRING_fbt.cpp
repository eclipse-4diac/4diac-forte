...
const SFBInterfaceSpec FORTE_F_USINT_AS_WSTRING::scmFBInterfaceSpec = {1,
                                                                       scmEventInputNames,
...
FORTE_F_USINT_AS_WSTRING::FORTE_F_USINT_AS_WSTRING(CStringDictionary::TStringId paInstanceNameId,
