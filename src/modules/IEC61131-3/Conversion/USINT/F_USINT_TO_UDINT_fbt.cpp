...
#include "F_USINT_TO_UDINT_fbt_gen.cpp"
#endif
...
const CStringDictionary::TStringId FORTE_F_USINT_TO_UDINT::scmDataInputNames[] = {g_nStringIdIN};

const CStringDictionary::TStringId FORTE_F_USINT_TO_UDINT::scmDataInputTypeIds[] = {g_nStringIdUSINT};

const CStringDictionary::TStringId FORTE_F_USINT_TO_UDINT::scmDataOutputNames[] = {g_nStringIdOUT};

const CStringDictionary::TStringId FORTE_F_USINT_TO_UDINT::scmDataOutputTypeIds[] = {g_nStringIdUDINT};
...
const CStringDictionary::TStringId FORTE_F_USINT_TO_UDINT::scmEventInputNames[] = {g_nStringIdREQ};
const CStringDictionary::TStringId FORTE_F_USINT_TO_UDINT::scmEventInputTypeIds[] = {g_nStringIdEvent};
...
const CStringDictionary::TStringId FORTE_F_USINT_TO_UDINT::scmEventOutputNames[] = {g_nStringIdCNF};
const CStringDictionary::TStringId FORTE_F_USINT_TO_UDINT::scmEventOutputTypeIds[] = {g_nStringIdEvent};
