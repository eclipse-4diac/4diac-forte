...
DEFINE_FIRMWARE_FB(FORTE_F_REAL_TO_LREAL, "F_REAL_TO_LREAL"_STRID)
...
FORTE_F_REAL_TO_LREAL::FORTE_F_REAL_TO_LREAL(const forte::core::StringId paInstanceNameId, forte::core::CFBContainer &paContainer) :
