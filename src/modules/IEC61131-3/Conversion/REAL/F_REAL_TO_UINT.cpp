...
const TDataIOID FORTE_F_REAL_TO_UINT::scm_anEIWith[] = {0, scmWithListDelimiter};
...
const TDataIOID FORTE_F_REAL_TO_UINT::scm_anEOWith[] = {0, scmWithListDelimiter};
...
FORTE_F_REAL_TO_UINT::FORTE_F_REAL_TO_UINT(CStringDictionary::TStringId pa_nInstanceNameId, CResource *pa_poSrcRes) :
...
void FORTE_F_REAL_TO_UINT::executeEvent(TEventID pa_nEIID){
  switch(pa_nEIID) {
...
void FORTE_F_REAL_TO_UINT::readInputData(TEventID pa_nEIID) {
  switch(pa_nEIID) {
    case scm_nEventREQID: {
...
void FORTE_F_REAL_TO_UINT::writeOutputData(TEventID pa_nEIID) {
  switch(pa_nEIID) {
