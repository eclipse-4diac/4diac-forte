...
const TDataIOID FORTE_F_REAL_TO_DINT::scm_anEIWith[] = {0, scmWithListDelimiter};
...
const TDataIOID FORTE_F_REAL_TO_DINT::scm_anEOWith[] = {0, scmWithListDelimiter};
...
FORTE_F_REAL_TO_DINT::FORTE_F_REAL_TO_DINT(CStringDictionary::TStringId pa_nInstanceNameId, CResource *pa_poSrcRes) :
...
void FORTE_F_REAL_TO_DINT::executeEvent(TEventID pa_nEIID){
  switch(pa_nEIID) {
...
void FORTE_F_REAL_TO_DINT::readInputData(TEventID pa_nEIID) {
  switch(pa_nEIID) {
    case scm_nEventREQID: {
...
void FORTE_F_REAL_TO_DINT::writeOutputData(TEventID pa_nEIID) {
  switch(pa_nEIID) {
