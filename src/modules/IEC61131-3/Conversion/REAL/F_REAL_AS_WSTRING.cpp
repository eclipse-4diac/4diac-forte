...
const TDataIOID FORTE_F_REAL_AS_WSTRING::scm_anEIWith[] = {0, scmWithListDelimiter};
...
const TDataIOID FORTE_F_REAL_AS_WSTRING::scm_anEOWith[] = {0, scmWithListDelimiter};
...
void FORTE_F_REAL_AS_WSTRING::executeEvent(TEventID pa_nEIID){
  switch(pa_nEIID) {
...
void FORTE_F_REAL_AS_WSTRING::readInputData(TEventID pa_nEIID) {
  switch(pa_nEIID) {
    case scm_nEventREQID: {
...
void FORTE_F_REAL_AS_WSTRING::writeOutputData(TEventID pa_nEIID) {
  switch(pa_nEIID) {
