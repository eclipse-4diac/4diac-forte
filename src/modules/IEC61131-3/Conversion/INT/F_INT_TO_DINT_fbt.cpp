...
const CStringDictionary::TStringId FORTE_F_INT_TO_DINT::scmEventInputTypeIds[] = {g_nStringIdEvent};
...
const CStringDictionary::TStringId FORTE_F_INT_TO_DINT::scmEventOutputTypeIds[] = {g_nStringIdEvent};
