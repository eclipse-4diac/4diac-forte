...
const CStringDictionary::TStringId FORTE_F_INT_TO_DINT::scmEventInputTypeIds[] = {STRID(Event)};
...
const CStringDictionary::TStringId FORTE_F_INT_TO_DINT::scmEventOutputTypeIds[] = {STRID(Event)};

const SFBInterfaceSpec FORTE_F_INT_TO_DINT::scmFBInterfaceSpec = {1,
                                                                  scmEventInputNames,
...
FORTE_F_INT_TO_DINT::FORTE_F_INT_TO_DINT(CStringDictionary::TStringId paInstanceNameId,
