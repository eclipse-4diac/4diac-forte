...
const CStringDictionary::TStringId FORTE_F_INT_TO_LREAL::scmEventInputTypeIds[] = {STRID(Event)};
...
const CStringDictionary::TStringId FORTE_F_INT_TO_LREAL::scmEventOutputTypeIds[] = {STRID(Event)};

const SFBInterfaceSpec FORTE_F_INT_TO_LREAL::scmFBInterfaceSpec = {1,
                                                                   scmEventInputNames,
...
FORTE_F_INT_TO_LREAL::FORTE_F_INT_TO_LREAL(CStringDictionary::TStringId paInstanceNameId,
