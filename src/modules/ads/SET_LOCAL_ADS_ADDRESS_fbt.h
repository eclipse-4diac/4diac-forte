...
class FORTE_SET_LOCAL_ADS_ADDRESS final : public CFunctionBlock {
  ...
  public:
    FORTE_SET_LOCAL_ADS_ADDRESS(const forte::core::InstanceNameId paInstanceNameId,
                                forte::core::CFBContainer &paContainer) :
    ~FORTE_SET_LOCAL_ADS_ADDRESS() override = default;

    FORTE_SET_LOCAL_ADS_ADDRESS(forte::core::InstanceNameId paInstanceNameId, forte::core::CFBContainer &paContainer);
