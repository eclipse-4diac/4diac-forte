...
#ifndef SRC_MODULES_logiBUSIO_HANDLE_IOHANDLEESP32LEDO_LEDC_MODE_H_
#define SRC_MODULES_logiBUSIO_HANDLE_IOHANDLEESP32LEDO_LEDC_MODE_H_
...
class IOHandleESP32LEDO_LEDC_MODE : public forte::core::io::IOHandle {

public:
    IOHandleESP32LEDO_LEDC_MODE(
...
private:
  ...
  static int32_t ledc_channel_num;            /*!< LEDC channel */
};

#endif /* SRC_MODULES_logiBUSIO_HANDLE_IOHANDLEESP32LEDO_LEDC_MODE_H_ */
