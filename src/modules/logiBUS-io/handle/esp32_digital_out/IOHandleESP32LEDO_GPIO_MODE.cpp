...
led_indicator_handle_t IOHandleESP32LEDO_GPIO_MODE::led_handles[static_cast<int32_t>(logiBUSIOEnums::DigitalOutPinNumber::DigitalOutNumberOfPins)] = {nullptr};



IOHandleESP32LEDO_GPIO_MODE::~IOHandleESP32LEDO_GPIO_MODE(){
  //TODO led_indicator_delete
  IOHandleESP32LEDO_GPIO_MODE::led_handles[static_cast<int32_t>(this->mPin)] = nullptr;
...
IOHandleESP32LEDO_GPIO_MODE::IOHandleESP32LEDO_GPIO_MODE(
  ...
  if(gpio_num > GPIO_NUM_NC) {
    if(IOHandleESP32LEDO_GPIO_MODE::led_handles[static_cast<int32_t>(this->mPin)] == nullptr) {
      ...
      IOHandleESP32LEDO_GPIO_MODE::led_handles[static_cast<int32_t>(this->mPin)] = led_indicator_create(&config);
      led_indicator_start(IOHandleESP32LEDO_GPIO_MODE::led_handles[static_cast<int32_t>(this->mPin)], BLINK_OFF);
    }
  }
}


void IOHandleESP32LEDO_GPIO_MODE::get(CIEC_ANY &paState) {
}




void IOHandleESP32LEDO_GPIO_MODE::set(const CIEC_ANY &paState) {
  int targetState = (true == static_cast<const CIEC_BOOL &>(paState)) ? 1 : 0;
  int blink_type = BLINK_INVALID;
  switch(mHandleType){
    case logiBUSIODeviceController::HandleType::ESP32LED_DO_5HZ:                 blink_type = BLINK_5HZ;       break;
    case logiBUSIODeviceController::HandleType::ESP32LED_DO_2HZ:                 blink_type = BLINK_2HZ;       break;
    case logiBUSIODeviceController::HandleType::ESP32LED_DO_1HZ:                 blink_type = BLINK_1HZ;       break;
    case logiBUSIODeviceController::HandleType::ESP32LED_DO_05HZ:                blink_type = BLINK_05HZ;      break;
    case logiBUSIODeviceController::HandleType::ESP32LED_DO_ON:                  blink_type = LED_ON;          break;
  ...
  if(blink_type > BLINK_INVALID) {
    switch(targetState){
      case 1:
        led_indicator_start (IOHandleESP32LEDO_GPIO_MODE::led_handles[static_cast<int32_t>(this->mPin)], blink_type);
        break;
      case 0:
        led_indicator_stop (IOHandleESP32LEDO_GPIO_MODE::led_handles[static_cast<int32_t>(this->mPin)], blink_type);
        break;
      default:
        break;
    }
