...
#ifndef SRC_MODULES_logiBUSIO_HANDLE_IOHANDLEESP32BUTTON_REPEAT_H_
#define SRC_MODULES_logiBUSIO_HANDLE_IOHANDLEESP32BUTTON_REPEAT_H_
...
public:
    IOHandleESP32Button_REPEAT(logiBUSIODeviceController *paDeviceCtrl, forte::core::io::IOMapper::Direction paDirection, CIEC_ANY::EDataTypeID paDataType, logiBUSIOEnums::DigitalInPinNumber paPin);
...
#endif /* SRC_MODULES_logiBUSIO_HANDLE_IOHANDLEESP32BUTTON_REPEAT_H_ */
