...
IOHandleESP32Button_SINGLE_CLICK::IOHandleESP32Button_SINGLE_CLICK(logiBUSIODeviceController *paDeviceCtrl, forte::core::io::IOMapper::Direction paDirection, CIEC_ANY::EDataTypeID paDataType, logiBUSIOEnums::DigitalInPinNumber paPin)
...
static const button_event_t EVENT = BUTTON_SINGLE_CLICK;

void IOHandleESP32Button_SINGLE_CLICK::register_GPIO_BUTTON(logiBUSIOEnums::DigitalInPinNumber paPin, int32_t gpio_num) {
...
void IOHandleESP32Button_SINGLE_CLICK::button_cb(void *button_handle, void *usr_data) {
  if(usr_data) {
    IOHandleESP32Button_SINGLE_CLICK *p = static_cast<IOHandleESP32Button_SINGLE_CLICK *>(usr_data);
    p->button_cb(button_handle);
  }
}

void IOHandleESP32Button_SINGLE_CLICK::button_cb(void *button_handle) {
  this->onChange();
}


void IOHandleESP32Button_SINGLE_CLICK::get(CIEC_ANY &paState) {
}

IOHandleESP32Button_SINGLE_CLICK::~IOHandleESP32Button_SINGLE_CLICK() {
...
void IOHandleESP32Button_SINGLE_CLICK::set(const CIEC_ANY &paState) {
}
