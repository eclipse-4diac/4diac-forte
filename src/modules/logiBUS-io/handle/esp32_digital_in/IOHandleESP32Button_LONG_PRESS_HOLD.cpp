...
IOHandleESP32Button_LONG_PRESS_HOLD::IOHandleESP32Button_LONG_PRESS_HOLD(logiBUSIODeviceController *paDeviceCtrl, forte::core::io::IOMapper::Direction paDirection, CIEC_ANY::EDataTypeID paDataType, logiBUSIOEnums::DigitalInPinNumber paPin)
...
static const button_event_t EVENT = BUTTON_LONG_PRESS_HOLD;

void IOHandleESP32Button_LONG_PRESS_HOLD::register_GPIO_BUTTON(logiBUSIOEnums::DigitalInPinNumber paPin, int32_t gpio_num) {
...
void IOHandleESP32Button_LONG_PRESS_HOLD::button_cb(void *button_handle, void *usr_data) {
  if(usr_data) {
    IOHandleESP32Button_LONG_PRESS_HOLD *p = static_cast<IOHandleESP32Button_LONG_PRESS_HOLD *>(usr_data);
    p->button_cb(button_handle);
  }
}

void IOHandleESP32Button_LONG_PRESS_HOLD::button_cb(void *button_handle) {
  this->onChange();
}


void IOHandleESP32Button_LONG_PRESS_HOLD::get(CIEC_ANY &paState) {
}

IOHandleESP32Button_LONG_PRESS_HOLD::~IOHandleESP32Button_LONG_PRESS_HOLD() {
...
void IOHandleESP32Button_LONG_PRESS_HOLD::set(const CIEC_ANY &paState) {
}
