...
IOHandleESP32Button_UP::IOHandleESP32Button_UP(logiBUSIODeviceController *paDeviceCtrl, forte::core::io::IOMapper::Direction paDirection, CIEC_ANY::EDataTypeID paDataType, logiBUSIOEnums::DigitalInPinNumber paPin)
...
static const button_event_t EVENT = BUTTON_PRESS_UP;

void IOHandleESP32Button_UP::register_GPIO_BUTTON(logiBUSIOEnums::DigitalInPinNumber paPin, int32_t gpio_num) {
...
void IOHandleESP32Button_UP::button_cb(void *button_handle, void *usr_data) {
  if(usr_data) {
    IOHandleESP32Button_UP *p = static_cast<IOHandleESP32Button_UP *>(usr_data);
    p->button_cb(button_handle);
  }
}

void IOHandleESP32Button_UP::button_cb(void *button_handle) {
  this->onChange();
}

void IOHandleESP32Button_UP::get(CIEC_ANY &paState) {
}

IOHandleESP32Button_UP::~IOHandleESP32Button_UP() {
...
void IOHandleESP32Button_UP::set(const CIEC_ANY &paState) {
}
