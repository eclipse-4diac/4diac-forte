...
IOHandleESP32Button_DOUBLE_CLICK::IOHandleESP32Button_DOUBLE_CLICK(
...
static const button_event_t EVENT = BUTTON_DOUBLE_CLICK;

void IOHandleESP32Button_DOUBLE_CLICK::register_GPIO_BUTTON(logiBUSIOEnums::DigitalInPinNumber paPin, int32_t gpio_num) {
...
void IOHandleESP32Button_DOUBLE_CLICK::button_cb(void *button_handle, void *usr_data) {
  if(usr_data) {
    IOHandleESP32Button_DOUBLE_CLICK *p = static_cast<IOHandleESP32Button_DOUBLE_CLICK *>(usr_data);
    p->button_cb(button_handle);
  }
}

void IOHandleESP32Button_DOUBLE_CLICK::button_cb(void *button_handle) {
  this->onChange();
}

void IOHandleESP32Button_DOUBLE_CLICK::get(CIEC_ANY &paState) {
}
...
void IOHandleESP32Button_DOUBLE_CLICK::set(const CIEC_ANY &paState) {
}
