...
class FORTE_logiBUS_8_DI_LONG_PRESS_HOLD final : public logiBUSIOFunctionBlock {
  DECLARE_FIRMWARE_FB(FORTE_logiBUS_8_DI_LONG_PRESS_HOLD)
  ...
  public:
    FORTE_logiBUS_8_DI_LONG_PRESS_HOLD(CStringDictionary::TStringId paInstanceNameId, forte::core::CFBContainer &paContainer);
