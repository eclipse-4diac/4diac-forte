...
class FORTE_logiBUS_8_DI_END final : public logiBUSIOFunctionBlock {
  DECLARE_FIRMWARE_FB(FORTE_logiBUS_8_DI_END)
  ...
  public:
    FORTE_logiBUS_8_DI_END(CStringDictionary::TStringId paInstanceNameId, forte::core::CFBContainer &paContainer);
