...
class FORTE_logiBUS_8_DI_LONG_PRESS_UP final : public logiBUSIOFunctionBlock {
  DECLARE_FIRMWARE_FB(FORTE_logiBUS_8_DI_LONG_PRESS_UP)
  ...
  public:
    FORTE_logiBUS_8_DI_LONG_PRESS_UP(CStringDictionary::TStringId paInstanceNameId, forte::core::CFBContainer &paContainer);
