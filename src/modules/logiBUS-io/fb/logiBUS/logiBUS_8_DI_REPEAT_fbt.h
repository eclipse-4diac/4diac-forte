...
class FORTE_logiBUS_8_DI_REPEAT final : public logiBUSIOFunctionBlock {
  DECLARE_FIRMWARE_FB(FORTE_logiBUS_8_DI_REPEAT)
  ...
  public:
    FORTE_logiBUS_8_DI_REPEAT(CStringDictionary::TStringId paInstanceNameId, forte::core::CFBContainer &paContainer);
