...
class FORTE_logiBUS_8_DI_DOWN final : public logiBUSIOFunctionBlock {
  DECLARE_FIRMWARE_FB(FORTE_logiBUS_8_DI_DOWN)
  ...
  public:
    FORTE_logiBUS_8_DI_DOWN(CStringDictionary::TStringId paInstanceNameId, forte::core::CFBContainer &paContainer);
