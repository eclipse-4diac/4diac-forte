...
class FORTE_logiBUS_8_DO_PWM final : public CFunctionBlock {
  DECLARE_FIRMWARE_FB(FORTE_logiBUS_8_DO_PWM)
  ...
  public:
    FORTE_logiBUS_8_DO_PWM(CStringDictionary::TStringId paInstanceNameId, forte::core::CFBContainer &paContainer);

    CIEC_BOOL var_QI;
    CIEC_UDINT var_target_duty;
    CIEC_UDINT var_max_fade_time_ms;
    ...
    CDataConnection *conn_target_duty;
    CDataConnection *conn_max_fade_time_ms;
    ...
    void operator()(const CIEC_BOOL &paQI, const CIEC_UDINT &patarget_duty, const CIEC_UDINT &pamax_fade_time_ms, const CIEC_STRING &paDigitalOutput_Q1, const CIEC_STRING &paDigitalOutput_Q2, const CIEC_STRING &paDigitalOutput_Q3, const CIEC_STRING &paDigitalOutput_Q4, const CIEC_STRING &paDigitalOutput_Q5, const CIEC_STRING &paDigitalOutput_Q6, const CIEC_STRING &paDigitalOutput_Q7, const CIEC_STRING &paDigitalOutput_Q8, CIEC_BOOL &paQO, CIEC_STRING &paSTATUS) {
      evt_INIT(paQI, patarget_duty, pamax_fade_time_ms, paDigitalOutput_Q1, paDigitalOutput_Q2, paDigitalOutput_Q3, paDigitalOutput_Q4, paDigitalOutput_Q5, paDigitalOutput_Q6, paDigitalOutput_Q7, paDigitalOutput_Q8, paQO, paSTATUS);
    }
};
