...
class FORTE_logiBUS_8_DI_REPEAT_DONE final : public logiBUSIOFunctionBlock {
  DECLARE_FIRMWARE_FB(FORTE_logiBUS_8_DI_REPEAT_DONE)
  ...
  public:
    FORTE_logiBUS_8_DI_REPEAT_DONE(CStringDictionary::TStringId paInstanceNameId, forte::core::CFBContainer &paContainer);
