...
class FORTE_logiBUS_1_LED_strip final : public logiBUSIOFunctionBlock {
  DECLARE_FIRMWARE_FB(FORTE_logiBUS_1_LED_strip)
  ...
  public:
    FORTE_logiBUS_1_LED_strip(CStringDictionary::TStringId paInstanceNameId, forte::core::CFBContainer &paContainer);

    CIEC_BOOL var_QI;
    CIEC_USINT var_Output;
    CIEC_UINT var_Colour;
    ...
    void evt_INIT(const CIEC_BOOL &paQI, const CIEC_USINT &paOutput, const CIEC_UINT &paColour, const CIEC_STRING &paLED_5HZ, const CIEC_STRING &paLED_2HZ, const CIEC_STRING &paLED_1HZ, const CIEC_STRING &paLED_05HZ, const CIEC_STRING &paLED_ON, CIEC_BOOL &paQO, CIEC_STRING &paSTATUS) {
      var_QI = paQI;
      var_Output = paOutput;
      var_Colour = paColour;
    ...
    void operator()(const CIEC_BOOL &paQI, const CIEC_USINT &paOutput, const CIEC_UINT &paColour, const CIEC_STRING &paLED_5HZ, const CIEC_STRING &paLED_2HZ, const CIEC_STRING &paLED_1HZ, const CIEC_STRING &paLED_05HZ, const CIEC_STRING &paLED_ON, CIEC_BOOL &paQO, CIEC_STRING &paSTATUS) {
      evt_INIT(paQI, paOutput, paColour, paLED_5HZ, paLED_2HZ, paLED_1HZ, paLED_05HZ, paLED_ON, paQO, paSTATUS);
    }
};
