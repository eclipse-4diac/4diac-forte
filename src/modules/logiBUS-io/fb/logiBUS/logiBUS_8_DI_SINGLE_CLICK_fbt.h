...
class FORTE_logiBUS_8_DI_SINGLE_CLICK final : public logiBUSIOFunctionBlock {
  DECLARE_FIRMWARE_FB(FORTE_logiBUS_8_DI_SINGLE_CLICK)
  ...
  public:
    FORTE_logiBUS_8_DI_SINGLE_CLICK(CStringDictionary::TStringId paInstanceNameId, forte::core::CFBContainer &paContainer);
