...
class FORTE_logiBUS_8_DI_MULTIPLE_CLICK final : public logiBUSIOFunctionBlock {
  DECLARE_FIRMWARE_FB(FORTE_logiBUS_8_DI_MULTIPLE_CLICK)
  ...
  public:
    FORTE_logiBUS_8_DI_MULTIPLE_CLICK(CStringDictionary::TStringId paInstanceNameId, forte::core::CFBContainer &paContainer);
