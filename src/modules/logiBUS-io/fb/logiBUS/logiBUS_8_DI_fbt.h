...
class FORTE_logiBUS_8_DI final : public logiBUSIOFunctionBlock {
  DECLARE_FIRMWARE_FB(FORTE_logiBUS_8_DI)
  ...
  public:
    FORTE_logiBUS_8_DI(CStringDictionary::TStringId paInstanceNameId, forte::core::CFBContainer &paContainer);
