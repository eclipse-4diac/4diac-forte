...
const SCFB_FBConnectionData FORTE_SubscribeEventHTTP::scmEventConnections[] = {
    {GENERATE_CONNECTION_PORT_ID_2_ARG(STRID(Register), STRID(INITO)), 7,
     GENERATE_CONNECTION_PORT_ID_2_ARG(STRID(E_PERMIT), STRID(EI)), 1},
    {GENERATE_CONNECTION_PORT_ID_2_ARG(STRID(Register), STRID(CNF)), 7,
     GENERATE_CONNECTION_PORT_ID_2_ARG(STRID(InitFlagReg), STRID(R)), 0},
    {GENERATE_CONNECTION_PORT_ID_2_ARG(STRID(InitFlagReg), STRID(EO)), 0,
     GENERATE_CONNECTION_PORT_ID_2_ARG(STRID(Register), STRID(INIT)), 7},
    ...
    {GENERATE_CONNECTION_PORT_ID_2_ARG(STRID(E_PERMIT), STRID(EO)), 1,
     GENERATE_CONNECTION_PORT_ID_2_ARG(STRID(Register), STRID(REQ)), 7},
    ...
    {GENERATE_CONNECTION_PORT_ID_2_ARG(STRID(InitFlagUnReg), STRID(EO)), 2,
     GENERATE_CONNECTION_PORT_ID_2_ARG(STRID(Unregister), STRID(INIT)), 8},
    {GENERATE_CONNECTION_PORT_ID_2_ARG(STRID(E_PERMIT_1), STRID(EO)), 6,
     GENERATE_CONNECTION_PORT_ID_2_ARG(STRID(Unregister), STRID(REQ)), 8},
    {GENERATE_CONNECTION_PORT_ID_2_ARG(STRID(Unregister), STRID(INITO)), 8,
     GENERATE_CONNECTION_PORT_ID_2_ARG(STRID(E_PERMIT_1), STRID(EI)), 6},
    {GENERATE_CONNECTION_PORT_ID_2_ARG(STRID(Unregister), STRID(CNF)), 8,
    ...
    {GENERATE_CONNECTION_PORT_ID_2_ARG(STRID(SubscribeEventAdp), STRID(Unsubscribe)),
     CCompositeFB::scmAdapterMarker | 0, GENERATE_CONNECTION_PORT_ID_2_ARG(STRID(CreateRegisterID_1), STRID(REQ)), 9},
    {GENERATE_CONNECTION_PORT_ID_2_ARG(STRID(CreateRegisterID_1), STRID(CNF)), 9,
     GENERATE_CONNECTION_PORT_ID_2_ARG(STRID(F_STRING_TO_WSTRING_2), STRID(REQ)), 10},
    {GENERATE_CONNECTION_PORT_ID_2_ARG(STRID(F_STRING_TO_WSTRING_2), STRID(CNF)), 10,
     GENERATE_CONNECTION_PORT_ID_2_ARG(STRID(ANYToJSON), STRID(REQ)), 5},
};

const SCFB_FBFannedOutConnectionData FORTE_SubscribeEventHTTP::scmFannedOutEventConnections[] = {
    {1, GENERATE_CONNECTION_PORT_ID_2_ARG(STRID(SubscribeEventAdp), STRID(Subscribed)),
     CCompositeFB::scmAdapterMarker | 0},
...
const SCFB_FBConnectionData FORTE_SubscribeEventHTTP::scmDataConnections[] = {
    ...
    {GENERATE_CONNECTION_PORT_ID_2_ARG(STRID(InitFlagReg), STRID(Q)), 0,
     GENERATE_CONNECTION_PORT_ID_2_ARG(STRID(Register), STRID(QI)), 7},
    {GENERATE_CONNECTION_PORT_ID_2_ARG(STRID(ANYToJSON), STRID(output)), 5,
     GENERATE_CONNECTION_PORT_ID_2_ARG(STRID(Register), STRID(SD_1)), 7},
    ...
    {GENERATE_CONNECTION_PORT_ID_2_ARG(STRID(F_STRING_TO_WSTRING), STRID(OUT)), 3,
     GENERATE_CONNECTION_PORT_ID_2_ARG(STRID(Register), STRID(ID)), 7},
    ...
    {GENERATE_CONNECTION_PORT_ID_2_ARG(STRID(CreateRegisterID_1), STRID(OUT)), 9,
     GENERATE_CONNECTION_PORT_ID_2_ARG(STRID(F_STRING_TO_WSTRING_2), STRID(IN)), 10},
    {GENERATE_CONNECTION_PORT_ID_2_ARG(STRID(F_STRING_TO_WSTRING_2), STRID(OUT)), 10,
     GENERATE_CONNECTION_PORT_ID_2_ARG(STRID(Unregister), STRID(ID)), 8},
};
