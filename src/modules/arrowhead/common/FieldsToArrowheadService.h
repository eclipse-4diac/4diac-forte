...
class FORTE_FieldsToArrowheadService : public CBasicFB {
  ...
  private:
    ...
    CIEC_WSTRING *interfaces() {
      return (
          CIEC_WSTRING *) (*static_cast<CIEC_ARRAY<> *>(getDI(1)))[0]; // the first element marks the start of the array
    };
    ...
    CIEC_WSTRING *serviceMetadata() {
      return (
          CIEC_WSTRING *) (*static_cast<CIEC_ARRAY<> *>(getDI(2)))[0]; // the first element marks the start of the array
    };
  ...
  public:
    FORTE_FieldsToArrowheadService(forte::core::StringId paInstanceNameId, forte::core::CFBContainer &paContainer) :
