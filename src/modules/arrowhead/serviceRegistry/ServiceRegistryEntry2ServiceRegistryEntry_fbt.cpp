...
const CStringDictionary::TStringId FORTE_ServiceRegistryEntry2ServiceRegistryEntry::scmDataInputTypeIds[] = {STRID(ServiceRegistryEntry)};

const CStringDictionary::TStringId FORTE_ServiceRegistryEntry2ServiceRegistryEntry::scmDataOutputNames[] = {STRID(OUT)};

const CStringDictionary::TStringId FORTE_ServiceRegistryEntry2ServiceRegistryEntry::scmDataOutputTypeIds[] = {STRID(ServiceRegistryEntry)};
...
const CStringDictionary::TStringId FORTE_ServiceRegistryEntry2ServiceRegistryEntry::scmEventInputTypeIds[] = {STRID(Event)};
...
const CStringDictionary::TStringId FORTE_ServiceRegistryEntry2ServiceRegistryEntry::scmEventOutputNames[] = {STRID(CNF)};
const CStringDictionary::TStringId FORTE_ServiceRegistryEntry2ServiceRegistryEntry::scmEventOutputTypeIds[] = {STRID(Event)};
