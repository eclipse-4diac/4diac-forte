...
const SCFB_FBConnectionData FORTE_QueryServiceOpcUa::scmEventConnections[] = {
    {GENERATE_CONNECTION_PORT_ID_2_ARG(STRID(APPEND_STRING_3), STRID(CNF)), 0,
     GENERATE_CONNECTION_PORT_ID_2_ARG(STRID(F_STRING_TO_WSTRING), STRID(REQ)), 1},
    {GENERATE_CONNECTION_PORT_ID_2_ARG(STRID(F_STRING_TO_WSTRING), STRID(CNF)), 1,
    ...
    {GENERATE_CONNECTION_PORT_ID_2_ARG(STRID(queryServices), STRID(query)), CCompositeFB::scmAdapterMarker | 0,
     GENERATE_CONNECTION_PORT_ID_2_ARG(STRID(ANYToJSON), STRID(REQ)), 4},
    {GENERATE_CONNECTION_PORT_ID_2_ARG(STRID(GetHTTPResult), STRID(CNF)), 5,
    ...
    {GENERATE_CONNECTION_PORT_ID_2_ARG(STRID(InitFlag), STRID(EO)), 2,
     GENERATE_CONNECTION_PORT_ID_2_ARG(STRID(Query), STRID(INIT)), 6},
    {GENERATE_CONNECTION_PORT_ID_2_ARG(STRID(E_PERMIT), STRID(EO)), 3,
     GENERATE_CONNECTION_PORT_ID_2_ARG(STRID(Query), STRID(REQ)), 6},
    {GENERATE_CONNECTION_PORT_ID_2_ARG(STRID(Query), STRID(INITO)), 6,
     GENERATE_CONNECTION_PORT_ID_2_ARG(STRID(E_PERMIT), STRID(EI)), 3},
    {GENERATE_CONNECTION_PORT_ID_2_ARG(STRID(E_SWITCH_1), STRID(EO0)), 7,
     GENERATE_CONNECTION_PORT_ID_2_ARG(STRID(E_DELAY), STRID(START)), 9},
    {GENERATE_CONNECTION_PORT_ID_2_ARG(STRID(E_CTU), STRID(CUO)), 10,
     GENERATE_CONNECTION_PORT_ID_2_ARG(STRID(E_SWITCH_1), STRID(EI)), 7},
    {GENERATE_CONNECTION_PORT_ID_2_ARG(STRID(E_SWITCH), STRID(EO0)), 8,
     GENERATE_CONNECTION_PORT_ID_2_ARG(STRID(E_CTU), STRID(CU)), 10},
    {GENERATE_CONNECTION_PORT_ID_2_ARG(STRID(E_SWITCH), STRID(EO1)), 8,
     GENERATE_CONNECTION_PORT_ID_2_ARG(STRID(GetHTTPResult), STRID(REQ)), 5},
    {GENERATE_CONNECTION_PORT_ID_2_ARG(STRID(Query), STRID(CNF)), 6,
     GENERATE_CONNECTION_PORT_ID_2_ARG(STRID(E_SWITCH), STRID(EI)), 8},
    {GENERATE_CONNECTION_PORT_ID_2_ARG(STRID(E_SWITCH_1), STRID(EO1)), 7,
     GENERATE_CONNECTION_PORT_ID_2_ARG(STRID(InitFlag), STRID(R)), 2},
    {GENERATE_CONNECTION_PORT_ID_2_ARG(STRID(E_DELAY), STRID(EO)), 9,
     GENERATE_CONNECTION_PORT_ID_2_ARG(STRID(Query), STRID(REQ)), 6},
};
...
const SCFB_FBConnectionData FORTE_QueryServiceOpcUa::scmDataConnections[] = {
    {GENERATE_CONNECTION_PORT_ID_2_ARG(STRID(APPEND_STRING_3), STRID(OUT)), 0,
     GENERATE_CONNECTION_PORT_ID_2_ARG(STRID(F_STRING_TO_WSTRING), STRID(IN)), 1},
    ...
    {GENERATE_CONNECTION_PORT_ID_2_ARG(STRID(GetHTTPResult), STRID(output)), 5,
     GENERATE_CONNECTION_PORT_ID_2_ARG(STRID(queryServices), STRID(serviceEntries)),
     CCompositeFB::scmAdapterMarker | 0},
    {GENERATE_CONNECTION_PORT_ID_2_ARG(STRID(F_STRING_TO_WSTRING), STRID(OUT)), 1,
     GENERATE_CONNECTION_PORT_ID_2_ARG(STRID(Query), STRID(ID)), 6},
    {GENERATE_CONNECTION_PORT_ID_2_ARG(STRID(ANYToJSON), STRID(output)), 4,
     GENERATE_CONNECTION_PORT_ID_2_ARG(STRID(Query), STRID(SD_1)), 6},
    {GENERATE_CONNECTION_PORT_ID_2_ARG(STRID(Query), STRID(RD_1)), 6,
     GENERATE_CONNECTION_PORT_ID_2_ARG(STRID(GetHTTPResult), STRID(response)), 5},
    {GENERATE_CONNECTION_PORT_ID_2_ARG(STRID(E_CTU), STRID(Q)), 10,
     GENERATE_CONNECTION_PORT_ID_2_ARG(STRID(E_SWITCH_1), STRID(G)), 7},
    {GENERATE_CONNECTION_PORT_ID_2_ARG(STRID(Query), STRID(QO)), 6,
     GENERATE_CONNECTION_PORT_ID_2_ARG(STRID(E_SWITCH), STRID(G)), 8},
};
