...
class FORTE_RT_E_EC_COUPLER final : public CRTEventSingle {
  ...
  public:
    FORTE_RT_E_EC_COUPLER(const forte::core::StringId paInstanceNameId, forte::core::CFBContainer &paContainer);
