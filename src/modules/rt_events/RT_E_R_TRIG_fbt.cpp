...
const CStringDictionary::TStringId FORTE_RT_E_R_TRIG::scmDataInputNames[] = {STRID(QI), STRID(Tmin), STRID(Deadline), STRID(WCET)};
const CStringDictionary::TStringId FORTE_RT_E_R_TRIG::scmDataInputTypeIds[] = {STRID(BOOL), STRID(TIME), STRID(TIME), STRID(TIME)};
