...
const TDataIOID FORTE_RT_E_R_TRIG::scm_anEIWith[] = {0, 1, 2, 3, scmWithListDelimiter, 0, scmWithListDelimiter};
...
const TDataIOID FORTE_RT_E_R_TRIG::scm_anEOWith[] = {0, scmWithListDelimiter};
const TForteInt16 FORTE_RT_E_R_TRIG::scm_anEOWithIndexes[] = {0, -1};
...
CIEC_ANY *FORTE_RT_E_R_TRIG::getDIO(size_t) {
  return nullptr;
}
...
CInOutDataConnection **FORTE_RT_E_R_TRIG::getDIOInConUnchecked(TPortId) {
  return nullptr;
}

CInOutDataConnection *FORTE_RT_E_R_TRIG::getDIOOutConUnchecked(TPortId) {
  return nullptr;
}
