...
GEN_VALUES2ARRAY::GEN_VALUES2ARRAY(const CStringDictionary::TStringId pa_nInstanceNameId, CResource *pa_poSrcRes) :
...
SFBInterfaceSpecforGenerics *GEN_VALUES2ARRAY::createInterfaceSpec(const char *paConfigString) {
