...
namespace {
  const auto cDataInputNames = std::array{STRID(BIT_00), STRID(BIT_01), STRID(BIT_02), STRID(BIT_03),
...
FORTE_ASSEMBLE_BYTE_FROM_BOOLS::FORTE_ASSEMBLE_BYTE_FROM_BOOLS(const forte::core::InstanceNameId paInstanceNameId,
