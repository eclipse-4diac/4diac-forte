                                      ...
                                      func_OR<CIEC_DWORD>(
                                          func_OR<CIEC_DWORD>(
                                              ...
                                              func_SHL(func_BYTE_TO_DWORD(st_lv_QUARTER_BYTE_10),
                                                       st_global_SHIFT_QUARTER_10)),
                                          func_SHL(func_BYTE_TO_DWORD(st_lv_QUARTER_BYTE_09),
                                                   st_global_SHIFT_QUARTER_09)),
                                      func_SHL(func_BYTE_TO_DWORD(st_lv_QUARTER_BYTE_08), st_global_SHIFT_QUARTER_08)),
                                  func_SHL(func_BYTE_TO_DWORD(st_lv_QUARTER_BYTE_07), st_global_SHIFT_QUARTER_07)),
                              func_SHL(func_BYTE_TO_DWORD(st_lv_QUARTER_BYTE_06), st_global_SHIFT_QUARTER_06)),
                          func_SHL(func_BYTE_TO_DWORD(st_lv_QUARTER_BYTE_05), st_global_SHIFT_QUARTER_05)),
                      func_SHL(func_BYTE_TO_DWORD(st_lv_QUARTER_BYTE_04), st_global_SHIFT_QUARTER_04)),
                  func_SHL(func_BYTE_TO_DWORD(st_lv_QUARTER_BYTE_03), st_global_SHIFT_QUARTER_03)),
              func_SHL(func_BYTE_TO_DWORD(st_lv_QUARTER_BYTE_02), st_global_SHIFT_QUARTER_02)),
          func_SHL(func_BYTE_TO_DWORD(st_lv_QUARTER_BYTE_01), st_global_SHIFT_QUARTER_01)),
      func_SHL(func_BYTE_TO_DWORD(st_lv_QUARTER_BYTE_00), st_global_SHIFT_QUARTER_00));
