...
const CStringDictionary::TStringId FORTE_ASSEMBLE_WORD_FROM_QUARTERS::scmEventInputTypeIds[] = {g_nStringIdEvent};
...
const CStringDictionary::TStringId FORTE_ASSEMBLE_WORD_FROM_QUARTERS::scmEventOutputTypeIds[] = {g_nStringIdEvent};
