...
namespace {
  const auto cDataInputNames = std::array{STRID(WORD_00),
                                                                                             STRID(WORD_01)};
...
FORTE_ASSEMBLE_DWORD_FROM_WORDS::FORTE_ASSEMBLE_DWORD_FROM_WORDS(const forte::core::InstanceNameId paInstanceNameId,
