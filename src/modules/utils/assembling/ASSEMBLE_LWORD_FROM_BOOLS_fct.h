...
class FORTE_ASSEMBLE_LWORD_FROM_BOOLS final : public CFunctionBlock {
  ...
  public:
    FORTE_ASSEMBLE_LWORD_FROM_BOOLS(CStringDictionary::TStringId paInstanceNameId, forte::core::CFBContainer &paContainer);
