...
USE_STRING_ID();
USE_STRING_ID(ASSEMBLE_DWORD_FROM_BOOLS);
...
FORTE_ASSEMBLE_DWORD_FROM_BOOLS::FORTE_ASSEMBLE_DWORD_FROM_BOOLS(const forte::core::InstanceNameId paInstanceNameId,
