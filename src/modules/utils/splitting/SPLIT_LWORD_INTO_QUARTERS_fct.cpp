...
const CStringDictionary::TStringId FORTE_SPLIT_LWORD_INTO_QUARTERS::scmDataOutputNames[] = {STRID(QUARTER_BYTE_00), STRID(QUARTER_BYTE_01), STRID(QUARTER_BYTE_02), STRID(QUARTER_BYTE_03), STRID(QUARTER_BYTE_04), STRID(QUARTER_BYTE_05), STRID(QUARTER_BYTE_06), STRID(QUARTER_BYTE_07), STRID(QUARTER_BYTE_08), STRID(QUARTER_BYTE_09), STRID(QUARTER_BYTE_10), STRID(QUARTER_BYTE_11), STRID(QUARTER_BYTE_12), STRID(QUARTER_BYTE_13), STRID(QUARTER_BYTE_14), STRID(QUARTER_BYTE_15), STRID(QUARTER_BYTE_16), STRID(QUARTER_BYTE_17), STRID(QUARTER_BYTE_18), STRID(QUARTER_BYTE_19), STRID(QUARTER_BYTE_20), STRID(QUARTER_BYTE_21), STRID(QUARTER_BYTE_22), STRID(QUARTER_BYTE_23), STRID(QUARTER_BYTE_24), STRID(QUARTER_BYTE_25), STRID(QUARTER_BYTE_26), STRID(QUARTER_BYTE_27), STRID(QUARTER_BYTE_28), STRID(QUARTER_BYTE_29), STRID(QUARTER_BYTE_30), STRID(QUARTER_BYTE_31)};
const CStringDictionary::TStringId FORTE_SPLIT_LWORD_INTO_QUARTERS::scmDataOutputTypeIds[] = {STRID(BYTE), STRID(BYTE), STRID(BYTE), STRID(BYTE), STRID(BYTE), STRID(BYTE), STRID(BYTE), STRID(BYTE), STRID(BYTE), STRID(BYTE), STRID(BYTE), STRID(BYTE), STRID(BYTE), STRID(BYTE), STRID(BYTE), STRID(BYTE), STRID(BYTE), STRID(BYTE), STRID(BYTE), STRID(BYTE), STRID(BYTE), STRID(BYTE), STRID(BYTE), STRID(BYTE), STRID(BYTE), STRID(BYTE), STRID(BYTE), STRID(BYTE), STRID(BYTE), STRID(BYTE), STRID(BYTE), STRID(BYTE)};
