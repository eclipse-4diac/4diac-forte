...
namespace {
  ...
  const auto cDataOutputNames = std::array{"WORD_00"_STRID,
                                                                                           "WORD_01"_STRID};
...
FORTE_SPLIT_DWORD_INTO_WORDS::FORTE_SPLIT_DWORD_INTO_WORDS(const forte::core::StringId paInstanceNameId,
