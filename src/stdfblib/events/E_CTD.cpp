...
FORTE_E_CTD::FORTE_E_CTD(const CStringDictionary::TStringId paInstanceNameId, CResource *const paSrcRes) :
...
void FORTE_E_CTD::enterStateSTART(CEventChainExecutionThread *const paECET) {
