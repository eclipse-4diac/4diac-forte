...
FORTE_E_SR::FORTE_E_SR(const CStringDictionary::TStringId paInstanceNameId, CResource *const paSrcRes) :
...
void FORTE_E_SR::enterStateSTART(CEventChainExecutionThread *const paECET) {
