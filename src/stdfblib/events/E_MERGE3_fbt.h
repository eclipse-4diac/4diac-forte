...
class FORTE_E_MERGE3 final : public CBasicFB {
  DECLARE_FIRMWARE_FB(FORTE_E_MERGE3)
  ...
  public:
    FORTE_E_MERGE3(CStringDictionary::TStringId paInstanceNameId, forte::core::CFBContainer &paContainer);
