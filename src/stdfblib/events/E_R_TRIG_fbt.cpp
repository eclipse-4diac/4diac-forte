...
const SCFB_FBInstanceData FORTE_E_R_TRIG::scmInternalFBs[] = {{STRID(E_D_FF), STRID(E_D_FF)},
...
const SCFB_FBConnectionData FORTE_E_R_TRIG::scmEventConnections[] = {
    ...
    {GENERATE_CONNECTION_PORT_ID_2_ARG(STRID(E_SWITCH), STRID(EO1)), 1, GENERATE_CONNECTION_PORT_ID_1_ARG(STRID(EO)),
     -1},
};
