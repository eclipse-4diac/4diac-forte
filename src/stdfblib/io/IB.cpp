...
const TDataIOID FORTE_IB::scm_anEOWith[] = { 0, 1, scmWithListDelimiter, 0, 1, 2, scmWithListDelimiter };
...
void FORTE_IB::executeEvent(TEventID pa_nEIID){
  QO() = QI();
  switch(pa_nEIID){
    ...
    case scm_nEventREQID:
      if(true == QI()){
        QO() = CIEC_BOOL(CProcessInterface::readByte());
      }
