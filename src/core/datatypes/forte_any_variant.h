...
#include "core/datatypes/forte_any_unique_ptr.h"
...
class CIEC_ANY_VARIANT : public CIEC_ANY, public TIecAnyVariantType {
  ...
  public:
    ...
    CIEC_ANY_VARIANT &operator=(const CIEC_ANY &paOther) {
...
static_assert(std::is_constructible_v<CIEC_ANY_VARIANT, const CIEC_ANY &>);
