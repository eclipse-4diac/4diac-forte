...
bool CIEC_ANY::isCastable(EDataTypeID pa_eSource, EDataTypeID pa_eDestination, bool &pa_rbUpCast, bool &pa_rbDownCast){
  ...
  static const TForteByte UpCast[e_WSTRING - e_BOOL + 1][(e_WSTRING - e_BOOL + 8) / 8] = {
      {B8(11111111), B8(11111000), B8(00011000)}, // e_BOOL to x
      {B8(01111000), B8(01111000), B8(00011000)}, // e_SINT
      {B8(00111000), B8(00111000), B8(00011000)}, // e_INT
      {B8(00011000), B8(00011000), B8(00001000)}, // e_DINT

      {B8(00001000), B8(00001000), B8(10000000)}, // e_LINT
      {B8(00111111), B8(11111000), B8(00011000)}, // e_USINT
      {B8(00011011), B8(10111000), B8(00011000)}, // e_UINT
      {B8(00001001), B8(10011000), B8(00001000)}, // e_UDINT
      ...
      {B8(00011001), B8(10011000), B8(00010000)}, // e_DWORD

      {B8(00001000), B8(10001000), B8(00011000)}, // e_LWORD
      ...
      {B8(00000000), B8(00000000), B8(10000000)}, // e_TIME

      {B8(00000000), B8(00000000), B8(01000100)}, // e_CHAR
      {B8(00000000), B8(00000000), B8(00100010)}, // e_WCHAR

      {B8(00000000), B8(00011000), B8(00011000)}, // e_REAL
      {B8(00000000), B8(00001000), B8(00001000)}, // e_LREAL
      {B8(00000000), B8(00000000), B8(00000100)}, // e_STRING

      {B8(00000000), B8(00000000), B8(00000010)} // e_WSTRING
  };
  ...
  static const TForteByte DownCast[e_WSTRING - e_BOOL + 1][(e_WSTRING - e_BOOL + 8) / 8] = {
      {B8(00000000), B8(00000000), B8(00000000)}, // e_BOOL to x
      {B8(10000111), B8(10000000), B8(00000000)}, // e_SINT
      {B8(11000111), B8(11000000), B8(00000000)}, // e_INT
      {B8(11100111), B8(11100000), B8(00010000)}, // e_DINT

      {B8(11110111), B8(11110000), B8(00011000)}, // e_LINT
      {B8(11000000), B8(00000000), B8(00000000)}, // e_USINT
      {B8(11100100), B8(01000000), B8(00000000)}, // e_UINT
      {B8(11110110), B8(01100000), B8(00010000)}, // e_UDINT

      {B8(11111111), B8(01110000), B8(00011000)}, // e_ULINT
      {B8(10000000), B8(00000000), B8(00011000)}, // e_BYTE
      {B8(11000100), B8(01000000), B8(00011000)}, // e_WORD
      {B8(11100110), B8(01100000), B8(00001000)}, // e_DWORD
      ...
      {B8(00000000), B8(00000000), B8(00000000)}, // e_TIME

      {B8(00000000), B8(00000000), B8(00000000)}, // e_CHAR
      {B8(00000000), B8(00000000), B8(00000000)}, // e_WCHAR

      {B8(11111111), B8(11100000), B8(00000000)}, // e_REAL
      {B8(11111111), B8(11110000), B8(00010000)}, // e_LREAL
