...
bool CIEC_ANY::isCastable(EDataTypeID pa_eSource, EDataTypeID pa_eDestination, bool &pa_rbUpCast, bool &pa_rbDownCast){
  ...
  static const TForteByte UpCast[e_WSTRING - e_BOOL + 1][(e_WSTRING - e_BOOL + 8) / 8] = {
      {0b11111111, 0b11111000, 0b00011000}, // e_BOOL to x
      {0b01111000, 0b01111000, 0b00011000}, // e_SINT
      {0b00111000, 0b00111000, 0b00011000}, // e_INT
      {0b00011000, 0b00011000, 0b00001000}, // e_DINT

      {0b00001000, 0b00001000, 0b10000000}, // e_LINT
      {0b00111111, 0b11111000, 0b00011000}, // e_USINT
      {0b00011011, 0b10111000, 0b00011000}, // e_UINT
      {0b00001001, 0b10011000, 0b00001000}, // e_UDINT

      {0b00000000, 0b10001000, 0b00000000}, // e_ULINT
      {0b01111111, 0b11111000, 0b00000000}, // e_BYTE
      {0b00111011, 0b10111000, 0b00000000}, // e_WORD
      {0b00011001, 0b10011000, 0b00010000}, // e_DWORD

      {0b00001000, 0b10001000, 0b00011000}, // e_LWORD
      {0b00000000, 0b00000100, 0b00000000}, // e_DATE
      {0b00000000, 0b00000010, 0b00000000}, // e_TIME_OF_DAY
      {0b00000000, 0b00000001, 0b00000000}, // e_DATE_AND_TIME

      {0b00000000, 0b00000000, 0b10000000}, // e_TIME

      {0b00000000, 0b00000000, 0b01000100}, // e_CHAR
      {0b00000000, 0b00000000, 0b00100010}, // e_WCHAR

      {0b00000000, 0b00011000, 0b00011000}, // e_REAL
      {0b00000000, 0b00001000, 0b00001000}, // e_LREAL
      {0b00000000, 0b00000000, 0b00000100}, // e_STRING

      {0b00000000, 0b00000000, 0b00000010} // e_WSTRING
  };
  ...
  static const TForteByte DownCast[e_WSTRING - e_BOOL + 1][(e_WSTRING - e_BOOL + 8) / 8] = {
      {0b00000000, 0b00000000, 0b00000000}, // e_BOOL to x
      {0b10000111, 0b10000000, 0b00000000}, // e_SINT
      {0b11000111, 0b11000000, 0b00000000}, // e_INT
      {0b11100111, 0b11100000, 0b00010000}, // e_DINT

      {0b11110111, 0b11110000, 0b00011000}, // e_LINT
      {0b11000000, 0b00000000, 0b00000000}, // e_USINT
      {0b11100100, 0b01000000, 0b00000000}, // e_UINT
      {0b11110110, 0b01100000, 0b00010000}, // e_UDINT

      {0b11111111, 0b01110000, 0b00011000}, // e_ULINT
      {0b10000000, 0b00000000, 0b00011000}, // e_BYTE
      {0b11000100, 0b01000000, 0b00011000}, // e_WORD
      {0b11100110, 0b01100000, 0b00001000}, // e_DWORD

      {0b11110111, 0b01110000, 0b00000000}, // e_LWORD
      {0b00000000, 0b00000000, 0b00000000}, // e_DATE
      {0b00000000, 0b00000000, 0b00000000}, // e_TIME_OF_DAY
      {0b00000000, 0b00000000, 0b00000000}, // e_DATE_AND_TIME

      {0b00000000, 0b00000000, 0b00000000}, // e_TIME

      {0b00000000, 0b00000000, 0b00000000}, // e_CHAR
      {0b00000000, 0b00000000, 0b00000000}, // e_WCHAR

      {0b11111111, 0b11100000, 0b00000000}, // e_REAL
      {0b11111111, 0b11110000, 0b00010000}, // e_LREAL
      {0b00000000, 0b00000000, 0b00000000}, // e_STRING

      {0b00000000, 0b00000000, 0b00000000} // e_WSTRING
  };
