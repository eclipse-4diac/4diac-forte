...
//   INT_TO_*  functions
//********************************************************************************************
inline const CIEC_BYTE func_INT_TO_BYTE(const CIEC_INT &paVal) {
  return CIEC_ANY::cast<CIEC_BYTE>(paVal);
}

inline const CIEC_DWORD func_INT_TO_DWORD(const CIEC_INT &paVal) {
  return CIEC_ANY::cast<CIEC_DWORD>(paVal);
}

inline const CIEC_DINT func_INT_TO_DINT(const CIEC_INT &paVal) {
  return CIEC_ANY::cast<CIEC_DINT>(paVal);
}

inline const CIEC_LINT func_INT_TO_LINT(const CIEC_INT &paVal){
  return CIEC_ANY::cast<CIEC_LINT>(paVal);
}

inline const CIEC_LREAL func_INT_TO_LREAL(const CIEC_INT &paVal){
  return CIEC_ANY::cast<CIEC_LREAL>(paVal);
}

inline const CIEC_LWORD func_INT_TO_LWORD(const CIEC_INT &paVal){
  return CIEC_ANY::cast<CIEC_LWORD>(paVal);
}

inline const CIEC_REAL func_INT_TO_REAL(const CIEC_INT &paVal){
  return CIEC_ANY::cast<CIEC_REAL>(paVal);
}

inline const CIEC_SINT func_INT_TO_SINT(const CIEC_INT &paVal) {
  return CIEC_ANY::cast<CIEC_SINT>(paVal);
}

inline const CIEC_UDINT func_INT_TO_UDINT(const CIEC_INT &paVal) {
  return CIEC_ANY::cast<CIEC_UDINT>(paVal);
}

inline const CIEC_UINT func_INT_TO_UINT(const CIEC_INT &paVal) {
  return CIEC_ANY::cast<CIEC_UINT>(paVal);
}

inline const CIEC_ULINT func_INT_TO_ULINT(const CIEC_INT &paVal){
  return CIEC_ANY::cast<CIEC_ULINT>(paVal);
}

inline const CIEC_USINT func_INT_TO_USINT(const CIEC_INT &paVal) {
  return CIEC_ANY::cast<CIEC_USINT>(paVal);
}

inline const CIEC_WORD func_INT_TO_WORD(const CIEC_INT &paVal) {
