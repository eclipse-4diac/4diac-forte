...
void CEventConnection::triggerEvent(CEventChainExecutionThreadAbstract &pa_poExecEnv) {
  for(TDestinationIdList::Iterator it = mDestinationIds.begin(); 0 != it.getPosition(); ++it) {
