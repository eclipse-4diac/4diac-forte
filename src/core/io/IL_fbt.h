...
class FORTE_IL final : public forte::core::io::CProcessInterfaceFB {
  ...
  public:
    ...
    void operator()(const CIEC_BOOL &paQI, const CIEC_STRING &paPARAMS, CIEC_BOOL &paQO, CIEC_STRING &paSTATUS, CIEC_LWORD &paIN) {
