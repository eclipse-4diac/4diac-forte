...
namespace forte::core::util {
  ...
  class CSpecReferenceRange {
    public:
      ...
      constexpr CSpecReferenceRange(TCSpecReference paFirst, TCSpecReference paLast) : mFirst(paFirst), mLast(paLast) {
      }
  ...
  class CStringIdListSpecBuilder {
    public:
       ...
       */
      bool isGood() const {
        return getNumStrings() <= cmMaxItems;
      }
  ...
  class CDataSpecBuilderBase {
    public:
       ...
       */
      void setStaticData(const CStringDictionary::TStringId *paStaticDataNames,
                         const CStringDictionary::TStringId *paStaticTypeNames,
                         std::size_t paDataCount) {
       ...
       */
      template<std::size_t N>
      void setStaticData(const std::array<CStringDictionary::TStringId, N> &paStaticDataNames,
                         const std::array<CStringDictionary::TStringId, N> &paStaticTypeNames) {
      ...
      build(CMixedStorage &paStorage) const;
  ...
  class CWithSpecBuilderBase {
    public:
       ...
       */
      void
      setStaticBindings(const TDataIOID *paStaticBindings, const TForteInt16 *paStaticIndexes, std::size_t paNumEvents);
      /**
       * @brief Sets statically defined configuration through std::array.
      ...
      void setStaticBindings(const std::array<TDataIOID, NBindings> &paStaticBindings,
                             const std::array<TForteInt16, NEvents> &paStaticIndexes) {
  ...
  class CWithSpecBuilder : public CWithSpecBuilderBase {
    public:
       ...
       */
      void bindRange(TCSpecEventReference paEventRef,
                     TCSpecDataReference paFirstDataRef,
                     TCSpecDataReference paLastDataRef) {
  ...
  class CAdapterSpecBuilder {
    public:
       ...
       */
      void
      addAdapter(const CStringDictionary::TStringId paName, const CStringDictionary::TStringId paType, bool paIsPlug);
  ...
  class CAdapterDirHelper<CInputSpecTag> : public CAdapterDirHelperBase {
    public:
      constexpr CAdapterDirHelper(CAdapterSpecBuilder &paBuilder) : CAdapterDirHelperBase(paBuilder, false) {
      }
  };
  ...
  class CAdapterDirHelper<COutputSpecTag> : public CAdapterDirHelperBase {
    public:
      constexpr CAdapterDirHelper(CAdapterSpecBuilder &paBuilder) : CAdapterDirHelperBase(paBuilder, true) {
      }
  };
  ...
  class CIfSpecBuilder {
    public:
       ...
       */
      template<class DirTag>
      void bind(CSpecReference<CEventSpecTag, DirTag> paEventRef,
                std::initializer_list<CSpecReference<CDataSpecTag, DirTag>> &&paDataRef) {
       ...
       */
      template<class DirTag>
      void bindRange(CSpecReference<CEventSpecTag, DirTag> paEventRef,
                     CSpecReference<CDataSpecTag, DirTag> paFirstDataRef,
                     CSpecReference<CDataSpecTag, DirTag> paLastDataRef) {
      ...
      template<class DirTag>
      void bindRange(CSpecReference<CEventSpecTag, DirTag> paEventRef,
                     CSpecReferenceRange<CDataSpecTag, DirTag> paDataRefRange) {
