...
class CFunctionBlock {
  public:
     ...
     */
    void receiveInputEvent(size_t paEIID, CEventChainExecutionThreadAbstract &paExecEnv);
  ...
  protected:
    ...
    CEventChainExecutionThreadAbstract *m_poInvokingExecEnv; //!< A pointer to the execution thread that invoked the FB. This value is stored here to reduce function parameters and reduce therefore stack usage.
