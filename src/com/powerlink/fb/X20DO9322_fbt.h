...
class FORTE_X20DO9322 final : public CFunctionBlock, public IEplCNCallback  {
  ...
  public:
    FORTE_X20DO9322(CStringDictionary::TStringId paInstanceNameId, forte::core::CFBContainer &paContainer);
