...
const CStringDictionary::TStringId FORTE_X20DO4649::scmEventInputTypeIds[] = {g_nStringIdEInit, g_nStringIdEvent};
...
const CStringDictionary::TStringId FORTE_X20DO4649::scmEventOutputTypeIds[] = {g_nStringIdEvent, g_nStringIdEvent};
