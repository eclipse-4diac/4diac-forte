...
const CStringDictionary::TStringId FORTE_X20DI9371::scmDataInputNames[] = {
  STRID(QI), STRID(CNID), STRID(MODID)
};
const CStringDictionary::TStringId FORTE_X20DI9371::scmDataInputTypeIds[] = {
  STRID(BOOL), STRID(USINT), STRID(UINT)
};
const CStringDictionary::TStringId FORTE_X20DI9371::scmDataOutputNames[] = {
  STRID(QO), STRID(CNIDO), STRID(STATUS), STRID(DI01), STRID(DI02), STRID(DI03),
  STRID(DI04), STRID(DI05), STRID(DI06), STRID(DI07), STRID(DI08), STRID(DI09),
  STRID(DI10), STRID(DI11), STRID(DI12)
};
const CStringDictionary::TStringId FORTE_X20DI9371::scmDataOutputTypeIds[] = {
  STRID(BOOL), STRID(USINT), STRID(STRING), STRID(BOOL), STRID(BOOL), STRID(BOOL),
