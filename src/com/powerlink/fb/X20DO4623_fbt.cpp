...
const CStringDictionary::TStringId FORTE_X20DO4623::scmDataInputNames[] = {STRID(QI), STRID(CNID), STRID(MODID), STRID(DO01), STRID(DO02), STRID(DO03), STRID(DO04)};
const CStringDictionary::TStringId FORTE_X20DO4623::scmDataInputTypeIds[] = {STRID(BOOL), STRID(USINT), STRID(UINT), STRID(BOOL), STRID(BOOL), STRID(BOOL), STRID(BOOL)};
