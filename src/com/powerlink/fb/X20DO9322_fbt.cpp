...
const CStringDictionary::TStringId FORTE_X20DO9322::scmDataInputNames[] = {
  STRID(QI), STRID(CNID), STRID(MODID), STRID(DO01), STRID(DO02), STRID(DO03),
  STRID(DO04), STRID(DO05), STRID(DO06), STRID(DO07), STRID(DO08), STRID(DO09),
  STRID(DO10), STRID(DO11), STRID(DO12)
};
const CStringDictionary::TStringId FORTE_X20DO9322::scmDataInputTypeIds[] = {
  STRID(BOOL), STRID(USINT), STRID(UINT), STRID(BOOL), STRID(BOOL), STRID(BOOL),
  STRID(BOOL), STRID(BOOL), STRID(BOOL), STRID(BOOL), STRID(BOOL), STRID(BOOL),
  STRID(BOOL), STRID(BOOL), STRID(BOOL)
};
const CStringDictionary::TStringId FORTE_X20DO9322::scmDataOutputNames[] = {
  STRID(QO), STRID(CNIDO), STRID(STATUS)
};
const CStringDictionary::TStringId FORTE_X20DO9322::scmDataOutputTypeIds[] = {
  STRID(BOOL), STRID(USINT), STRID(STRING)
};
