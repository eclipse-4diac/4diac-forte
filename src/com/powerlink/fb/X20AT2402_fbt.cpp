...
namespace {
  ...
  const auto cDataOutputNames = std::array{STRID(QO), STRID(CNIDO), STRID(STATUS), STRID(T01), STRID(T02)};
...
FORTE_X20AT2402::FORTE_X20AT2402(const forte::core::InstanceNameId paInstanceNameId,
