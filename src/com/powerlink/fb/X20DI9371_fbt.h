...
public:
  ...
  void evt_INIT(const CIEC_BOOL &paQI, const CIEC_USINT &paCNID, const CIEC_UINT &paMODID, CIEC_BOOL &paQO,
          CIEC_USINT &paCNIDO, CIEC_STRING &paSTATUS, CIEC_BOOL &paDI01, CIEC_BOOL &paDI02, CIEC_BOOL &paDI03,
          CIEC_BOOL &paDI04, CIEC_BOOL &paDI05, CIEC_BOOL &paDI06, CIEC_BOOL &paDI07, CIEC_BOOL &paDI08,
          CIEC_BOOL &paDI09, CIEC_BOOL &paDI10, CIEC_BOOL &paDI11, CIEC_BOOL &paDI12) {
    var_QI = paQI;
    var_CNID = paCNID;
    var_MODID = paMODID;
  ...
  void evt_REQ(const CIEC_BOOL &paQI, const CIEC_USINT &paCNID, const CIEC_UINT &paMODID, CIEC_BOOL &paQO,
         CIEC_USINT &paCNIDO, CIEC_STRING &paSTATUS, CIEC_BOOL &paDI01, CIEC_BOOL &paDI02, CIEC_BOOL &paDI03,
         CIEC_BOOL &paDI04, CIEC_BOOL &paDI05, CIEC_BOOL &paDI06, CIEC_BOOL &paDI07, CIEC_BOOL &paDI08,
         CIEC_BOOL &paDI09, CIEC_BOOL &paDI10, CIEC_BOOL &paDI11, CIEC_BOOL &paDI12) {
    var_QI = paQI;
  ...
  void operator()(const CIEC_BOOL &paQI, const CIEC_USINT &paCNID, const CIEC_UINT &paMODID, CIEC_BOOL &paQO,
          CIEC_USINT &paCNIDO, CIEC_STRING &paSTATUS, CIEC_BOOL &paDI01, CIEC_BOOL &paDI02, CIEC_BOOL &paDI03,
          CIEC_BOOL &paDI04, CIEC_BOOL &paDI05, CIEC_BOOL &paDI06, CIEC_BOOL &paDI07, CIEC_BOOL &paDI08,
          CIEC_BOOL &paDI09, CIEC_BOOL &paDI10, CIEC_BOOL &paDI11, CIEC_BOOL &paDI12) {
