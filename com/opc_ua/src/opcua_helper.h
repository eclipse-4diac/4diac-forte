  ...
  namespace com_infra::opc_ua {
    class COPC_UA_Helper {
      public:
        ...
        /**
         * Allocated a UA_QualifiedName from a nodename which can have a semicolon to define the namespace. If no
         * semicolon is found the passed deafult namespace is used
      ...
      private:
        ...
        /**
         * Class that encapsulates, for each 61131-3 type, the map to the OPC UA type, and a transform to and from
         * functions
         */
        class UA_TypeConvert {
          public:
            UA_TypeConvert(const UA_DataType *paType,
                           convertFromIECToOPCUA paToOPCUA,
                           convertFromOPCUAToIEC paFromOPCUA) :
                mType(paType),
                mToOPCUA(paToOPCUA),
