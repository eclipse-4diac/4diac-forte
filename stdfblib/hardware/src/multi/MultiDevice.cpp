...
int MultiDevice::resetControlledDevice() {
  ...
  forte::hardware::multi::utils::setFactoriesSettings(forte::hardware::multi::utils::FactoriesSettings());
  ...
  if (auto opcuaMgr = forte::hardware::multi::utils::getOpcuaMgr(*mControlledDevice); opcuaMgr != nullptr) {
    mOpcuaMgr = opcuaMgr;
  } else {
