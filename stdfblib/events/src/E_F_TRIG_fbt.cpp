...
#include "forte/iec61499/events/E_F_TRIG_fbt.h"
...
FORTE_E_F_TRIG::FORTE_E_F_TRIG(const forte::core::StringId paInstanceNameId, forte::core::CFBContainer &paContainer) :
