...
DEFINE_FIRMWARE_FB(FORTE_E_T_FF_SR, "E_T_FF_SR"_STRID)
...
FORTE_E_T_FF_SR::FORTE_E_T_FF_SR(const forte::core::StringId paInstanceNameId, forte::core::CFBContainer &paContainer) :
