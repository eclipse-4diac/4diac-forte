...
namespace forte::iec61499::events::timers {
  namespace {
    ...
    const auto cEventConnections = std::to_array<SCFB_FBConnectionData>({
        ...
        {"CheckRunning"_STRID, "EO"_STRID, "E_DELAY"_STRID, "START"_STRID},
        {"CheckRunning"_STRID, "EO"_STRID, "E_RS"_STRID, "S"_STRID},
    ...
    const auto cDataConnections = std::to_array<SCFB_FBConnectionData>({
        ...
        {"E_RS"_STRID, ep_Q__NOT, "CheckRunning"_STRID, "PERMIT"_STRID},
    });
  ...
  void FORTE_E_PULSE::writeOutputData(const TEventID paEIID) {
    switch (paEIID) {
      case scmEventCNFID: {
        writeData(1, fb_E_RS->conn_Q.getValue(), conn_Q);
        break;
      }
      default: break;
    }
