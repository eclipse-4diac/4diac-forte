...
namespace forte::iec61499::events::timers {
  class FORTE_E_PULSE_RETRIG final : public CCompositeFB {
      DECLARE_FIRMWARE_FB(FORTE_E_PULSE_RETRIG)
    ...
    public:
      FORTE_E_PULSE_RETRIG(StringId paInstanceNameId, CFBContainer &paContainer);
