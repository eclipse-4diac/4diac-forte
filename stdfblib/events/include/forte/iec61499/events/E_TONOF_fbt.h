...
namespace forte::iec61499::events {
  class FORTE_E_TONOF final : public CCompositeFB {
    ...
    private:
      ...
      forte::CInternalFB<FORTE_E_DELAY> fb_E_DELAY_ON;
      forte::CInternalFB<FORTE_E_RS> fb_E_RS;
      forte::CInternalFB<FORTE_E_DELAY> fb_E_DELAY_OFF;
    ...
    public:
      FORTE_E_TONOF(forte::StringId paInstanceNameId, forte::CFBContainer &paContainer);
