...
/* DatatypeTest */
static UA_INLINE void UA_DatatypeTest_init(UA_DatatypeTest *p) {
  memset(p, 0, sizeof(UA_DatatypeTest));
}

static UA_INLINE UA_DatatypeTest *UA_DatatypeTest_new(void) {
  return (UA_DatatypeTest *) UA_new(&UA_UA_TYPES_FORDIACNAMESPACE[UA_UA_TYPES_FORDIACNAMESPACE_DATATYPETEST]);
}

static UA_INLINE UA_StatusCode UA_DatatypeTest_copy(const UA_DatatypeTest *src, UA_DatatypeTest *dst) {
  return UA_copy(src, dst, &UA_UA_TYPES_FORDIACNAMESPACE[UA_UA_TYPES_FORDIACNAMESPACE_DATATYPETEST]);
}

UA_DEPRECATED static UA_INLINE void UA_DatatypeTest_clear(UA_DatatypeTest *p) {
  UA_clear(p, &UA_UA_TYPES_FORDIACNAMESPACE[UA_UA_TYPES_FORDIACNAMESPACE_DATATYPETEST]);
}

static UA_INLINE void UA_DatatypeTest_clear(UA_DatatypeTest *p) {
  UA_clear(p, &UA_UA_TYPES_FORDIACNAMESPACE[UA_UA_TYPES_FORDIACNAMESPACE_DATATYPETEST]);
}

static UA_INLINE void UA_DatatypeTest_delete(UA_DatatypeTest *p) {
