...
UA_DatatypeTest_encodeBinary(const UA_DatatypeTest *src, UA_Byte **bufPos, const UA_Byte *bufEnd) {
    return UA_encodeBinary(src, &UA_UA_TYPES_FORDIACNAMESPACE[UA_UA_TYPES_FORDIACNAMESPACE_DATATYPETEST], bufPos, &bufEnd, NULL, NULL);
}
static UA_INLINE UA_StatusCode
UA_DatatypeTest_decodeBinary(const UA_ByteString *src, size_t *offset, UA_DatatypeTest *dst) {
    return UA_decodeBinary(src, offset, dst, &UA_UA_TYPES_FORDIACNAMESPACE[UA_UA_TYPES_FORDIACNAMESPACE_DATATYPETEST], NULL);
}
