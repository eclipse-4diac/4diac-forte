...
namespace forte::com_infra::test {
  ...
  const TForteByte cgWStringHalloWorld[23] = {0x55, 0, 0xA, 0, 'H', 0, 'a', 0, 'l', 0, 'l', 0,
                                              'o',  0, 'W', 0, 'o', 0, 'r', 0, 'l', 0, 'd'};
  ...
  const TForteByte cgArrayStringEmptyHalloWorld[] = {0x76, 0x00, 0x02, 0x50, 0,   0,   0,   0xA, 'H',
                                                     'a',  'l',  'l',  'o',  'W', 'o', 'r', 'l', 'd'};
} // namespace forte::com_infra::test
