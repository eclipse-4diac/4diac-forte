...
namespace forte::test {
  ...
  BOOST_AUTO_TEST_CASE(is_valid_bcd_LWORD) {
    ...
    for (size_t i = 0; i < valueTypeSize; ++i) {
      const size_t bitShift = i * 8;
      test = TestType(0x00UL << bitShift);
      BOOST_TEST(static_cast<CIEC_BOOL::TValueType>(func_IS_VALID_BCD(test)) == true);
      test = TestType(0x01UL << bitShift);
      BOOST_TEST(static_cast<CIEC_BOOL::TValueType>(func_IS_VALID_BCD(test)) == true);
      test = TestType(0x02UL << bitShift);
      BOOST_TEST(static_cast<CIEC_BOOL::TValueType>(func_IS_VALID_BCD(test)) == true);
      test = TestType(0x03UL << bitShift);
      BOOST_TEST(static_cast<CIEC_BOOL::TValueType>(func_IS_VALID_BCD(test)) == true);
      test = TestType(0x04UL << bitShift);
      BOOST_TEST(static_cast<CIEC_BOOL::TValueType>(func_IS_VALID_BCD(test)) == true);
      test = TestType(0x05UL << bitShift);
      BOOST_TEST(static_cast<CIEC_BOOL::TValueType>(func_IS_VALID_BCD(test)) == true);
      test = TestType(0x06UL << bitShift);
      BOOST_TEST(static_cast<CIEC_BOOL::TValueType>(func_IS_VALID_BCD(test)) == true);
      test = TestType(0x07UL << bitShift);
      BOOST_TEST(static_cast<CIEC_BOOL::TValueType>(func_IS_VALID_BCD(test)) == true);
      test = TestType(0x08UL << bitShift);
      BOOST_TEST(static_cast<CIEC_BOOL::TValueType>(func_IS_VALID_BCD(test)) == true);
      test = TestType(0x09UL << bitShift);
      BOOST_TEST(static_cast<CIEC_BOOL::TValueType>(func_IS_VALID_BCD(test)) == true);
      test = TestType(0x0AUL << bitShift);
      BOOST_TEST(static_cast<CIEC_BOOL::TValueType>(func_IS_VALID_BCD(test)) == false);
      test = TestType(0x0BUL << bitShift);
      BOOST_TEST(static_cast<CIEC_BOOL::TValueType>(func_IS_VALID_BCD(test)) == false);
      test = TestType(0x0CUL << bitShift);
      BOOST_TEST(static_cast<CIEC_BOOL::TValueType>(func_IS_VALID_BCD(test)) == false);
      test = TestType(0x0DUL << bitShift);
      BOOST_TEST(static_cast<CIEC_BOOL::TValueType>(func_IS_VALID_BCD(test)) == false);
      test = TestType(0x0EUL << bitShift);
      BOOST_TEST(static_cast<CIEC_BOOL::TValueType>(func_IS_VALID_BCD(test)) == false);
      test = TestType(0x0FUL << bitShift);
      BOOST_TEST(static_cast<CIEC_BOOL::TValueType>(func_IS_VALID_BCD(test)) == false);
      test = TestType(0x00UL << bitShift);
      BOOST_TEST(static_cast<CIEC_BOOL::TValueType>(func_IS_VALID_BCD(test)) == true);
      test = TestType(0x10UL << bitShift);
      BOOST_TEST(static_cast<CIEC_BOOL::TValueType>(func_IS_VALID_BCD(test)) == true);
      test = TestType(0x20UL << bitShift);
      BOOST_TEST(static_cast<CIEC_BOOL::TValueType>(func_IS_VALID_BCD(test)) == true);
      test = TestType(0x30UL << bitShift);
      BOOST_TEST(static_cast<CIEC_BOOL::TValueType>(func_IS_VALID_BCD(test)) == true);
      test = TestType(0x40UL << bitShift);
      BOOST_TEST(static_cast<CIEC_BOOL::TValueType>(func_IS_VALID_BCD(test)) == true);
      test = TestType(0x50UL << bitShift);
      BOOST_TEST(static_cast<CIEC_BOOL::TValueType>(func_IS_VALID_BCD(test)) == true);
      test = TestType(0x60UL << bitShift);
      BOOST_TEST(static_cast<CIEC_BOOL::TValueType>(func_IS_VALID_BCD(test)) == true);
      test = TestType(0x70UL << bitShift);
      BOOST_TEST(static_cast<CIEC_BOOL::TValueType>(func_IS_VALID_BCD(test)) == true);
      test = TestType(0x80UL << bitShift);
      BOOST_TEST(static_cast<CIEC_BOOL::TValueType>(func_IS_VALID_BCD(test)) == true);
      test = TestType(0x90UL << bitShift);
      BOOST_TEST(static_cast<CIEC_BOOL::TValueType>(func_IS_VALID_BCD(test)) == true);
      test = TestType(0xA0UL << bitShift);
      BOOST_TEST(static_cast<CIEC_BOOL::TValueType>(func_IS_VALID_BCD(test)) == false);
      test = TestType(0xB0UL << bitShift);
      BOOST_TEST(static_cast<CIEC_BOOL::TValueType>(func_IS_VALID_BCD(test)) == false);
      test = TestType(0xC0UL << bitShift);
      BOOST_TEST(static_cast<CIEC_BOOL::TValueType>(func_IS_VALID_BCD(test)) == false);
      test = TestType(0xD0UL << bitShift);
      BOOST_TEST(static_cast<CIEC_BOOL::TValueType>(func_IS_VALID_BCD(test)) == false);
      test = TestType(0xE0UL << bitShift);
      BOOST_TEST(static_cast<CIEC_BOOL::TValueType>(func_IS_VALID_BCD(test)) == false);
      test = TestType(0xF0UL << bitShift);
      BOOST_TEST(static_cast<CIEC_BOOL::TValueType>(func_IS_VALID_BCD(test)) == false);
    }
  }
  ...
  BOOST_AUTO_TEST_CASE(func_min_variadic_4) {
    // cast to int for better readability in test result output
    BOOST_TEST(static_cast<int>(static_cast<CIEC_SINT::TValueType>(func_MIN(0_SINT, -10_SINT, 50_SINT, 35_SINT))) ==
               -10);
  }
  ...
  BOOST_AUTO_TEST_CASE(func_max_variadic_4) {
    // cast to int for better readability in test result output
    BOOST_TEST(static_cast<int>(static_cast<CIEC_SINT::TValueType>(func_MAX(0_SINT, -10_SINT, 50_SINT, 35_SINT))) ==
               50);
  }
