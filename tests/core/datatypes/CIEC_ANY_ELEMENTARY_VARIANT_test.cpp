...
#include "../../../src/core/datatypes/forte_any_elementary_variant.h"

BOOST_AUTO_TEST_SUITE(CIEC_ANY_ELEMENTARY_VARIANT_function_test)

    BOOST_AUTO_TEST_CASE(Type_test) {
      CIEC_ANY_ELEMENTARY_VARIANT test;
    ...
    void checkStringConversion(CIEC_ANY_ELEMENTARY_VARIANT &paValue, const char *paString, CIEC_ANY::EDataTypeID paDataTypeId) {
      char buf[50];
