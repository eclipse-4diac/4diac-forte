...
#include "../../../src/core/datatypes/forte_any_char_variant.h"

BOOST_AUTO_TEST_SUITE(CIEC_ANY_CHAR_VARIANT_function_test)

    BOOST_AUTO_TEST_CASE(Type_test) {
      CIEC_ANY_CHAR_VARIANT test;
    ...
    BOOST_AUTO_TEST_CASE(Initialization_test) {
      // assign value
      CIEC_ANY_CHAR_VARIANT test1 = 'a'_CHAR;
    ...
    void checkStringConversion(CIEC_ANY_CHAR_VARIANT &paValue, const char *paString, CIEC_ANY::EDataTypeID paDataTypeId) {
      char buf[50];
