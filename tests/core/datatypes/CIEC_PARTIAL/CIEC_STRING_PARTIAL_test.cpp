...
BOOST_AUTO_TEST_CASE(PARTIAL_ACCESS_STRING_READ_AND_WRITE) {
  CIEC_STRING testString("4diac IDE"_STRING);
  testString[7] = testString[3];
  BOOST_TEST("4diac iDE"_STRING == testString);
}
