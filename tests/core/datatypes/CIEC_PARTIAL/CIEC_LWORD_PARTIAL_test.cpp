...
BOOST_AUTO_TEST_CASE(PARTIAL_COPY_PARTIAL_BYTE_TO_SAME_PARTIAL_BYTE) {
  ...
  nLWord.partial<CIEC_BYTE>(CIEC_SINT(0)) = CIEC_BYTE(
          static_cast<CIEC_BYTE::TValueType>(nLWord.cpartial<CIEC_BYTE>(CIEC_SINT(0))) | 0x01);
...
BOOST_AUTO_TEST_CASE(PARTIAL_COPY_PARTIAL_WORD_TO_SAME_PARTIAL_WORD) {
  CIEC_LWORD nLWord(0xABCDEFABCDEF00FEU);
  nLWord.partial<CIEC_WORD>(CIEC_SINT(0)) = CIEC_WORD(
          static_cast<CIEC_WORD::TValueType>(nLWord.cpartial<CIEC_WORD>(CIEC_SINT(0))) | 0x1001);
...
BOOST_AUTO_TEST_CASE(PARTIAL_COPY_PARTIAL_DWORD_TO_SAME_PARTIAL_DWORD) {
  CIEC_LWORD nLWord(0xABCDEFABCDEF00FEU);
  nLWord.partial<CIEC_DWORD>(CIEC_SINT(0)) = CIEC_DWORD(
          static_cast<CIEC_DWORD::TValueType>(nLWord.cpartial<CIEC_DWORD>(CIEC_SINT(0))) | 0x1001);
  BOOST_TEST(static_cast<CIEC_LWORD::TValueType>(nLWord) == 0xABCDEFABCDEF10FFU);
}
