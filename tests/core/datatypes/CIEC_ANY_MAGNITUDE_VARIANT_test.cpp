...
BOOST_AUTO_TEST_SUITE(CIEC_ANY_MAGNITUDE_VARIANT_function_test)
    ...
    BOOST_AUTO_TEST_CASE(Type_test) {
      CIEC_ANY_MAGNITUDE_VARIANT test;
    ...
    void checkStringConversion(CIEC_ANY_MAGNITUDE_VARIANT &paValue, const char *paString, CIEC_ANY::EDataTypeID paDataTypeId) {
      char buf[50];
