...
void checkTestStruct_InitialValues(CIEC_TestStruct &paStruct){
  ...
  BOOST_CHECK_EQUAL(0, static_cast<CIEC_TIME::TValueType>(*static_cast<CIEC_TIME *>(paStruct.getMemberNamed(STRID(Val3)))));
}
...
void checkTestStruct_TestDataSet1(CIEC_TestStruct &paStruct){
  ...
  BOOST_CHECK_EQUAL(44, static_cast<CIEC_INT::TValueType>(*static_cast<CIEC_INT *>(paStruct.getMemberNamed(STRID(Val2)))));
  BOOST_CHECK_EQUAL(10, static_cast<CIEC_TIME::TValueType>(*static_cast<CIEC_TIME *>(paStruct.getMemberNamed(STRID(Val3)))));
}
...
BOOST_AUTO_TEST_CASE(TimeStruct_element_access_test){ 
  ...
  BOOST_CHECK_EQUAL(55, static_cast<CIEC_INT::TValueType>(*static_cast<CIEC_INT *>(stStruct.getMemberNamed(STRID(Val2)))));
  BOOST_CHECK_EQUAL(12, static_cast<CIEC_TIME::TValueType>(*static_cast<CIEC_TIME *>(stStruct.getMemberNamed(STRID(Val3)))));
}
...
BOOST_AUTO_TEST_CASE(TimeStruct_TIME_parser_test) {
  ...
  BOOST_CHECK_EQUAL(0, static_cast<CIEC_INT::TValueType>(*static_cast<CIEC_INT *>(stStruct.getMemberNamed(STRID(Val2)))));
  BOOST_CHECK_EQUAL(33000000, static_cast<CIEC_TIME::TValueType>(*static_cast<CIEC_TIME *>(stStruct.getMemberNamed(STRID(Val3)))));

  timeVar.fromString("TIME#44h36m");
  (*static_cast<CIEC_TIME *>(stStruct.getMemberNamed(STRID(Val3)))) = timeVar;
  BOOST_CHECK_EQUAL(false, (*static_cast<CIEC_BOOL *>(stStruct.getMemberNamed(STRID(Val1)))));
  BOOST_CHECK_EQUAL(0, static_cast<CIEC_INT::TValueType>(*static_cast<CIEC_INT *>(stStruct.getMemberNamed(STRID(Val2)))));
  BOOST_CHECK_EQUAL(160560000000000, static_cast<CIEC_TIME::TValueType>(*static_cast<CIEC_TIME *>(stStruct.getMemberNamed(STRID(Val3)))));
...
void checkArrayOfStructTest_TestDataSet1(CIEC_TestStruct &paStruct) {
  BOOST_CHECK_EQUAL(true, (*static_cast<CIEC_BOOL *>(paStruct.getMemberNamed(STRID(Val1)))));
  BOOST_CHECK_EQUAL(33, static_cast<CIEC_INT::TValueType>(*static_cast<CIEC_INT *>(paStruct.getMemberNamed(STRID(Val2)))));
  BOOST_CHECK_EQUAL(22, static_cast<CIEC_TIME::TValueType>(*static_cast<CIEC_TIME *>(paStruct.getMemberNamed(STRID(Val3)))));
}
...
BOOST_AUTO_TEST_CASE(arrayOfStructs_access_test) {
  ...
  BOOST_CHECK_EQUAL(static_cast<CIEC_STRUCT &>(nTest[0]).getMemberNamed(STRID(Val1))->getDataTypeID(), CIEC_ANY::e_BOOL);
  BOOST_CHECK_EQUAL(static_cast<CIEC_STRUCT &>(nTest[0]).getMemberNamed(STRID(Val2))->getDataTypeID(), CIEC_ANY::e_INT);
  BOOST_CHECK_EQUAL(static_cast<CIEC_STRUCT &>(nTest[0]).getMemberNamed(STRID(Val3))->getDataTypeID(), CIEC_ANY::e_TIME);
...
BOOST_AUTO_TEST_CASE(arrayOfStructs_TIME_parser_test) {
  ...
  for(size_t i = 0; i < 3; i++) { 
    ...
    BOOST_CHECK_EQUAL(33000000, static_cast<CIEC_TIME::TValueType>(*static_cast<CIEC_TIME *>(static_cast<CIEC_STRUCT &>(nTest[0]).getMemberNamed(STRID(Val3)))));
  }

  timeVar.fromString("TIME#44h36m");
  for(size_t i = 0; i < 3; i++) { 
    (*static_cast<CIEC_TIME *>(static_cast<CIEC_STRUCT &>(nTest[0]).getMemberNamed(STRID(Val3)))) = timeVar;
    BOOST_CHECK_EQUAL(160560000000000, static_cast<CIEC_TIME::TValueType>(*static_cast<CIEC_TIME *>(static_cast<CIEC_STRUCT &>(nTest[0]).getMemberNamed(STRID(Val3)))));
  }
