...
namespace forte::arch::test {
  ...
  BOOST_AUTO_TEST_CASE(wstringToString) {
    ...
    const std::string testString =
        "4diac 4 \xe3\x81\xaf\xe4\xbb\x8a\xe3\x81\xbe\xe3\x81\xa7\xef\xbc\x81"; // u8"4diac 4 は今まで！"
    const std::wstring resultString =
        L"4diac 4 \xe3\x81\xaf\xe4\xbb\x8a\xe3\x81\xbe\xe3\x81\xa7\xef\xbc\x81"; // L"4diac 4 は今まで！"
#else
