...
struct F_TIME_IN_NS_TO_LINT_TestFixture : public CFBTestFixtureBase {
    ...
    F_TIME_IN_NS_TO_LINT_TestFixture() : CFBTestFixtureBase(STRID(F_TIME_IN_NS_TO_LINT)) {
...
BOOST_AUTO_TEST_CASE(timeConversion) {
  ...
  BOOST_CHECK_EQUAL(INT64_C(172800000000000) + INT64_C(18000000000000) + INT64_C(2580000000000) + INT64_C(12000000000) +
