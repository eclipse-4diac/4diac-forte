...
namespace forte::iec61131::arithmetic {
  struct F_TIME_IN_NS_TO_LINT_TestFixture : public forte::test::CFBTestFixtureBase {
  ...
  BOOST_AUTO_TEST_CASE(timeConversion) {
    ...
    BOOST_CHECK_EQUAL(INT64_C(172800000000000) + INT64_C(18000000000000) + INT64_C(2580000000000) +
                          INT64_C(12000000000) + INT64_C(44000000) + INT64_C(27000) + INT64_C(31),
                      static_cast<CIEC_LINT::TValueType>(mOut_F_TIME_IN_NS_TO_LINT));
  }
