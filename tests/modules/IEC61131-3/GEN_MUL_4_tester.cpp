...
namespace forte::iec61131::arithmetic {
  struct GEN_MUL_4_TestFixture : public test::CFBTestFixtureBase {
      static constexpr TEventID REQ = 0;
      static constexpr TEventID CNF = 0;

      GEN_MUL_4_TestFixture() : CFBTestFixtureBase("iec61131::arithmetic::MUL_4"_STRID) {
  ...
  BOOST_FIXTURE_TEST_SUITE(GenMul4Tests, GEN_MUL_4_TestFixture)
