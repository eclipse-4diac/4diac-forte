...
struct F_TIME_IN_MS_TO_LREAL_TestFixture : public CFBTestFixtureBase {
    ...
    F_TIME_IN_MS_TO_LREAL_TestFixture() : CFBTestFixtureBase(STRID(F_TIME_IN_MS_TO_LREAL)) {
...
BOOST_AUTO_TEST_CASE(timeConversion) {
  ...
  BOOST_CHECK_EQUAL(static_cast<CIEC_LREAL::TValueType>(INT64_C(172800000000000) + INT64_C(18000000000000) +
                                                        INT64_C(2580000000000) + INT64_C(12000000000) +
                                                        INT64_C(44000000) + INT64_C(27000) + INT64_C(31)) /
                        static_cast<CIEC_LREAL::TValueType>(1E6),
                    static_cast<CIEC_LREAL::TValueType>(mOut_F_TIME_IN_MS_TO_LREAL));
}
