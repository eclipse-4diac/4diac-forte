...
namespace forte::iec61131::arithmetic {
  struct GEN_ADD_3_TestFixture : public test::CFBTestFixtureBase {
      static constexpr TEventID REQ = 0;
      static constexpr TEventID CNF = 0;

      GEN_ADD_3_TestFixture() : CFBTestFixtureBase("iec61131::arithmetic::ADD_3"_STRID) {
  ...
  BOOST_FIXTURE_TEST_SUITE(GenAdd3Tests, GEN_ADD_3_TestFixture)
