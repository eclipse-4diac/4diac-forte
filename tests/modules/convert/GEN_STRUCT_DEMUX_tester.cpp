...
USE_STRING_ID(STRUCT_DEMUX_1REAL);
USE_STRING_ID(STRUCT_DEMUX_1STRING);
USE_STRING_ID(STRUCT_DEMUX_1Struct_Muxer_Test_Struct_1);
USE_STRING_ID(STRUCT_DEMUX_1Struct_Muxer_Test_Struct_2);
USE_STRING_ID(STRUCT_DEMUX_1Struct_Muxer_Test_Struct_3);
USE_STRING_ID(STRUCT_DEMUX_1Struct_Muxer_Test_Struct_4);
USE_STRING_ID(STRUCT_DEMUX_1Struct_Muxer_Test_Struct_5);
USE_STRING_ID(STRUCT_DEMUX_1UnknownType);
...
struct STRUCT_DEMUX_TestFixture_1 : public CFBTestFixtureBase{
    ...
    STRUCT_DEMUX_TestFixture_1() : CFBTestFixtureBase(STRID(STRUCT_DEMUX_1Struct_Muxer_Test_Struct_1)){
      setInputData({&mIn});
...
struct STRUCT_DEMUX_TestFixture_2 : public CFBTestFixtureBase{
    ...
    STRUCT_DEMUX_TestFixture_2() : CFBTestFixtureBase(STRID(STRUCT_DEMUX_1Struct_Muxer_Test_Struct_2)){
      setInputData({&mIn});
      setOutputData({&mVar1, &mVar2, &mVar3});
      CFBTestFixtureBase::setup();
    }
...
BOOST_AUTO_TEST_SUITE(STRUCT_DEMUX_FailedCreationTest)
  ...
  BOOST_AUTO_TEST_CASE(missingDataType){
    CFunctionBlock *fb = CTypeLib::createFB(STRID(InstanceName), STRID(STRUCT_DEMUX_1UnknownType), CFBContainerMock::smDefaultFBContMock);
    BOOST_CHECK(nullptr == fb);
  }

  BOOST_AUTO_TEST_CASE(wrongDataType){
    CFunctionBlock *fb = CTypeLib::createFB(STRID(InstanceName), STRID(STRUCT_DEMUX_1STRING), CFBContainerMock::smDefaultFBContMock);
    BOOST_CHECK(nullptr == fb);

    fb = CTypeLib::createFB(STRID(InstanceName), STRID(STRUCT_DEMUX_1REAL), CFBContainerMock::smDefaultFBContMock);
    BOOST_CHECK(nullptr == fb);
  }

BOOST_AUTO_TEST_CASE(emptyStruct) {
CFunctionBlock *fb = CTypeLib::createFB(STRID(InstanceName), STRID(STRUCT_DEMUX_1Struct_Muxer_Test_Struct_3), CFBContainerMock::smDefaultFBContMock);
BOOST_CHECK(nullptr == fb);
}

BOOST_AUTO_TEST_CASE(bigStruct) {
CFunctionBlock *fb = CTypeLib::createFB(STRID(InstanceName), STRID(STRUCT_DEMUX_1Struct_Muxer_Test_Struct_4), CFBContainerMock::smDefaultFBContMock);
BOOST_CHECK(nullptr != fb);
delete fb;
}
...
struct STRUCT_DEMUX_TestFixture_5 : public CFBTestFixtureBase {
  ...
  STRUCT_DEMUX_TestFixture_5() : CFBTestFixtureBase(STRID(STRUCT_DEMUX_1Struct_Muxer_Test_Struct_5)) {
    setInputData({&mIn});
    setOutputData({&mVar1, &mVar2, &mVar3});
    CFBTestFixtureBase::setup();
  }
