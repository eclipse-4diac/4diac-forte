...
BOOST_AUTO_TEST_CASE(missingDataType) {
  CFunctionBlock *fb = forte::createFB("InstanceName"_STRID, "eclipse4diac::convert::STRUCT_MUX_1UnknownType"_STRID,
                                       CFBContainerMock::smDefaultFBContMock);
  BOOST_CHECK(nullptr == fb);
}

BOOST_AUTO_TEST_CASE(wrongDataType) {
  CFunctionBlock *fb = forte::createFB("InstanceName"_STRID, "eclipse4diac::convert::STRUCT_MUX_1STRING"_STRID,
                                       CFBContainerMock::smDefaultFBContMock);
  BOOST_CHECK(nullptr == fb);

  fb = forte::createFB("InstanceName"_STRID, "eclipse4diac::convert::STRUCT_MUX_1REAL"_STRID,
                       CFBContainerMock::smDefaultFBContMock);
  BOOST_CHECK(nullptr == fb);
}
...
BOOST_AUTO_TEST_CASE(emptyStruct) {
  CFunctionBlock *fb =
      forte::createFB("InstanceName"_STRID, "eclipse4diac::convert::STRUCT_MUX_1Struct_Muxer_Test_Struct_3"_STRID,
                      CFBContainerMock::smDefaultFBContMock);
  BOOST_CHECK(nullptr == fb);
}
...
BOOST_AUTO_TEST_CASE(bigStruct) {
  CFunctionBlock *fb =
      forte::createFB("InstanceName"_STRID, "eclipse4diac::convert::STRUCT_MUX_1Struct_Muxer_Test_Struct_4"_STRID,
                      CFBContainerMock::smDefaultFBContMock);
  BOOST_CHECK(nullptr != fb);
  delete fb;
}
