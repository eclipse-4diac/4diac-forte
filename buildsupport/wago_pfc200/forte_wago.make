...
FORTE_WAGO_CONF_OPT  := $(CROSS_CMAKE_USR) -DFORTE_COM_ETH:BOOL=ON -DFORTE_COM_LOCAL:BOOL=ON  -DFORTE_ARCHITECTURE:STRING=Posix -DFORTE_MODULE_CONVERT:BOOL=ON -DFORTE_TRACE_EVENTS:BOOL=OFF -DFORTE_MODULE_WagoKbus=ON
#
# ----------------------------------------------------------------------------
# Target-Install
# ----------------------------------------------------------------------------
