...
FOREACH(FBLIB_FILE ${FBLIB_STRUCT})  
  IF(NOT EXISTS ${FBLIB_FILE})
    CONTINUE()
  ENDIF()
  FILE(READ ${FBLIB_FILE} FILE_STRING)
  STRING(REGEX MATCHALL  "USE_STRING_ID\\(([A-Za-z0-9_]*)" REGEX_STRINGS ${FILE_STRING})
  STRING(REGEX MATCHALL  "USE_STRING_ID\\(([0-9][A-Za-z0-9_]*)" REGEX_STRINGS_ERROR ${FILE_STRING})

  FOREACH(STR ${REGEX_STRINGS})
    string(SUBSTRING ${STR} 14 -1 OUTSTR)
