...
namespace forte {
  DEFINE_FIRMWARE_DATATYPE(ANY_INT_VARIANT, "ANY_INT"_STRID)
  ...
  bool CIEC_ANY_INT_VARIANT::setDefaultValue(EDataTypeID paDataTypeId) {
    switch (paDataTypeId) {
  ...
  void CIEC_ANY_INT_VARIANT::toString(std::string &paTargetBuf) const {
