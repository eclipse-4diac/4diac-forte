...
namespace forte {
  ...
  class CIEC_ULINT final : public CIEC_ANY_UNSIGNED {
    ...
    public:
      ...
      template<
          typename T,
          std::enable_if_t<std::is_same_v<typename forte::mpl::implicit_cast_t<T, CIEC_ULINT>, CIEC_ULINT>, int> = 0>
...
namespace std {
  template<>
  struct numeric_limits<forte::CIEC_ULINT> : public forte::templates::numeric_limits<forte::CIEC_ULINT> {
