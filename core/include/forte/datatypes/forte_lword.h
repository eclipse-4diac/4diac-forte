...
namespace forte {
  ...
  class CIEC_LWORD : public CIEC_ANY_BIT {
    ...
    public:
      ...
      void setValue(const CIEC_ANY &paValue) override final;

      void setValue(const CIEC_REAL &paValue) override final;

      void setValue(const CIEC_LREAL &paValue) override final;
...
namespace std {
  template<>
  struct numeric_limits<forte::CIEC_LWORD> : public forte::templates::numeric_limits<forte::CIEC_LWORD> {
