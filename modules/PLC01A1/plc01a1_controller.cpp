...
namespace forte::eclipse4diac::io::plc01a1 {
  ...
  namespace {
    const char *const scmSPIInputDevice = "/dev/spidev0.0";
    const char *const scmSPIOutputDevice = "/dev/spidev0.1";

    const char *const scmFailedToOpenInputControlFile = "Failed to open input control file";
    const char *const scmFailedToOpenOutputControlFile = "Failed to open output control file";

    const char *const scmFailedToSetInputMode = "Failed to set input mode";
    const char *const scmFailedToSetOutputMode = "Failed to set output mode";

    const char *const scmFailedToSetInputBits = "Failed to set input bits";
    const char *const scmFailedToSetOutputBits = "Failed to set output bits";

    const char *const scmFailedToSetInputSpeed = "Failed to set input speed";
    const char *const scmFailedToSetOutputSpeed = "Failed to set output speed";

    const uint32_t scmSPIMode = 0;

    const uint8_t scmSPIBits = 8;
    const uint32_t scmSPIInputMaxSpeed = 6250000; // 6.25 MHz
    const uint32_t scmSPIOutputMaxSpeed = 5000000; // 5 MHz
  } // namespace

  PLC01A1Controller::PLC01A1Controller(CDeviceExecution &paDeviceExecution) :
      IODevicePollController(paDeviceExecution, 25),
      mSPIInputFd(0),
      mSPIOutputFd(0) {
  ...
  void PLC01A1Controller::setConfig(struct IODeviceController::Config *paConfig) {
  ...
  forte::io::IOHandle *PLC01A1Controller::createIOHandle(IODeviceController::HandleDescriptor &paHandleDescriptor) {
