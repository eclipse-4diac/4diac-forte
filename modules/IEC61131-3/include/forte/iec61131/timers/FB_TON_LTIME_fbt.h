...
namespace forte::iec61131::timers {
  class FORTE_FB_TON_LTIME final : public CSimpleFB {
      DECLARE_FIRMWARE_FB(FORTE_FB_TON_LTIME)
    ...
    public:
      FORTE_FB_TON_LTIME(StringId paInstanceNameId, CFBContainer &paContainer);
