...
namespace forte::iec61131::conversion {
  class FORTE_F_WSTRING_TO_STRING final : public CSimpleFB {
    ...
    public:
      FORTE_F_WSTRING_TO_STRING(StringId paInstanceNameId, CFBContainer &paContainer);
      ...
      void evt_REQ(const CIEC_WSTRING &paIN, COutputParameter<CIEC_STRING> paOUT) {
      ...
      void operator()(const CIEC_WSTRING &paIN, COutputParameter<CIEC_STRING> paOUT) {
        evt_REQ(paIN, paOUT);
      }
  };
} // namespace forte::iec61131::conversion
