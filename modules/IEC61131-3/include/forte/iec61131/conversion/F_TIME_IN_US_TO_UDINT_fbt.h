...
namespace forte::iec61131::conversion {
  class FORTE_F_TIME_IN_US_TO_UDINT final : public CSimpleFB {
    ...
    public:
      FORTE_F_TIME_IN_US_TO_UDINT(StringId paInstanceNameId, CFBContainer &paContainer);
      ...
      void evt_REQ(const CIEC_TIME &paIN, COutputParameter<CIEC_UDINT> paOUT) {
      ...
      void operator()(const CIEC_TIME &paIN, COutputParameter<CIEC_UDINT> paOUT) {
        evt_REQ(paIN, paOUT);
      }
  };
} // namespace forte::iec61131::conversion
