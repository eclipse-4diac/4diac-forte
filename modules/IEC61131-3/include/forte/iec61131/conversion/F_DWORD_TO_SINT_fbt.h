...
namespace forte::iec61131::conversion {
  class FORTE_F_DWORD_TO_SINT final : public CSimpleFB {
    ...
    public:
      FORTE_F_DWORD_TO_SINT(StringId paInstanceNameId, CFBContainer &paContainer);
      ...
      void evt_REQ(const CIEC_DWORD &paIN, COutputParameter<CIEC_SINT> paOUT) {
      ...
      void operator()(const CIEC_DWORD &paIN, COutputParameter<CIEC_SINT> paOUT) {
        evt_REQ(paIN, paOUT);
      }
  };
} // namespace forte::iec61131::conversion
