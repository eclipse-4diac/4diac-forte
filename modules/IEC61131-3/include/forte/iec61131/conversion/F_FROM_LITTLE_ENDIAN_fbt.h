...
namespace forte::iec61131::conversion {
  class FORTE_F_FROM_LITTLE_ENDIAN final : public CSimpleFB {
      DECLARE_FIRMWARE_FB(FORTE_F_FROM_LITTLE_ENDIAN)
    ...
    public:
      FORTE_F_FROM_LITTLE_ENDIAN(StringId paInstanceNameId, CFBContainer &paContainer);
