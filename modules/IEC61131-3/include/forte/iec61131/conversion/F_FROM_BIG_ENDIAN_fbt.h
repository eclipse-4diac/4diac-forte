...
namespace forte::iec61131::conversion {
  class FORTE_F_FROM_BIG_ENDIAN final : public CSimpleFB {
      DECLARE_FIRMWARE_FB(FORTE_F_FROM_BIG_ENDIAN)
    ...
    public:
      FORTE_F_FROM_BIG_ENDIAN(StringId paInstanceNameId, CFBContainer &paContainer);
