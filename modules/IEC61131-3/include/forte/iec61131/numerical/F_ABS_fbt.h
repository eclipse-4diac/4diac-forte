...
namespace forte::iec61131::numerical {
  class FORTE_F_ABS : public CFunctionBlock {
    ...
    public:
      FORTE_F_ABS(const StringId paInstanceNameId, CFBContainer &paContainer);
      ...
      void evt_REQ(const CIEC_ANY_NUM &pa_IN, COutputParameter<CIEC_ANY_NUM_VARIANT> pa_OUT) {
      ...
      void operator()(const CIEC_ANY_NUM &pa_IN, COutputParameter<CIEC_ANY_NUM_VARIANT> pa_OUT) {
