...
namespace forte::iec61131::arrays {
  class FORTE_F_LOWER_BOUND final : public CFunctionBlock {
      DECLARE_FIRMWARE_FB(FORTE_F_LOWER_BOUND)
    ...
    public:
      FORTE_F_LOWER_BOUND(StringId paInstanceNameId, CFBContainer &paContainer);
