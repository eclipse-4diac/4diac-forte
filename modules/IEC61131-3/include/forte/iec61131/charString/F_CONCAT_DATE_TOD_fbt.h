...
namespace forte::iec61131::charString {
  class FORTE_F_CONCAT_DATE_TOD : public CFunctionBlock {
    ...
    public:
      ...
      void
      evt_REQ(const CIEC_DATE &pa_IN1, const CIEC_TIME_OF_DAY &pa_IN2, COutputParameter<CIEC_DATE_AND_TIME> pa_OUT) {
      ...
      void
      operator()(const CIEC_DATE &pa_IN1, const CIEC_TIME_OF_DAY &pa_IN2, COutputParameter<CIEC_DATE_AND_TIME> pa_OUT) {
