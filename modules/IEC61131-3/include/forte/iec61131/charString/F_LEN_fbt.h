...
namespace forte::iec61131::charString {
  class FORTE_F_LEN : public CFunctionBlock {
    ...
    public:
      FORTE_F_LEN(const StringId paInstanceNameId, CFBContainer &paContainer);
      ...
      void evt_REQ(const CIEC_ANY_STRING &pa_IN, COutputParameter<CIEC_ANY_INT_VARIANT> pa_OUT) {
      ...
      void operator()(const CIEC_ANY_STRING &pa_IN, COutputParameter<CIEC_ANY_INT_VARIANT> pa_OUT) {
