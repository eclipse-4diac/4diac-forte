...
namespace forte::iec61131::arithmetic {
  class FORTE_F_SUB_TOD_TIME : public CFunctionBlock {
    ...
    public:
      FORTE_F_SUB_TOD_TIME(const StringId paInstanceNameId, CFBContainer &paContainer);
      ...
      void evt_REQ(const CIEC_TIME_OF_DAY &pa_IN1, const CIEC_TIME &pa_IN2, COutputParameter<CIEC_TIME_OF_DAY> pa_OUT) {
      ...
      void
      operator()(const CIEC_TIME_OF_DAY &pa_IN1, const CIEC_TIME &pa_IN2, COutputParameter<CIEC_TIME_OF_DAY> pa_OUT) {
