...
namespace forte::iec61131::arithmetic {
  class FORTE_F_TRUNC : public CFunctionBlock {
    ...
    public:
      FORTE_F_TRUNC(const StringId paInstanceNameId, CFBContainer &paContainer);
      ...
      void evt_REQ(const CIEC_ANY_REAL &pa_IN, COutputParameter<CIEC_ANY_INT_VARIANT> pa_OUT) {
      ...
      void operator()(const CIEC_ANY_REAL &pa_IN, COutputParameter<CIEC_ANY_INT_VARIANT> pa_OUT) {
