...
namespace forte::iec61131::arithmetic {
  class FORTE_F_SUB_DT_DT : public CFunctionBlock {
    ...
    public:
      ...
      void
      evt_REQ(const CIEC_DATE_AND_TIME &pa_IN1, const CIEC_DATE_AND_TIME &pa_IN2, COutputParameter<CIEC_TIME> pa_OUT) {
      ...
      void operator()(const CIEC_DATE_AND_TIME &pa_IN1,
                      const CIEC_DATE_AND_TIME &pa_IN2,
                      COutputParameter<CIEC_TIME> pa_OUT) {
