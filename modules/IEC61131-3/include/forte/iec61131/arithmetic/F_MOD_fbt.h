...
namespace forte::iec61131::arithmetic {
  class FORTE_F_MOD : public CFunctionBlock {
    ...
    public:
      FORTE_F_MOD(const StringId paInstanceNameId, CFBContainer &paContainer);
      ...
      void
      evt_REQ(const CIEC_ANY_INT &pa_IN1, const CIEC_ANY_INT &pa_IN2, COutputParameter<CIEC_ANY_NUM_VARIANT> pa_OUT) {
      ...
      void operator()(const CIEC_ANY_INT &pa_IN1,
                      const CIEC_ANY_INT &pa_IN2,
