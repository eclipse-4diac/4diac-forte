...
namespace forte::iec61131::arithmetic {
  class FORTE_F_EXPT : public CFunctionBlock {
    ...
    public:
      ...
      void evt_REQ(const CIEC_ANY_REAL &pa_IN1,
                   const CIEC_ANY_REAL &pa_IN2,
                   COutputParameter<CIEC_ANY_REAL_VARIANT> pa_OUT) {
      ...
      void operator()(const CIEC_ANY_REAL &pa_IN1,
                      const CIEC_ANY_REAL &pa_IN2,
                      COutputParameter<CIEC_ANY_REAL_VARIANT> pa_OUT) {
