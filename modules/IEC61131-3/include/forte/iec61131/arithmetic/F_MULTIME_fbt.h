...
namespace forte::iec61131::arithmetic {
  class FORTE_F_MULTIME : public CFunctionBlock {
    ...
    public:
      FORTE_F_MULTIME(const StringId paInstanceNameId, CFBContainer &paContainer);
      ...
      void evt_REQ(const CIEC_TIME &pa_IN1, const CIEC_ANY_NUM &pa_IN2, COutputParameter<CIEC_TIME> pa_OUT) {
      ...
      void operator()(const CIEC_TIME &pa_IN1, const CIEC_ANY_NUM &pa_IN2, COutputParameter<CIEC_TIME> pa_OUT) {
