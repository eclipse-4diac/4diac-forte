...
namespace forte::iec61131::arithmetic {
  class FORTE_F_SUB : public CFunctionBlock {
    ...
    public:
      FORTE_F_SUB(const StringId paInstanceNameId, CFBContainer &paContainer);
      ...
      void evt_REQ(const CIEC_ANY_MAGNITUDE &pa_IN1,
                   const CIEC_ANY_MAGNITUDE &pa_IN2,
                   COutputParameter<CIEC_ANY_MAGNITUDE_VARIANT> pa_OUT) {
      ...
      void operator()(const CIEC_ANY_MAGNITUDE &pa_IN1,
                      const CIEC_ANY_MAGNITUDE &pa_IN2,
                      COutputParameter<CIEC_ANY_MAGNITUDE_VARIANT> pa_OUT) {
