...
#include "forte/iec61131/comparison/F_LE_fbt.h"

using namespace forte::core::literals;

using namespace forte::iec61131::comparison;

DEFINE_FIRMWARE_FB(FORTE_F_LE, "iec61131::comparison::F_LE"_STRID)
...
FORTE_F_LE::FORTE_F_LE(const forte::core::StringId paInstanceNameId, forte::core::CFBContainer &paContainer) :
