...
#include "forte/iec61131/comparison/F_EQ_fbt.h"

using namespace forte::core::literals;

using namespace forte::iec61131::comparison;

DEFINE_FIRMWARE_FB(FORTE_F_EQ, "iec61131::comparison::F_EQ"_STRID)
...
FORTE_F_EQ::FORTE_F_EQ(const forte::core::StringId paInstanceNameId, forte::core::CFBContainer &paContainer) :
