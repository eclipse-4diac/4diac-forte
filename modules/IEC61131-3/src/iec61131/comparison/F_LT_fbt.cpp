...
#include "forte/iec61131/comparison/F_LT_fbt.h"

using namespace forte::core::literals;

using namespace forte::iec61131::comparison;

DEFINE_FIRMWARE_FB(FORTE_F_LT, "iec61131::comparison::F_LT"_STRID)
...
FORTE_F_LT::FORTE_F_LT(const forte::core::StringId paInstanceNameId, forte::core::CFBContainer &paContainer) :
