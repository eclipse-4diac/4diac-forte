...
DEFINE_FIRMWARE_FB(FORTE_F_GE, "iec61131::comparison::F_GE"_STRID)
...
FORTE_F_GE::FORTE_F_GE(const forte::core::StringId paInstanceNameId, forte::core::CFBContainer &paContainer) :
