...
DEFINE_FIRMWARE_FB(FORTE_F_FIND, "iec61131::charString::F_FIND"_STRID)
...
FORTE_F_FIND::FORTE_F_FIND(const forte::core::StringId paInstanceNameId, forte::core::CFBContainer &paContainer) :
