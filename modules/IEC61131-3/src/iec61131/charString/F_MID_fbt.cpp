...
#include "forte/iec61131/charString/F_MID_fbt.h"
...
namespace forte::iec61131::charString {
  ...
  DEFINE_FIRMWARE_FB(FORTE_F_MID, "iec61131::charString::F_MID"_STRID)

  FORTE_F_MID::FORTE_F_MID(const StringId paInstanceNameId, CFBContainer &paContainer) :
