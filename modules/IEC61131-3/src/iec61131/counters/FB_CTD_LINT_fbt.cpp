...
#include "forte/iec61131/counters/FB_CTD_LINT_fbt.h"
...
DEFINE_FIRMWARE_FB(FORTE_FB_CTD_LINT, "FB_CTD_LINT"_STRID)

FORTE_FB_CTD_LINT::FORTE_FB_CTD_LINT(const forte::core::StringId paInstanceNameId,
