...
#include "forte/iec61131/counters/FB_CTU_LINT_fbt.h"
...
DEFINE_FIRMWARE_FB(FORTE_FB_CTU_LINT, "iec61131::counters::FB_CTU_LINT"_STRID)

FORTE_FB_CTU_LINT::FORTE_FB_CTU_LINT(const forte::StringId paInstanceNameId, forte::CFBContainer &paContainer) :
