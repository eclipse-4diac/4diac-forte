...
DEFINE_FIRMWARE_FB(FORTE_F_TIME_IN_S_TO_UDINT, "F_TIME_IN_S_TO_UDINT"_STRID)
...
FORTE_F_TIME_IN_S_TO_UDINT::FORTE_F_TIME_IN_S_TO_UDINT(const forte::core::StringId paInstanceNameId,
