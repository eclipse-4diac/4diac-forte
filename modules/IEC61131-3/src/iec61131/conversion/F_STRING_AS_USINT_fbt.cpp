...
#include "forte/iec61131/conversion/F_STRING_AS_USINT_fbt.h"
...
namespace forte::iec61131::conversion {
  ...
  DEFINE_FIRMWARE_FB(FORTE_F_STRING_AS_USINT, "iec61131::conversion::F_STRING_AS_USINT"_STRID)

  FORTE_F_STRING_AS_USINT::FORTE_F_STRING_AS_USINT(const StringId paInstanceNameId, CFBContainer &paContainer) :
