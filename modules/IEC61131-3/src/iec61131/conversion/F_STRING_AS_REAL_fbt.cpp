...
#include "forte/iec61131/conversion/F_STRING_AS_REAL_fbt.h"
...
namespace forte::iec61131::conversion {
  ...
  DEFINE_FIRMWARE_FB(FORTE_F_STRING_AS_REAL, "iec61131::conversion::F_STRING_AS_REAL"_STRID)

  FORTE_F_STRING_AS_REAL::FORTE_F_STRING_AS_REAL(const StringId paInstanceNameId, CFBContainer &paContainer) :
