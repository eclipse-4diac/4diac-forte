...
#include "forte/iec61131/conversion/F_WSTRING_AS_DINT_fbt.h"
...
namespace forte::iec61131::conversion {
  ...
  DEFINE_FIRMWARE_FB(FORTE_F_WSTRING_AS_DINT, "iec61131::conversion::F_WSTRING_AS_DINT"_STRID)

  FORTE_F_WSTRING_AS_DINT::FORTE_F_WSTRING_AS_DINT(const StringId paInstanceNameId, CFBContainer &paContainer) :
