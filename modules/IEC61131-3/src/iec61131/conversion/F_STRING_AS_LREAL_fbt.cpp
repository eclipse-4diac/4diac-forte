...
#include "forte/iec61131/conversion/F_STRING_AS_LREAL_fbt.h"
...
namespace forte::iec61131::conversion {
  ...
  DEFINE_FIRMWARE_FB(FORTE_F_STRING_AS_LREAL, "iec61131::conversion::F_STRING_AS_LREAL"_STRID)

  FORTE_F_STRING_AS_LREAL::FORTE_F_STRING_AS_LREAL(const StringId paInstanceNameId, CFBContainer &paContainer) :
