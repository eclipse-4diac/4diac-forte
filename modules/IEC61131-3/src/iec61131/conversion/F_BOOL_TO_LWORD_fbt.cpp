...
#include "forte/iec61131/conversion/F_BOOL_TO_LWORD_fbt.h"
...
namespace forte::iec61131::conversion {
  ...
  DEFINE_FIRMWARE_FB(FORTE_F_BOOL_TO_LWORD, "iec61131::conversion::F_BOOL_TO_LWORD"_STRID)

  FORTE_F_BOOL_TO_LWORD::FORTE_F_BOOL_TO_LWORD(const StringId paInstanceNameId, CFBContainer &paContainer) :
