...
#include "forte/iec61131/conversion/F_USINT_TO_DINT_fbt.h"
...
namespace forte::iec61131::conversion {
  ...
  DEFINE_FIRMWARE_FB(FORTE_F_USINT_TO_DINT, "iec61131::conversion::F_USINT_TO_DINT"_STRID)

  FORTE_F_USINT_TO_DINT::FORTE_F_USINT_TO_DINT(const StringId paInstanceNameId, CFBContainer &paContainer) :
