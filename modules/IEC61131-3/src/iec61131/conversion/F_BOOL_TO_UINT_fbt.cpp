...
#include "forte/iec61131/conversion/F_BOOL_TO_UINT_fbt.h"
...
namespace forte::iec61131::conversion {
  ...
  DEFINE_FIRMWARE_FB(FORTE_F_BOOL_TO_UINT, "iec61131::conversion::F_BOOL_TO_UINT"_STRID)

  FORTE_F_BOOL_TO_UINT::FORTE_F_BOOL_TO_UINT(const StringId paInstanceNameId, CFBContainer &paContainer) :
