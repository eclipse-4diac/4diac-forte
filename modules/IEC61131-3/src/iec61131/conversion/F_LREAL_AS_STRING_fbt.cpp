...
#include "forte/iec61131/conversion/F_LREAL_AS_STRING_fbt.h"
...
namespace forte::iec61131::conversion {
  ...
  DEFINE_FIRMWARE_FB(FORTE_F_LREAL_AS_STRING, "iec61131::conversion::F_LREAL_AS_STRING"_STRID)

  FORTE_F_LREAL_AS_STRING::FORTE_F_LREAL_AS_STRING(const StringId paInstanceNameId, CFBContainer &paContainer) :
