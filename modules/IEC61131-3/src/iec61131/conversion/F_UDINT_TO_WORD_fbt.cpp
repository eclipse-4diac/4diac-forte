...
#include "forte/iec61131/conversion/F_UDINT_TO_WORD_fbt.h"
...
namespace forte::iec61131::conversion {
  ...
  DEFINE_FIRMWARE_FB(FORTE_F_UDINT_TO_WORD, "iec61131::conversion::F_UDINT_TO_WORD"_STRID)

  FORTE_F_UDINT_TO_WORD::FORTE_F_UDINT_TO_WORD(const StringId paInstanceNameId, CFBContainer &paContainer) :
