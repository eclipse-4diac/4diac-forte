...
#include "forte/iec61131/conversion/F_WSTRING_AS_TIME_fbt.h"
...
namespace forte::iec61131::conversion {
  ...
  DEFINE_FIRMWARE_FB(FORTE_F_WSTRING_AS_TIME, "iec61131::conversion::F_WSTRING_AS_TIME"_STRID)

  FORTE_F_WSTRING_AS_TIME::FORTE_F_WSTRING_AS_TIME(const StringId paInstanceNameId, CFBContainer &paContainer) :
