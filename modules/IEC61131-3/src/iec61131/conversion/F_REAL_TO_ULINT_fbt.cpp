...
#include "forte/iec61131/conversion/F_REAL_TO_ULINT_fbt.h"
...
namespace forte::iec61131::conversion {
  ...
  DEFINE_FIRMWARE_FB(FORTE_F_REAL_TO_ULINT, "iec61131::conversion::F_REAL_TO_ULINT"_STRID)

  FORTE_F_REAL_TO_ULINT::FORTE_F_REAL_TO_ULINT(const StringId paInstanceNameId, CFBContainer &paContainer) :
