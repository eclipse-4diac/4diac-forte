...
#include "forte/iec61131/conversion/F_BOOL_TO_SINT_fbt.h"
...
namespace forte::iec61131::conversion {
  ...
  DEFINE_FIRMWARE_FB(FORTE_F_BOOL_TO_SINT, "iec61131::conversion::F_BOOL_TO_SINT"_STRID)

  FORTE_F_BOOL_TO_SINT::FORTE_F_BOOL_TO_SINT(const StringId paInstanceNameId, CFBContainer &paContainer) :
