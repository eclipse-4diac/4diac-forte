...
#include "forte/iec61131/conversion/F_LWORD_TO_BYTE_fbt.h"
...
namespace forte::iec61131::conversion {
  ...
  DEFINE_FIRMWARE_FB(FORTE_F_LWORD_TO_BYTE, "iec61131::conversion::F_LWORD_TO_BYTE"_STRID)

  FORTE_F_LWORD_TO_BYTE::FORTE_F_LWORD_TO_BYTE(const StringId paInstanceNameId, CFBContainer &paContainer) :
