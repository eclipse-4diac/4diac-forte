...
#include "forte/iec61131/conversion/F_INT_TO_LREAL_fbt.h"
...
namespace forte::iec61131::conversion {
  ...
  DEFINE_FIRMWARE_FB(FORTE_F_INT_TO_LREAL, "iec61131::conversion::F_INT_TO_LREAL"_STRID)

  FORTE_F_INT_TO_LREAL::FORTE_F_INT_TO_LREAL(const StringId paInstanceNameId, CFBContainer &paContainer) :
