...
#include "forte/iec61131/conversion/F_WSTRING_AS_SINT_fbt.h"
...
namespace forte::iec61131::conversion {
  ...
  DEFINE_FIRMWARE_FB(FORTE_F_WSTRING_AS_SINT, "iec61131::conversion::F_WSTRING_AS_SINT"_STRID)

  FORTE_F_WSTRING_AS_SINT::FORTE_F_WSTRING_AS_SINT(const StringId paInstanceNameId, CFBContainer &paContainer) :
