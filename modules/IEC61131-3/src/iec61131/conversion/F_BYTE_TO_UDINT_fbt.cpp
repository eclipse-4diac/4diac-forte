...
#include "forte/iec61131/conversion/F_BYTE_TO_UDINT_fbt.h"
...
namespace forte::iec61131::conversion {
  ...
  DEFINE_FIRMWARE_FB(FORTE_F_BYTE_TO_UDINT, "iec61131::conversion::F_BYTE_TO_UDINT"_STRID)

  FORTE_F_BYTE_TO_UDINT::FORTE_F_BYTE_TO_UDINT(const StringId paInstanceNameId, CFBContainer &paContainer) :
