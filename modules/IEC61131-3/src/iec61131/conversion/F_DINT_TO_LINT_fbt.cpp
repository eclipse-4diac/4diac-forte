...
#include "forte/iec61131/conversion/F_DINT_TO_LINT_fbt.h"
...
namespace forte::iec61131::conversion {
  ...
  DEFINE_FIRMWARE_FB(FORTE_F_DINT_TO_LINT, "iec61131::conversion::F_DINT_TO_LINT"_STRID)

  FORTE_F_DINT_TO_LINT::FORTE_F_DINT_TO_LINT(const StringId paInstanceNameId, CFBContainer &paContainer) :
  ...
  void FORTE_F_DINT_TO_LINT::setInitialValues() {
    var_IN = 0_DINT;
    var_OUT = 0_LINT;
  }
  ...
  void FORTE_F_DINT_TO_LINT::enterStateREQ(CEventChainExecutionThread *const paECET) {
    alg_REQ();
