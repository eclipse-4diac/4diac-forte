...
#include "forte/iec61131/conversion/F_DWORD_TO_REAL_fbt.h"
...
namespace forte::iec61131::conversion {
  ...
  DEFINE_FIRMWARE_FB(FORTE_F_DWORD_TO_REAL, "iec61131::conversion::F_DWORD_TO_REAL"_STRID)

  FORTE_F_DWORD_TO_REAL::FORTE_F_DWORD_TO_REAL(const StringId paInstanceNameId, CFBContainer &paContainer) :
