...
#include "forte/iec61131/conversion/F_STRING_AS_INT_fbt.h"
...
namespace forte::iec61131::conversion {
  ...
  DEFINE_FIRMWARE_FB(FORTE_F_STRING_AS_INT, "iec61131::conversion::F_STRING_AS_INT"_STRID)

  FORTE_F_STRING_AS_INT::FORTE_F_STRING_AS_INT(const StringId paInstanceNameId, CFBContainer &paContainer) :
