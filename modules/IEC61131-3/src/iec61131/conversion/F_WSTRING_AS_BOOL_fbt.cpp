...
DEFINE_FIRMWARE_FB(FORTE_F_WSTRING_AS_BOOL, "F_WSTRING_AS_BOOL"_STRID)
...
FORTE_F_WSTRING_AS_BOOL::FORTE_F_WSTRING_AS_BOOL(const forte::core::StringId paInstanceNameId,
