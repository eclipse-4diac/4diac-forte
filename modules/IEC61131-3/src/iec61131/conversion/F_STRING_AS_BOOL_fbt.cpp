...
#include "forte/iec61131/conversion/F_STRING_AS_BOOL_fbt.h"
...
namespace forte::iec61131::conversion {
  ...
  DEFINE_FIRMWARE_FB(FORTE_F_STRING_AS_BOOL, "iec61131::conversion::F_STRING_AS_BOOL"_STRID)

  FORTE_F_STRING_AS_BOOL::FORTE_F_STRING_AS_BOOL(const StringId paInstanceNameId, CFBContainer &paContainer) :
