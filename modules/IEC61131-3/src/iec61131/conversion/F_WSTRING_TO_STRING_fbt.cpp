...
#include "forte/iec61131/conversion/F_WSTRING_TO_STRING_fbt.h"
...
namespace forte::iec61131::conversion {
  ...
  DEFINE_FIRMWARE_FB(FORTE_F_WSTRING_TO_STRING, "iec61131::conversion::F_WSTRING_TO_STRING"_STRID)

  FORTE_F_WSTRING_TO_STRING::FORTE_F_WSTRING_TO_STRING(const StringId paInstanceNameId, CFBContainer &paContainer) :
