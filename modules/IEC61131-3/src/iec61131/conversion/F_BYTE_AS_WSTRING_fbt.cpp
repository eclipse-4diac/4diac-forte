...
#include "forte/iec61131/conversion/F_BYTE_AS_WSTRING_fbt.h"
...
namespace forte::iec61131::conversion {
  ...
  DEFINE_FIRMWARE_FB(FORTE_F_BYTE_AS_WSTRING, "iec61131::conversion::F_BYTE_AS_WSTRING"_STRID)

  FORTE_F_BYTE_AS_WSTRING::FORTE_F_BYTE_AS_WSTRING(const StringId paInstanceNameId, CFBContainer &paContainer) :
