...
#include "forte/iec61131/conversion/F_TIME_IN_NS_TO_DINT_fbt.h"
...
FORTE_F_TIME_IN_NS_TO_DINT::FORTE_F_TIME_IN_NS_TO_DINT(const forte::StringId paInstanceNameId,
