...
#include "forte/iec61131/conversion/F_REAL_TO_USINT_fbt.h"
...
namespace forte::iec61131::conversion {
  ...
  DEFINE_FIRMWARE_FB(FORTE_F_REAL_TO_USINT, "iec61131::conversion::F_REAL_TO_USINT"_STRID)

  FORTE_F_REAL_TO_USINT::FORTE_F_REAL_TO_USINT(const StringId paInstanceNameId, CFBContainer &paContainer) :
