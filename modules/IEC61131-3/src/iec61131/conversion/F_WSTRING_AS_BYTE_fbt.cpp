...
#include "forte/iec61131/conversion/F_WSTRING_AS_BYTE_fbt.h"
...
namespace forte::iec61131::conversion {
  ...
  DEFINE_FIRMWARE_FB(FORTE_F_WSTRING_AS_BYTE, "iec61131::conversion::F_WSTRING_AS_BYTE"_STRID)

  FORTE_F_WSTRING_AS_BYTE::FORTE_F_WSTRING_AS_BYTE(const StringId paInstanceNameId, CFBContainer &paContainer) :
