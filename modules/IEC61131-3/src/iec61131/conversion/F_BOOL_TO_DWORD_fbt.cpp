...
#include "forte/iec61131/conversion/F_BOOL_TO_DWORD_fbt.h"
...
namespace forte::iec61131::conversion {
  ...
  DEFINE_FIRMWARE_FB(FORTE_F_BOOL_TO_DWORD, "iec61131::conversion::F_BOOL_TO_DWORD"_STRID)

  FORTE_F_BOOL_TO_DWORD::FORTE_F_BOOL_TO_DWORD(const StringId paInstanceNameId, CFBContainer &paContainer) :
