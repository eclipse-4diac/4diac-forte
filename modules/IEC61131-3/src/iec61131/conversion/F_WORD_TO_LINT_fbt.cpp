...
#include "forte/iec61131/conversion/F_WORD_TO_LINT_fbt.h"
...
namespace forte::iec61131::conversion {
  ...
  DEFINE_FIRMWARE_FB(FORTE_F_WORD_TO_LINT, "iec61131::conversion::F_WORD_TO_LINT"_STRID)

  FORTE_F_WORD_TO_LINT::FORTE_F_WORD_TO_LINT(const StringId paInstanceNameId, CFBContainer &paContainer) :
