...
#include "forte/iec61131/conversion/F_USINT_TO_BCD_BYTE_fbt.h"
...
namespace forte::iec61131::conversion {
  ...
  DEFINE_FIRMWARE_FB(FORTE_F_USINT_TO_BCD_BYTE, "iec61131::conversion::F_USINT_TO_BCD_BYTE"_STRID)

  FORTE_F_USINT_TO_BCD_BYTE::FORTE_F_USINT_TO_BCD_BYTE(const StringId paInstanceNameId, CFBContainer &paContainer) :
