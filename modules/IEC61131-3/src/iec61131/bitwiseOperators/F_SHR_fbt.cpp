...
#include "forte/iec61131/bitwiseOperators/F_SHR_fbt.h"
...
namespace forte::iec61131::bitwiseOperators {
  ...
  DEFINE_FIRMWARE_FB(FORTE_F_SHR, "iec61131::bitwiseOperators::F_SHR"_STRID)

  FORTE_F_SHR::FORTE_F_SHR(const StringId paInstanceNameId, CFBContainer &paContainer) :
