...
#include "forte/iec61131/bitwiseOperators/F_AND_fbt.h"

using namespace forte::core::literals;

using namespace forte::iec61131::bitwiseOperators;

DEFINE_FIRMWARE_FB(FORTE_F_AND, "iec61131::bitwiseOperators::F_AND"_STRID)
...
FORTE_F_AND::FORTE_F_AND(const forte::core::StringId paInstanceNameId, forte::core::CFBContainer &paContainer) :
