...
DEFINE_FIRMWARE_FB(FORTE_F_ROL, "iec61131::bitwiseOperators::F_ROL"_STRID)
...
FORTE_F_ROL::FORTE_F_ROL(const forte::core::StringId paInstanceNameId, forte::core::CFBContainer &paContainer) :
