...
#include "forte/iec61131/selection/F_MIN_fbt.h"

using namespace forte::core::literals;

using namespace forte::iec61131::selection;

DEFINE_FIRMWARE_FB(FORTE_F_MIN, "iec61131::selection::F_MIN"_STRID)
...
FORTE_F_MIN::FORTE_F_MIN(const forte::core::StringId paInstanceNameId, forte::core::CFBContainer &paContainer) :
