...
#include "forte/iec61131/arithmetic/F_DIV_fbt.h"

using namespace forte::literals;

using namespace forte::iec61131::arithmetic;

DEFINE_FIRMWARE_FB(FORTE_F_DIV, "iec61131::arithmetic::F_DIV"_STRID)
...
FORTE_F_DIV::FORTE_F_DIV(const forte::StringId paInstanceNameId, forte::CFBContainer &paContainer) :
    ...
    case scmEventREQID:
      var_OUT = std::visit(
          [](auto &&paIN1, auto &&paIN2) -> CIEC_ANY_NUM_VARIANT {
            ...
            using deductedType = typename forte::mpl::get_div_operator_result_type<T, U>::type;
