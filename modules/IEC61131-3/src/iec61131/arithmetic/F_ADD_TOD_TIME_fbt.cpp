...
#include "forte/iec61131/arithmetic/F_ADD_TOD_TIME_fbt.h"
...
namespace forte::iec61131::arithmetic {
  ...
  DEFINE_FIRMWARE_FB(FORTE_F_ADD_TOD_TIME, "iec61131::arithmetic::F_ADD_TOD_TIME"_STRID)

  FORTE_F_ADD_TOD_TIME::FORTE_F_ADD_TOD_TIME(const StringId paInstanceNameId, CFBContainer &paContainer) :
