...
#include "forte/iec61131/numerical/F_TAN_fbt.h"
...
namespace forte::iec61131::numerical {
  ...
  DEFINE_FIRMWARE_FB(FORTE_F_TAN, "iec61131::numerical::F_TAN"_STRID)

  FORTE_F_TAN::FORTE_F_TAN(const StringId paInstanceNameId, CFBContainer &paContainer) :
