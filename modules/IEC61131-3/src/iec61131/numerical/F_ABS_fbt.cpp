...
#include "forte/iec61131/numerical/F_ABS_fbt.h"

using namespace forte::core::literals;

using namespace forte::iec61131::numerical;

DEFINE_FIRMWARE_FB(FORTE_F_ABS, "iec61131::numerical::F_ABS"_STRID)
...
FORTE_F_ABS::FORTE_F_ABS(const forte::core::StringId paInstanceNameId, forte::core::CFBContainer &paContainer) :
