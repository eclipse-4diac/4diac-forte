...
#include "forte/iec61131/numerical/F_LOG_fbt.h"
...
namespace forte::iec61131::numerical {
  ...
  DEFINE_FIRMWARE_FB(FORTE_F_LOG, "iec61131::numerical::F_LOG"_STRID)

  FORTE_F_LOG::FORTE_F_LOG(const StringId paInstanceNameId, CFBContainer &paContainer) :
