...
DEFINE_FIRMWARE_FB(FORTE_F_LN, "iec61131::numerical::F_LN"_STRID)
...
FORTE_F_LN::FORTE_F_LN(const forte::core::StringId paInstanceNameId, forte::core::CFBContainer &paContainer) :
