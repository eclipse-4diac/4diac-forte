...
#include "forte/iec61131/numerical/F_ASIN_fbt.h"
...
namespace forte::iec61131::numerical {
  ...
  DEFINE_FIRMWARE_FB(FORTE_F_ASIN, "iec61131::numerical::F_ASIN"_STRID)

  FORTE_F_ASIN::FORTE_F_ASIN(const StringId paInstanceNameId, CFBContainer &paContainer) :
