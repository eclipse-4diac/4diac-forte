...
#include "forte/iec61131/numerical/F_ACOS_fbt.h"
...
namespace forte::iec61131::numerical {
  ...
  DEFINE_FIRMWARE_FB(FORTE_F_ACOS, "iec61131::numerical::F_ACOS"_STRID)

  FORTE_F_ACOS::FORTE_F_ACOS(const StringId paInstanceNameId, CFBContainer &paContainer) :
