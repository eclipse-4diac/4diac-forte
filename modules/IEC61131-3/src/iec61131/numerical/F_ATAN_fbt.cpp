...
DEFINE_FIRMWARE_FB(FORTE_F_ATAN, "iec61131::numerical::F_ATAN"_STRID)
...
FORTE_F_ATAN::FORTE_F_ATAN(const forte::core::StringId paInstanceNameId, forte::core::CFBContainer &paContainer) :
