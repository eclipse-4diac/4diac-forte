...
#include "forte/iec61131/numerical/F_SIN_fbt.h"
...
namespace forte::iec61131::numerical {
  ...
  DEFINE_FIRMWARE_FB(FORTE_F_SIN, "iec61131::numerical::F_SIN"_STRID)

  FORTE_F_SIN::FORTE_F_SIN(const StringId paInstanceNameId, CFBContainer &paContainer) :
