...
DEFINE_FIRMWARE_FB(FORTE_SPLIT_DWORD_INTO_BOOLS, "SPLIT_DWORD_INTO_BOOLS"_STRID)
...
FORTE_SPLIT_DWORD_INTO_BOOLS::FORTE_SPLIT_DWORD_INTO_BOOLS(const forte::core::StringId paInstanceNameId,
