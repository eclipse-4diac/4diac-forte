...
DEFINE_FIRMWARE_FB(FORTE_SPLIT_DWORD_INTO_QUARTERS, "SPLIT_DWORD_INTO_QUARTERS"_STRID)
...
FORTE_SPLIT_DWORD_INTO_QUARTERS::FORTE_SPLIT_DWORD_INTO_QUARTERS(const forte::core::StringId paInstanceNameId,
