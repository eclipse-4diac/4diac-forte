...
FORTE_ASSEMBLE_WORD_FROM_BOOLS::FORTE_ASSEMBLE_WORD_FROM_BOOLS(const forte::StringId paInstanceNameId,
...
CIEC_WORD forte::eclipse4diac::utils::assembling::func_ASSEMBLE_WORD_FROM_BOOLS(CIEC_BOOL st_lv_BIT_00,
