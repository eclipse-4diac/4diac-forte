...
DEFINE_FIRMWARE_FB(FORTE_ASSEMBLE_LWORD_FROM_BOOLS, "eclipse4diac::utils::assembling::ASSEMBLE_LWORD_FROM_BOOLS"_STRID)
...
FORTE_ASSEMBLE_LWORD_FROM_BOOLS::FORTE_ASSEMBLE_LWORD_FROM_BOOLS(const forte::core::StringId paInstanceNameId,
