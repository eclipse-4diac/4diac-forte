...
#include "forte/eclipse4diac/utils/selection/F_SEL_E_4_fbt.h"
...
FORTE_F_SEL_E_4::FORTE_F_SEL_E_4(const forte::core::StringId paInstanceNameId, forte::core::CFBContainer &paContainer) :
