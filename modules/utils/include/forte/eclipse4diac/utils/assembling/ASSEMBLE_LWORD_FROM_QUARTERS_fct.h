...
class FORTE_ASSEMBLE_LWORD_FROM_QUARTERS final : public CFunctionBlock {
  ...
  public:
    FORTE_ASSEMBLE_LWORD_FROM_QUARTERS(forte::core::StringId paInstanceNameId, forte::core::CFBContainer &paContainer);
    ...
    void evt_REQ(const CIEC_BYTE &paQUARTER_BYTE_00,
                 ...
                 const CIEC_BYTE &paQUARTER_BYTE_08,
                 const CIEC_BYTE &paQUARTER_BYTE_09,
                 const CIEC_BYTE &paQUARTER_BYTE_10,
                 const CIEC_BYTE &paQUARTER_BYTE_11,
                 const CIEC_BYTE &paQUARTER_BYTE_12,
                 const CIEC_BYTE &paQUARTER_BYTE_13,
                 const CIEC_BYTE &paQUARTER_BYTE_14,
                 const CIEC_BYTE &paQUARTER_BYTE_15,
                 const CIEC_BYTE &paQUARTER_BYTE_16,
                 const CIEC_BYTE &paQUARTER_BYTE_17,
                 const CIEC_BYTE &paQUARTER_BYTE_18,
                 const CIEC_BYTE &paQUARTER_BYTE_19,
                 const CIEC_BYTE &paQUARTER_BYTE_20,
                 const CIEC_BYTE &paQUARTER_BYTE_21,
                 const CIEC_BYTE &paQUARTER_BYTE_22,
                 const CIEC_BYTE &paQUARTER_BYTE_23,
                 const CIEC_BYTE &paQUARTER_BYTE_24,
                 const CIEC_BYTE &paQUARTER_BYTE_25,
                 const CIEC_BYTE &paQUARTER_BYTE_26,
                 const CIEC_BYTE &paQUARTER_BYTE_27,
                 const CIEC_BYTE &paQUARTER_BYTE_28,
    ...
    void operator()(const CIEC_BYTE &paQUARTER_BYTE_00,
      ...
      evt_REQ(paQUARTER_BYTE_00, paQUARTER_BYTE_01, paQUARTER_BYTE_02, paQUARTER_BYTE_03, paQUARTER_BYTE_04,
              ...
              paQUARTER_BYTE_30, paQUARTER_BYTE_31, pa);
    }
};
}
