...
namespace forte::eclipse4diac::controlengineering {
  class FORTE_PI final : public CBasicFB {
      DECLARE_FIRMWARE_FB(FORTE_PI)
    ...
    public:
      FORTE_PI(StringId paInstanceNameId, CFBContainer &paContainer);
      ...
      void evt_INIT(const CIEC_BOOL &paQI, const CIEC_REAL &paACTUAL, const CIEC_REAL &paSET_POINT, const CIEC_REAL &paKP, const CIEC_REAL &paTN, const CIEC_TIME &paTimestep, CAnyBitOutputParameter<CIEC_BOOL> paQO, COutputParameter<CIEC_REAL> paOUT) {
      ...
      void evt_REQ(const CIEC_BOOL &paQI, const CIEC_REAL &paACTUAL, const CIEC_REAL &paSET_POINT, const CIEC_REAL &paKP, const CIEC_REAL &paTN, const CIEC_TIME &paTimestep, CAnyBitOutputParameter<CIEC_BOOL> paQO, COutputParameter<CIEC_REAL> paOUT) {
        COutputGuard guard_QO(paQO);
        COutputGuard guard_OUT(paOUT);
        var_QI = paQI;
        var_ACTUAL = paACTUAL;
