...
namespace forte::eclipse4diac::convert {
  class FORTE_SINT2SINT final : public CSimpleFB {
    ...
    public:
      FORTE_SINT2SINT(StringId paInstanceNameId, CFBContainer &paContainer);
      ...
      void evt_REQ(const CIEC_SINT &paIN, COutputParameter<CIEC_SINT> paOUT) {
      ...
      void operator()(const CIEC_SINT &paIN, COutputParameter<CIEC_SINT> paOUT) {
        evt_REQ(paIN, paOUT);
      }
  };
} // namespace forte::eclipse4diac::convert
