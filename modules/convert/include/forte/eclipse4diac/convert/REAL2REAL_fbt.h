...
namespace forte::eclipse4diac::convert {
  class FORTE_REAL2REAL final : public CSimpleFB {
    ...
    public:
      FORTE_REAL2REAL(StringId paInstanceNameId, CFBContainer &paContainer);
      ...
      void evt_REQ(const CIEC_REAL &paIN, COutputParameter<CIEC_REAL> paOUT) {
      ...
      void operator()(const CIEC_REAL &paIN, COutputParameter<CIEC_REAL> paOUT) {
        evt_REQ(paIN, paOUT);
      }
  };
} // namespace forte::eclipse4diac::convert
