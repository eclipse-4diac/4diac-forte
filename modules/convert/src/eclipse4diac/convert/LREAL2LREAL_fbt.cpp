...
#include "forte/eclipse4diac/convert/LREAL2LREAL_fbt.h"
...
DEFINE_FIRMWARE_FB(FORTE_LREAL2LREAL, "eclipse4diac::convert::LREAL2LREAL"_STRID)
...
FORTE_LREAL2LREAL::FORTE_LREAL2LREAL(const forte::core::StringId paInstanceNameId,
