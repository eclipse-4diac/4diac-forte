...
#include "forte/eclipse4diac/convert/SINT2SINT_fbt.h"
...
DEFINE_FIRMWARE_FB(FORTE_SINT2SINT, "eclipse4diac::convert::SINT2SINT"_STRID)
...
FORTE_SINT2SINT::FORTE_SINT2SINT(const forte::StringId paInstanceNameId, forte::CFBContainer &paContainer) :
