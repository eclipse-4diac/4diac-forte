...
#include "forte/eclipse4diac/convert/UINT2UINT_fbt.h"
...
DEFINE_FIRMWARE_FB(FORTE_UINT2UINT, "eclipse4diac::convert::UINT2UINT"_STRID)
...
FORTE_UINT2UINT::FORTE_UINT2UINT(const forte::core::StringId paInstanceNameId, forte::core::CFBContainer &paContainer) :
