...
#include "forte/eclipse4diac/convert/INT2INT_fbt.h"
...
DEFINE_FIRMWARE_FB(FORTE_INT2INT, "eclipse4diac::convert::INT2INT"_STRID)
...
FORTE_INT2INT::FORTE_INT2INT(const forte::StringId paInstanceNameId, forte::CFBContainer &paContainer) :
