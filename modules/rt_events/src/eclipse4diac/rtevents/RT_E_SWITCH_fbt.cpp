...
namespace forte::eclipse4diac::rtevents {
  namespace {
    const auto cDataInputNames =
        std::array{"QI"_STRID,           "G"_STRID,       "Tmin"_STRID, "Deadline_EO1"_STRID, "WCET_EO1"_STRID,
                   "Deadline_EO2"_STRID, "WCET_EO2"_STRID};
  ...
  FORTE_RT_E_SWITCH::FORTE_RT_E_SWITCH(const StringId paInstanceNameId, CFBContainer &paContainer) :
  ...
  EMGMResponse FORTE_RT_E_SWITCH::changeExecutionState(EMGMCommandType paCommand) {
