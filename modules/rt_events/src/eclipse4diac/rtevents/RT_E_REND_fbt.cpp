 ...
 *******************************************************************************/
#include "forte/eclipse4diac/rtevents/RT_E_REND_fbt.h"

using namespace forte::core::literals;

using namespace forte::eclipse4diac::rtevents;

DEFINE_FIRMWARE_FB(FORTE_RT_E_REND, "eclipse4diac::rtevents::RT_E_REND"_STRID)
...
namespace {
  ...
  const auto cEventInputNames = std::array{"INIT"_STRID, "EI1"_STRID, "EI2"_STRID, "R"_STRID};
...
FORTE_RT_E_REND::FORTE_RT_E_REND(const forte::core::StringId paInstanceNameId, forte::core::CFBContainer &paContainer) :
