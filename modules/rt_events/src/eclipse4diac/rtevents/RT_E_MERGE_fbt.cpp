 ...
 *******************************************************************************/
#include "forte/eclipse4diac/rtevents/RT_E_MERGE_fbt.h"

using namespace forte::literals;

using namespace forte::eclipse4diac::rtevents;

DEFINE_FIRMWARE_FB(FORTE_RT_E_MERGE, "eclipse4diac::rtevents::RT_E_MERGE"_STRID)
...
namespace {
  ...
  const auto cEventInputNames = std::array{"INIT"_STRID, "EI1"_STRID, "EI2"_STRID};
...
FORTE_RT_E_MERGE::FORTE_RT_E_MERGE(const forte::StringId paInstanceNameId, forte::CFBContainer &paContainer) :
