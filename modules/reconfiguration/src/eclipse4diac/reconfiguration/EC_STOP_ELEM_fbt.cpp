 ...
 *******************************************************************************/
#include "forte/eclipse4diac/reconfiguration/EC_STOP_ELEM_fbt.h"
...
FORTE_EC_STOP_ELEM::FORTE_EC_STOP_ELEM(const forte::StringId paInstanceNameId, forte::CFBContainer &paContainer) :
