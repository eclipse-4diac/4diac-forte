 ...
 *******************************************************************************/
#include "forte/eclipse4diac/reconfiguration/ST_CREATE_CONN_fbt.h"
...
namespace forte::eclipse4diac::reconfiguration {
  ...
  DEFINE_FIRMWARE_FB(FORTE_ST_CREATE_CONN, "eclipse4diac::reconfiguration::ST_CREATE_CONN"_STRID)
