 ...
 *******************************************************************************/
#include "forte/eclipse4diac/reconfiguration/ST_DEL_CONN_fbt.h"
...
namespace forte::eclipse4diac::reconfiguration {
  ...
  DEFINE_FIRMWARE_FB(FORTE_ST_DEL_CONN, "eclipse4diac::reconfiguration::ST_DEL_CONN"_STRID)

  FORTE_ST_DEL_CONN::FORTE_ST_DEL_CONN(const StringId paInstanceNameId, CFBContainer &paContainer) :
