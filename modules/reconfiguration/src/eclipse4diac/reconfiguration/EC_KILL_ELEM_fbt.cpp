 ...
 *******************************************************************************/
#include "forte/eclipse4diac/reconfiguration/EC_KILL_ELEM_fbt.h"
...
FORTE_EC_KILL_ELEM::FORTE_EC_KILL_ELEM(const forte::StringId paInstanceNameId, forte::CFBContainer &paContainer) :
