...
class FORTE_X20AI4622 final : public PowerlinkFunctionBlockAI {
  ...
  public:
    FORTE_X20AI4622(forte::StringId paInstanceNameId, CFBContainer &paContainer);
    ...
    COutDataConnection<CIEC_INT> conn_AI03;
    COutDataConnection<CIEC_INT> conn_AI04;
    ...
    void evt_INIT(const CIEC_BOOL &paQI,
                  ...
                  COutputParameter<CIEC_INT> paAI03,
                  COutputParameter<CIEC_INT> paAI04) {
      COutputGuard guard_paQO(paQO);
      COutputGuard guard_paCNIDO(paCNIDO);
      COutputGuard guard_paSTATUS(paSTATUS);
      COutputGuard guard_paAI01(paAI01);
      COutputGuard guard_paAI02(paAI02);
      COutputGuard guard_paAI03(paAI03);
      COutputGuard guard_paAI04(paAI04);
      var_QI = paQI;
      var_CNID = paCNID;
      var_MODID = paMODID;
